...
PDF: https://help.zscaler.com/pdf/com/en/1355791.pdf

The Users Overview provides information about the digital experience of users in your organization during the selected time frame. By default, Total Active Users and Total Active Devices are displayed in the overview.
...
To further sort user information, use the filters on the page. You can also use the Search functionality to search for a specific user. To learn more, see [Using Search in the ZDX Admin Portal](/zdx/using-user-search-zdx-admin-portal).
...
To learn more about user details, see [Evaluating User Details](/zdx/evaluating-user-details).
...
[]View how many users have a **Poor**, **Okay**, or **Good** ZDX Score in the selected time period. To learn more, see [About the ZDX Score](/zdx/about-zdx-score).
![ZDX Score User Distribution ](/downloads/zdx/analytics/about-users-dashboard/ZDX_ZDXScore_UserDistribution_0.png)
[]The **User** column provides a list of users by their name. These names come from your identity providers configured in ZIA. To learn more, see [About Identity Providers](/zia/about-identity-providers).
You can click a name to see more information about each user. To learn more, see [Evaluating User Details](/zdx/evaluating-user-details).
[]The **ZDX Score **column shows the user's ZDX Score from 1–100, with 1 being the lowest and 100 being the highest. It is an average score for the selected time period. To learn more, see [About the ZDX Score](/zdx/about-zdx-score).
[]The **Zscaler Locations** column provides a list of the locations where the user accessed their device. These locations are defined in ZIA. To learn more, see [About Locations](/zia/about-locations).
Click a location name to view the Applications Overview with the data filtered by that defined location. To learn more, see [Monitoring the Applications Overview](/zdx/monitoring-applications-dashboard).
[]The **Geolocations** column lists all of the areas where users accessed their devices for the selected time period.
...
Click a city to view the Applications Overview with the data filtered by those cities. To learn more, see [Monitoring the Applications Overview](/zdx/monitoring-applications-dashboard).
[]The **Devices** column lists all of the user's devices they used for the selected time period.
Click the device names to view more detailed information about the user's devices and applications accessed from the devices. To learn more, see [Evaluating User Details](/zdx/evaluating-user-details).
[]The **Device Count** column lists the total number of devices associated with the user.
Click the user name or device names to view detailed information about the user's devices. To learn more, see [Evaluating User Details](/zdx/evaluating-user-details).
