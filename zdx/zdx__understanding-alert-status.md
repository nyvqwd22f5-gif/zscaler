...
PDF: https://help.zscaler.com/pdf/com/en/1414456.pdf

The Alert Status provides details on the current status of an alert. The alert status can be seen in the Alerts Overview, Ongoing Alerts, Alert History, and View Alert pages. To learn more, see [About Alerts](/zdx/about-alerts).
