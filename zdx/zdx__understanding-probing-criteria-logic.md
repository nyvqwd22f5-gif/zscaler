...
PDF: https://help.zscaler.com/pdf/com/en/1486366.pdf

When you configure a probe for an application in the ZDX Admin Portal, the inclusion and exclusion configuration fields use different logic based on what you select. You can create a combination of the inclusion and exclusion criteria to be specific towards your probing data needs.
