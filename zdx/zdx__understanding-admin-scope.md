...
PDF: https://help.zscaler.com/pdf/com/en/1449966.pdf

With [role-based administration](/zdx/about-administrators), a ZDX admin's scope specifies which areas of the organization an admin can manage and view in the ZDX Admin Portal. The default ZDX admin is assigned the Organization scope over the entire organization. For each additional admin you create, you must assign one of the following scopes:
- Organization
- Department
- Applications
- Location
You can assign a scope over the entire organization or either location or department. When selecting **Location** as a scope, you can assign a Zscaler **Location **to limit their area of impact. When selecting **Department**, you can assign a department to limit their area of impact. To learn more, see [Adding ZDX Admins](/zdx/adding-zdx-admins).
[See image.](#admin-scope)
...
[]The following table outlines how admin scope impacts the ability to access the ZDX Admin Portal features.
-
-
-
-
...
| ZDX DashboardApplicationsUserInventory | Admins can view traffic information for areas over which they have scope.For ZDX Dashboard, Applications, User, and Inventory, an admin can only view impacted users and their devices based on their area of scope. |
|  |
-
-
-
