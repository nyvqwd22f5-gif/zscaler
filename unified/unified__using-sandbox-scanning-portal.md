...
Source: https://help.zscaler.com/unified/using-sandbox-scanning-portal
PDF: https://help.zscaler.com/pdf/com/en/1494376.pdf

With Advanced Sandbox, you can manually submit suspicious files for behavioral analysis by uploading them to the [Sandbox Scanning Portal](http://filecheck.zscaler.com/).
[See image.](#seeimage1)
...
-
**MD5**:** **Displays the MD5 value you need to search for the file in the Admin Portal [Insight logs](/zia/about-insights-logs) and view the [Sandbox Detail Report](/zia/viewing-sandbox-reports-data#about-sandbox-detail-report).
...
- **Uploaded URL**: Displays the URL you need to search for either single or multiple files in the Admin Portal. See the next section for instructions.
...
To check whether the file was clean or sent for analysis, you must view the Sandbox logs, which you can access from the Admin Portal. See the next section for instructions.
[See image.](#seeimage2)
Checking the File Status
To check whether the file was clean or sent for analysis:
- Go to **Logs** > **Insights** > **Internet & SaaS** > **Web Insights**.
- Click the** Logs** tab.
