...
Source: https://help.zscaler.com/unified/email-dlp-insights-logs-columns
PDF: https://help.zscaler.com/pdf/com/en/1503461.pdf

You can customize your Email Data Loss Prevention (DLP) logs by using the column fields. To learn more about logs, see [About Insights Logs](/unified/about-insights-logs).
...
- **External User**: The user who sent the email but is not provisioned to Internet & SaaS.
