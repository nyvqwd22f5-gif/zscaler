...
Source: https://help.zscaler.com/unified/saas-security-insights
PDF: https://help.zscaler.com/pdf/com/en/1497316.pdf

The SaaS Security Insights page is where you can view and define information that you want to view when analyzing files scanned through charts. To learn more about how to analyze your traffic on the Insights pages, see [Analyzing Traffic Using Insights](/unified/analyzing-traffic-using-insights).
...
To view Insights, go to **Logs **>** Insights **>** Internet & SaaS **>** SaaS Security Insights**.
- View the [Logs](/unified/about-saas-security-insights-logs) tab.
- Clear all filters.
