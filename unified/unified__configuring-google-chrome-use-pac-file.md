...
Source: https://help.zscaler.com/unified/configuring-google-chrome-use-pac-file
PDF: https://help.zscaler.com/pdf/com/en/1495486.pdf
...
-
In the **Local Area Network (LAN) Settings** window, select **Use automatic configuration script **and paste the PAC file URL that you copied from the Admin Portal.
[See image.](#Image6)
...
-
In the **Proxy **settings page, enable **Use setup script **and then paste the PAC file URL that you copied from the Admin Portal into the **Script address **field.
