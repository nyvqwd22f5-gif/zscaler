...
Source: https://help.zscaler.com/unified/viewing-active-directory-protection-dashboard
PDF: https://help.zscaler.com/pdf/com/en/1517556.pdf
...
- **API Protection Dashboard**: View the [API Protection Dashboard](/unified/viewing-api-protection-dashboard) for information about API traffic in API protection controls. This tab is only visible if the feature is enabled in your account.
