...
Source: https://help.zscaler.com/unified/adding-streaming-media-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494766.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Streaming Media**.
The **Add Streaming Media Rule** window appears.
- In the **Add Streaming Media Rule** window, enter the rule attributes:
...
You can choose either **Allow** or **Block** action for **Uploading**.
- [Allow](#allow)
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-streaming-media-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Streaming-Media-See-More.png)
...
-
**Tenant Profile**: Appears only when **Google Video** or **YouTube** is selected as the cloud application. You can select the tenant profiles for which you want to apply the rule. To learn more, see [About Tenant Profiles](/unified/about-tenant-profiles).
