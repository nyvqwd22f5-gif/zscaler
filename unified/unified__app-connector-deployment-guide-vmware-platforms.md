...
Source: https://help.zscaler.com/unified/app-connector-deployment-guide-vmware-platforms
PDF: https://help.zscaler.com/pdf/com/en/1496166.pdf
...
- Step 5: Verify that the deployed App Connector is [running and healthy](/unified/managing-deployed-app-connectors#Status). Also, check that it is [meeting your sizing requirements](/unified/managing-deployed-app-connectors#VerifySizing).
...
- Obtain the latest VMware image from Zscaler. You can also use the following link to download the file for the vSphere Web Client: [https://dist.private.zscaler.com/vms/VMware/2024.06/zpa-connector-el9-2024.06.05.ova](https://dist.private.zscaler.com/vms/VMware/2024.06/zpa-connector-el9-2024.06.05.ova).
...
- Select **URL**, enter the following URL for the App Connector image into the provided field, then click **Next**: https://dist.private.zscaler.com/vms/VMware/2024.06/zpa-connector-el9-2024.06.05.ova.
...
- For **2 Destination** > **2a Select name and folder**, the name and folder specified in vCenter has no impact on the Private Applications service. So, select a name and folder that is suitable for your organization, then click **Next**.
...
- [Configure Static IP Addressing](/unified/app-connector-deployment-guide-vmware-platforms#Static_IP)
- [Configure the Domain Name System (DNS) Resolver](/unified/app-connector-deployment-guide-vmware-platforms#DNS)
...
- Verify the local time on the VMware machine is correct. If it is not, update the time using [Network Time Protocol](/unified/app-connector-deployment-guide-vmware-platforms#NTP).
- Make any necessary [network configuration](/unified/app-connector-deployment-guide-vmware-platforms#Networking) changes before applying the provisioning key.
...
- Use a current [provisioning key](/zpa/pselabel/about-connector-provisioning-keys) or create a new [App Connector group](/zpa/pselabel/about-connector-groups) with a provisioning key for each location.
- Verify the [version profile](/zpa/pselabel/configuring-version-profile) is **Default**, **Previous Default**, or **New Release** by doing one of the following:
...
- Follow the [step-by-step guide](/zpa/pselabel/connector-deployment-guide-vmware-platforms) to deploy new VMs using the RHEL 9 images and newly created provisioning keys. Ensure the yum repository is pointing to the new RHEL 9 link: `https://yum.private.zscaler.com/yum/el9`
...
- (Optional) [Disable the App Connector groups](/zpa/pselabel/editing-connector-groups) 5 minutes prior to the regional off-hours maintenance window to allow connections to gradually drain down.
-
...
- Enter the following URL for the App Connector image into the provided field: https://dist.private.zscaler.com/vms/VMware/2024.06/zpa-connector-el9-2024.06.05.ova, then click **Next**:
...
- [Configure Static IP Addressing](/unified/app-connector-deployment-guide-vmware-platforms)
- [Configure the Domain Name System (DNS) Resolver](/unified/app-connector-deployment-guide-vmware-platforms#DNS)
- Verify the local time on the VMware machine is correct. If it is not, update the time using [Network Time Protocol](/unified/app-connector-deployment-guide-vmware-platforms#NTP).
- Make any necessary [network configuration](/unified/app-connector-deployment-guide-vmware-platforms#Networking) changes before applying the provisioning key.
- Apply the App Connector provisioning key.
