...
PDF: https://help.zscaler.com/pdf/com/en/1400401.pdf
...
| ZSCALER-PROCESSWATCHDOG-MIB.mib | This module describes the process watchdog information for each of the managed processes of a Zscaler instance (e.g., for a SME type of instance, the watched processes are sme, smavd, smavd2, smcdsc, and sctimer). |
...
| ZSCALER-VSE-MIB | This module describes the health status of Virtual Service Edge connection to Zscaler CA and Log and Reporting servers. |
...
The steps for configuring [NSS ](/zia/about-nanolog-streaming-service)are identical to the Virtual Service Edge example shown in this article.
