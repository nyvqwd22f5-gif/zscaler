...
Source: https://help.zscaler.com/unified/adding-http-header-profile
PDF: https://help.zscaler.com/pdf/com/en/1529751.pdf

The [HTTP header profile](/unified/about-http-header-profile) allows you to create criteria for various HTTP request headers and create policies based on the HTTP headers.
...
- Go to **Policies **>** Access Control **>** Internet & SaaS **>** HTTP Header Control**.
-
