...
Source: https://help.zscaler.com/unified/editing-defined-application-segments
PDF: https://help.zscaler.com/pdf/com/en/1492096.pdf
...
- [](Optional) If you selected the **Show Recommendation Before Editing** checkbox on the [Defined Application Segments](/unified/about-applications) page, then you will have the following additional steps. If you did not select this option, go to [Step 4](#Step4).
...
- On the **Applications and Port Configuration** tab, modify fields as necessary. To learn more about each field, see [Configuring Application Segments](/unified/configuring-defined-application-segments).[]
...
To learn more about each field, see [Configuring Application Segments](/unified/configuring-defined-application-segments).
...
- **Confidence**: The measurement of accuracy that a recommended application matched the set requirements. The range is from 0–100, with higher numbers meaning a more accurate match, given the configured filters set in the [AI-Powered Recommendations Settings](/unified/configuring-ai-powered-recommendations-settings%20) page.
...
- **Confidence**: The measurement of accuracy that a recommended application segment matched the set requirements. The range is from 0-100, with higher numbers meaning a more accurate match, given the configured filters set in the [AI-Powered Recommendations Settings](/unified/configuring-ai-powered-recommendations-settings) page.
