...
Source: https://help.zscaler.com/unified/defining-patterns-custom-dlp-dictionaries
PDF: https://help.zscaler.com/pdf/com/en/1493111.pdf

You can use alphanumeric patterns to configure custom dictionaries that match a wide variety of data types. For example, you can define patterns to detect data like phone numbers, driver's license numbers, or credit card numbers for specific issuers (a number of sample patterns are provided below). To learn more, see [Adding Custom DLP Dictionaries](/unified/adding-custom-dlp-dictionaries).
