...
Source: https://help.zscaler.com/unified/nss-feed-output-format-saas-security-logs
PDF: https://help.zscaler.com/pdf/com/en/1497816.pdf
...
Fields that support obfuscation are documented in the following tables with the prefix `o` (e.g., `%s{ofileid}`). To obfuscate a field, manually add the prefix `o` before the field name in the Feed Output Format in the Admin Portal.
Collaboration
-
-
-
...
| %s{extownername} | The file owners (inside or outside your organization) who are not provisioned to Internet & SaaS | jane@yahoo.com |
| %s{oextownername} | The obfuscated version of the file owners (inside or outside your organization) who are not provisioned to Internet & SaaS | 753148 |
...
| %s{externalownername} | The file owners (inside or outside your organization) who are not provisioned to Internet & SaaS | jane@yahoo.com |
| %s{oexternalownername} | The obfuscated version of the file owners (inside or outside your organization) who are not provisioned to Internet & SaaS | 753148 |
