...
Source: https://help.zscaler.com/unified/about-configuration-risk-report
PDF: https://help.zscaler.com/pdf/com/en/1497571.pdf
...
On the Configuration Risk Report page (Analytics > Internet & SaaS > Analytics > Configuration Risk Report), you can view the following sections:
- **Configuration Risk Score**: This section displays the organization’s configuration risk score and further breaks down the score contributed from each of the following categories:
