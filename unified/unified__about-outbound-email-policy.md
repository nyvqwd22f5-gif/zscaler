...
On the Outbound Email Policy page (Policies > Data Protection >  Policy > Outbound Email Controls > Data Loss Prevention), you can do the following:
- [Add an Outbound Email Policy rule](/unified/configuring-outbound-email-policy-rules).
...
- Edit, duplicate, or delete a policy rule. You can also add [an exception rule](/unified/configuring-outbound-email-policy-rules).
