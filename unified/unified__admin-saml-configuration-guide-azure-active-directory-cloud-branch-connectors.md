# Cloud & Branch Connector Admin SAML Configuration Guide for Azure Active Directory
Source: https://help.zscaler.com/unified/admin-saml-configuration-guide-azure-active-directory-cloud-branch-connectors
PDF: https://help.zscaler.com/pdf/com/en/1516726.pdf

This guide demonstrates how to configure Microsoft Azure Active Directory (Azure AD) as the identity provider (IdP) for Zscaler Cloud & Branch Connector and use [SAML single-sign-on (SSO) for your organization's admins](/unified/configuring-saml-admins-0). To learn more about how to configure SAML within the Azure portal, refer to the [Microsoft documentation](https://learn.microsoft.com/en-us/azure/active-directory/manage-apps/add-application-portal).
Prerequisites
...
- [Step 5: Configure SAML Admin SSO in the Admin Portal](/unified/configuring-saml-admins-cloud-branch-connector)
[]
...
[See image.](#AzureAD2G)
-
In **SAML Certificates**, download the **Certificate (Base64)**. You need this certificate in order to [configure SAML admin SSO in the Cloud & Branch Connector Admin Portal](/unified/configuring-saml-admins-0).
[See image.](#AzureAD2H)
-
In **Set up Zscaler Cloud and Branch Connector Administrator Application**, copy the **Azure AD Identifier**. You need this certificate in order to [configure SAML admin SSO in the Admin Portal](/unified/configuring-saml-admins-0).
[See image.](#AzureAD2I)
[]
...
[]
You can use this method if you have enabled application visibility, as demonstrated in the [Enable IdP-Initiated SSO step](#EnableIdP-InitiatedSSO).
...
- Browse to the User Access URL. You are signed in to the Zscaler Admin Portal.
