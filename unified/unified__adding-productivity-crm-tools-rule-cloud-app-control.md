...
Source: https://help.zscaler.com/unified/adding-productivity-crm-tools-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494751.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Productivity & CRM Tools**.
The **Add Productivity & CRM Tools Rule** window appears.
- In the **Add Productivity & CRM Tools Rule** window, enter the rule attributes:
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-productivity-crm-tools-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Prod-CRM-See-More.png)
...
-
**Tenant Profiles**: Appears only when **Google Analytics** is selected as the cloud application. You can select the tenant profiles for which you want to apply the rule. To learn more, see [About Tenant Profiles](/unified/about-tenant-profiles).
