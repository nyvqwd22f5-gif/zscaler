...
PDF: https://help.zscaler.com/pdf/com/en/1401436.pdf
...
-
Click **Add** and select **DNS Over HTTPS Services**.
The **Add** **DNS Over HTTPS Services **window appears.
- In the **Add** **DNS Over HTTPS Services **window, enter the **Cloud App Control Rule** attributes:
