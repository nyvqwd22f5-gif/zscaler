...
Source: https://help.zscaler.com/unified/about-api-client-access-policy
PDF: https://help.zscaler.com/pdf/com/en/1532769.pdf
...
- [Add an API client access policy rule](/unified/adding-api-client-access-policy-rule).
...
-
Edit an API client access policy rule.
If you update the policy rule that is associated with the API client, then the access token is also updated. Ensure to use the valid access token. To learn more, see [About Access Tokens](/unified/about-access-tokens).
-
Delete an API client access policy rule.
