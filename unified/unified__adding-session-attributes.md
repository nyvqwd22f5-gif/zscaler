...
Source: https://help.zscaler.com/unified/adding-session-attributes
PDF: https://help.zscaler.com/pdf/com/en/1505316.pdf

You can add session attributes related to the user's session in the Admin Portal, so they can be made available to the subscribed Zscaler services. For example, Private Applications can use these session attributes and enforce policies based on the session context.
...
[]![The Session Attribute page](/downloads/zslogin/administration/attributes/adding-session-attributes/zid-add-attribute-button.png)
[]![Adding session attribute](/downloads/zslogin/administration/attributes/adding-session-attributes/zid-add-attribute.png)
[]![Clicking Import CSV button](/downloads/zslogin/administration/attributes/adding-session-attributes/zid-import-csv-button.png)
[]![Importing attributes](/downloads/zslogin/administration/attributes/adding-session-attributes/zid-import-attributes.png)
