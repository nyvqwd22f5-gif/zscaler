# About Alert History
Source: https://help.zscaler.com/unified/about-alert-history
PDF: https://help.zscaler.com/pdf/com/en/1530725.pdf
...
On the Alert Summary page (Administration > Alerts > Security & UEBA Alerts > Alerts > Alert History), you can do the following:
...
On the Details page, (Administration > Alerts > Security & UEBA Alerts > Alerts > Alert History > Alert Name > Details), you can do the following:
-
...
- **View All Logs**: Click to view the list of all [Insight logs](/unified/about-insights-internet-saas) for the alert.
...
On the Impacted Systems page (Administration > Alerts > Security & UEBA Alerts > Alerts > Alert History > Alert Name > Impacted Systems), you can do the following:
...
- View all the [logged transactions](/unified/about-insights-internet-saas) by the user.
- View all the logged transactions on the [Insights](/unified/about-insights-internet-saas) page.
...
[]The Details section displays information on each individual alert. To view the details of an alert, click on the alert rule name from the Alert Summary table. The Details page is displayed.
On the Details page (Administration > Alerts > Security & UEBA Alerts > Alerts > Alert History > Alert Name > Details), you can do the following:
- **Alert Overview**: View the information on the alert rule name, the alert ID, the identified user, the type of policy action, the event type, the start and end time of the alert, the timestamp of when the alert was generated, the user risk score, and the [Web Insights](/unified/about-insights-internet-saas) log and [SaaS Security Insights](/unified/saas-security-insights) log for the selected alert.
