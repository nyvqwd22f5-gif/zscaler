...
Source: https://help.zscaler.com/unified/configuring-location-template
PDF: https://help.zscaler.com/pdf/com/en/1524686.pdf

Within the Admin Portal, you can create location templates. The selected attributes in the template are applied to a [location](/unified/about-locations-cloud-branch-connector). To learn more, see [About Location Templates](/unified/about-location-templates).
To configure a location template:
- Go to **Infrastructure **> **Locations **> **Location Resources** > **Location Templates**.
