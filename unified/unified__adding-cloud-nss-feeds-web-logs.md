...
Source: https://help.zscaler.com/unified/adding-cloud-nss-feeds-web-logs
PDF: https://help.zscaler.com/pdf/com/en/1496846.pdf
...
- **Download User-Defined File Type**: Use this filter to limit the logs based on the [user-defined type of file](/unified/configuring-file-type-control-policy) downloaded during the transaction. Multiple selections are allowed. To learn more, see [Configuring Custom File Types](/unified/configuring-custom-file-types).
- **Upload User-Defined File Type**: Use this filter to limit the logs based on the [user-defined type of file](/unified/configuring-file-type-control-policy) uploaded during the transaction. Multiple selections are allowed. To learn more, see [Configuring Custom File Types](/unified/configuring-custom-file-types).
