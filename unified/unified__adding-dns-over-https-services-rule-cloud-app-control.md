...
Source: https://help.zscaler.com/unified/adding-dns-over-https-services-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494691.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **DNS Over HTTPS Services**.
The Add DNS Over HTTPS Services window appears.
- in the Add DNS Over HTTPS Services window, enter the rule attributes:
...
If the allow or conditional option is selected, define the following:
