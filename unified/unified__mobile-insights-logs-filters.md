...
Source: https://help.zscaler.com/unified/mobile-insights-logs-filters
PDF: https://help.zscaler.com/pdf/com/en/1497371.pdf

Filters define the traffic information that you view in your Mobile Insights Logs. To learn more about logs, see [About Insights Logs](/unified/about-insights-logs).
...
- **DNS**: This refers to [DNS Control policy](/unified/about-dns-control).
...
- **Social Networking/Blogging**: This refers to the [Social Networking & Blogging rule](/unified/adding-social-networking-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Streaming Media**: This refers to the [Streaming Media rule](/unified/adding-streaming-media-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
