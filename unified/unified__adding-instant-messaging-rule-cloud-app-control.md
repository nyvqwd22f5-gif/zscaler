...
Source: https://help.zscaler.com/unified/adding-instant-messaging-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494736.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Instant Messaging**.
The **Add Instant Messaging Rule** window appears.
- In the **Add Instant Messaging Rule** window, enter the rule attributes:
...
You can choose either **Allow** or **Block** action for **File Transfers**.
- [Allow](#allow)
