...
Source: https://help.zscaler.com/unified/adding-ip-based-applications-bypass-traffic
PDF: https://help.zscaler.com/pdf/com/en/1494531.pdf

In addition to using predefined applications, (e.g., Microsoft Teams and Zoom), you can add IP-based applications to bypass traffic. Add the applications to bypass in [App Profiles](/unified/configuring-zscaler-client-connector-app-profiles).
To add an IP-based application to bypass traffic:
- In the Admin Portal, go to **Infrastructure > Common Resources > Application > IP Based**.
