...
Source: https://help.zscaler.com/unified/certificate-pinning-and-ssl-inspection
PDF: https://help.zscaler.com/pdf/com/en/1493811.pdf
...
To prevent applications that use certificate pinning from breaking in these circumstances, exempt the applications from SSL Inspection. You can achieve this by exempting either the cloud application from [SSL Inspection](/unified/about-ssl-inspection) or the individual domains from [SSL Inspection](/unified/about-ssl-inspection) using the [Custom URL categories](/unified/configuring-custom-url-categories).
...
-
-
[](https://support.goto.com/webinar/help/optimal-firewall-configuration-g2w060025)[](/unified/configuring-advanced-url-policy-settings#ucaas)
...
| ---- | -------- | ------- | ------------- | ----- |
| Adobe Acrobat Reader (Fill & Sign) | All | .acrobat.com.echosign.com.echocdn.com.bam.nr-data.net.newrelic.com | N/A | To learn more about the FQDNs that are required for Adobe Acrobat Services, see the Adobe product support page. |
| Adobe Creative Cloud | All | N/A | N/A | To learn more about the non-browser-based FQDNs, see the Adobe product support page. |
| Adobe Updates | All | platformdl.adobe.comfpdownload.adobe.comsstats.adobe.comget3.adobe.comget.adobe.comstats.adobe.comdlmping3.adobe.comdlmping2.adobe.com | N/A | To learn more, see the Adobe product support page. |
...
| Amazon Workspaces | All | .amazonaws.com.amazonworkspaces.com.awsapps.com.cloudfront.net | N/A | On the Firewall, define a network service, "Allow connection to PCoIP - Amazon Workspaces" to allow the destination ports 4172 and 4195. To learn more, see the Amazon Workspace support page. |
| Apple iMessage | All | p24-keyvalueservice.icloud.com | No error | iMessage on OSX and iOS will fail to send or receive messages unless this URL is bypassed. |
| Apple iTunes and App Store | All | .apps.apple.com.itunes.apple.com.mzstatic.comgs-loc.apple.comgsa.apple.comsecuremetrics.apple.comswscan.apple.comxp.apple.com.icloud.comppq.apple.comakadns.net | Various errors stating server not available | Without bypasses, iTunes and App Store will partially work, but many icons won't appear and apps cannot be downloaded or purchased unless these URLs are bypassed. To learn more, see the Apple product support page. |
| Apple Mail App | All | .mail.me.com | N/A | Bypass the Apple site for your email app to use an iCloud email account. |
| Blizzard Online Games | All | .battle.net.blizzard.comblzddist1-a.akamaihd.netblzddist2-a.akamaihd.net | N/A | Game updates and Battle.net updates will not download. No error message. |
...
| GoTo Applications | Browser - All | N/A | Connection fails | To learn more about the recommended FQDNs that can be bypassed, see the GoTo Support page. To learn more about GoTo one-click option, see Unified Communications as a Service (UCaaS). |
| Microsoft Defender | All | N/A | N/A | To learn more about the Microsoft Defender ATP service domains, see the Microsoft product support page. |
...
| Office 365 | All | N/A | N/A | Use Office365 One-Click Configuration in **Policies **>** Access Control **>** Internet & SaaS **>** URL Control **>** Advanced Settings**. |
| Overcast | Mobile - All | N/A | No Internet Connection | N/A |
| PayPal | Mobile - All | N/A | Cannot log in | N/A |
| PeopleGraph | Windows | appsforoffice.microsoft.com | Blank Graph | Auth Bypass needed as well: .oaspapps.com |
| Periscope | Mobile - All | N/A | N/A | You cannot find any live broadcasts and fails to load any video content. |
| Signal | All | .whispersystems.org.signal.org | N/A | To learn more about the non-browser-based domains that are required for Signal, see the Signal product support page. |
...
| Twitter | Mobile - All | N/A | N/A | The app loads but cannot pull in new content. |
...
| YikYak | Mobile - All | N/A | No Yaks | N/A |