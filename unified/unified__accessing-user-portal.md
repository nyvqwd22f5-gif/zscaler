...
Source: https://help.zscaler.com/unified/accessing-user-portal
PDF: https://help.zscaler.com/pdf/com/en/1492491.pdf

A user portal can display links to applications that your end users are authorized to access, as well as links to public applications or websites that your organization commonly uses.
...
User Portal Features for Private Applications
...
If a link is displayed but is inactive (i.e., grayed out), then an end-user cannot launch it directly from the portal and might require a native client for that specific application (e.g., SSH, RDP, etc.). In addition to the native client, the end-user also needs to have Zscaler Client Connector installed and enrolled on that device. If they do not have Zscaler Client Connector installed, you can give them the ability to **Download Zscaler Client Connector** from the portal. To learn more, see [About Zscaler Client Connector Download Links](/unified/viewing-and-managing-zscaler-client-connector-download-links). [See image.](#ZAppLinkGrayedOut-Img)
[]![Example AUP page for a user portal](/downloads/zpa/user-portal/accessing-user-portal/zpa-userportal-aupexample.png)
[]![All Types drop-down menu within a user portal](/downloads/zpa/user-portal/accessing-user-portal/zpa-userportal-alltypesmenu.png)
