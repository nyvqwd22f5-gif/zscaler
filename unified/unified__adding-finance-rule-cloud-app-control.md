...
Source: https://help.zscaler.com/unified/adding-finance-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494706.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Finance**.
The **Add Finance Rule** window appears.
- In the **Add Finance Rule** window, enter the rule attributes:
...
To see how this policy fits into the overall order of policy enforcement, see [Undersatnding Policy Enforcement](/unified/understanding-policy-enforcement).
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-finance-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Finance-Click-See-More.png)
