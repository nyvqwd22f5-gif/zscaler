...
- **Template Name**: The name of the template, as specified in the [Index Tool](/unified/creating-indexed-document-match-template). You can sort this column.
...
- [Delete an IDM index template](/unified/creating-indexed-document-match-template#delete-IDM-template).
- Go to the [Exact Data Match](/unified/about-exact-data-match) page, where you can view a list of all Exact Data Match (EDM) templates that are configured for your organization.
