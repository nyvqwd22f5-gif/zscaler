# About Alerts for Digital Experience Monitoring
Source: https://help.zscaler.com/unified/about-alerts-digital-experience-monitoring
PDF: https://help.zscaler.com/pdf/com/en/1491731.pdf
...
In the Admin Portal, you can view alerts triggered over the past two weeks. You can select options from 2 hours to 14 days in the time range filter to view triggered alerts in the Alert History tab. To learn more, see [Triggering an Alert](/unified/triggering-alert).
...
If you configure an alert rule by ZDX Score, depending on how you choose to group the scoring, these filters and icons are displayed. To learn more, see [Configuring an Alert Rule](/unified/configuring-alert-rule).
...
-
View details of the alerts triggered in the Admin Portal. The Ongoing Alerts tab displays ongoing alerts, and the Alert History tab displays historical alert details over the time selected. You can view the following for all the configured alerts:
...
- View details about an alert by clicking the View icon. To learn more, see [Evaluating Individual Alert Details](/unified/evaluating-individual-alert-details).
- Access the navigation menu to go to the following pages:
- [Rules](/unified/about-rules)
- [Templates](/unified/about-templates)
- Switch the view to see Ongoing Alerts or Alert History.
![Overview of the Alerts Page ](/downloads/zdx/alerts/about-alerts/ZDX-Alerts-Overview-1-Outline.png)