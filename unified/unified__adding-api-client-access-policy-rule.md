...
Source: https://help.zscaler.com/unified/adding-api-client-access-policy-rule
PDF: https://help.zscaler.com/pdf/com/en/1532770.pdf
...
ZIdentity administrators assigned with Full permission to access the API clients and API resources modules can configure an API client access policy rule. To learn more, see [Admin Roles and Permissions](/unified/admin-roles-and-permissions).
To add an API client access policy rule:
- Go to **Administration > API Configuration > OneAPI > API Client Access Policy.**
...
-
**Resources**:
- Select the API resources that determine the permissions (scope) the API client has to access the API resources of each Zscaler service. To learn more, see [Viewing API Resources](/unified/viewing-api-resources).
