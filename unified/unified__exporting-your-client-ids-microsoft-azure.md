...
Source: https://help.zscaler.com/unified/exporting-your-client-ids-microsoft-azure
PDF: https://help.zscaler.com/pdf/com/en/1515306.pdf

You can export a list of client IDs of all the apps connected to your Microsoft Azure environment and [upload](/unified/uploading-apps-bulk) the apps to the Inventory in Zscaler 3rd-Party App Governance** **using the client IDs.
