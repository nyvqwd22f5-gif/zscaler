...
PDF: https://help.zscaler.com/pdf/com/en/1485021.pdf

When [configuring custom controls](/zpa/configuring-custom-controls), some allow you to define with regular expressions (regex) values. The characters and limitations are:
