...
Source: https://help.zscaler.com/unified/adding-consumer-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494681.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Consumer**.
The Add Consumer Rule window appears.
- In the Add Consumer Rule window, enter the rule attributes:
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-consumer-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Consumer-Click-See-More.png)
