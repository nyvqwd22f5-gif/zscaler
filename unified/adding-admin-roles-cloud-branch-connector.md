# Adding Cloud & Branch Connector Admin Roles
Source: https://help.zscaler.com/unified/adding-admin-roles-cloud-branch-connector
PDF: https://help.zscaler.com/pdf/com/en/1516766.pdf

Configuring admin roles is one of the tasks you must complete when configuring role-based permissions for admins in the Zscaler Admin Portal.
Prerequisites
...
- Go to **Administration **>** Roles > Branch and Cloud Connector.**
...
You must assign admin roles in the ZIdentity Admin Portal. To learn more, see [About Administrative Entitlements](/zslogin/about-administrative-entitlements).
