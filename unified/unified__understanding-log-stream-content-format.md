...
Source: https://help.zscaler.com/unified/understanding-log-stream-content-format
PDF: https://help.zscaler.com/pdf/com/en/1496006.pdf
...
- [Audit Logs](/unified/about-audit-log-fields)
- [App Connector Metrics](/unified/about-app-connector-metrics-log-fields)
- [App Connector Status](/unified/about-app-connector-status-log-fields)
- [Browser Access](/unified/about-browser-access-log-fields)
- [Private Cloud Controller Metrics](/unified/understanding-private-cloud-controller-metrics-log-fields)
- [Private Cloud Controller Status](/unified/understanding-private-cloud-controller-status-log-fields)
- [Private Service Edge Metrics](/unified/about-private-service-edge-metrics-log-fields)
- [Private Service Edge Status](/unified/about-private-service-edge-status-log-fields)
- [User Activity](/unified/about-user-activity-log-fields)
- [User Status](/unified/about-user-status-log-fields)
- [Web Inspection](/unified/about-appprotection-log-fields)
While [configuring your log receiver](/unified/configuring-log-receiver), you can edit the default Log Stream Content to include customized log fields. For example, when configuring your log receiver using the [App Connector Status](/unified/about-app-connector-status-log-fields) log type, the `ConnectionLogType` field can be added as a custom log field to distinguish between AppProtection and event logs. The expected values for this field are `event_log` and `inspection_log`. The supported log field format specification must be included (i.e., %[OPT]s, %[OPT]j, %[OPT]J, %[OPT]d, %[OPT]x, %[OPT]f, %[OPT]o).
