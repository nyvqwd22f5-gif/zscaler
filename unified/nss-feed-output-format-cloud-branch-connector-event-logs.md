# NSS Feed Output Format: Cloud & Branch Connector Event Logs
Source: https://help.zscaler.com/unified/nss-feed-output-format-cloud-branch-connector-event-logs
PDF: https://help.zscaler.com/pdf/com/en/1519586.pdf
...
Zscaler Cloud Connector generates the Event logs when a status change occurs for a Cloud Connector health check, Zscaler data center reachability, a data plane health check, a software upgrade, a control plane health check, or a tunnel to Zscaler data centers.
