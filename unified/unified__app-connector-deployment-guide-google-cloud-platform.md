...
Source: https://help.zscaler.com/unified/app-connector-deployment-guide-google-cloud-platform
PDF: https://help.zscaler.com/pdf/com/en/1517096.pdf
...
After you create an SSH key pair and an image from the virtual disk, [complete the following steps to deploy using the Instance wizard.](#Deploy-Connector-Instance)
[]To launch the VM in GCP Marketplace:
- Go to [Private Applications - GCP Marketplace](https://console.cloud.google.com/marketplace/product/zpa-gcp-marketplace/zscaler-private-access-connector).
- Click **Launch**.
...
- **Secret value**: Enter the value for the secret (e.g., `<your provisioning key>`). You can acquire a provisioning key when creating an App Connector in the Admin Portal. To learn more, see [About App Connector Provisioning Keys](/unified/about-app-connector-provisioning-keys) and [Configuring App Connectors](/unified/configuring-app-connectors).
...
To learn more, see [Managing Deployed App Connectors](/unified/managing-deployed-app-connectors#Status).
...
- Select the customized zpa-connector.
- For **Access scope**:
