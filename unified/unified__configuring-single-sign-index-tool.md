...
Source: https://help.zscaler.com/unified/configuring-single-sign-index-tool
PDF: https://help.zscaler.com/pdf/com/en/1531108.pdf

Instead of logging in to the [Index Tool](/unified/about-index-tool) with a username and password, you can configure single sign-on (SSO) to the Index Tool through your identity provider (IdP).
...
For more information, refer to the documentation for your IdP.
- After you finish integrating the Index Tool in your IdP's admin console, log in to the Experience Center.
...
-
**Issuer**: Enter the URL for your Index Tool configuration.
...
- **SAML Issuer ID**: (Optional) Enter the URL that is used to verify your IdP.
...
- **Single sign-on URL**: Enter the URL for your Index Tool configuration.
- **Use this for Recipient URL and Destination URL**: Select this option.
- **Audience URI (SP Entity ID)**: Enter the URL for your Index Tool configuration.
...
- Click **Finish**.
-
On the **Sign On** tab, in the **SAML 2.0** section, click **More details**. Copy the **Sign on URL** and **Download **the **Signing Certificate**. You need them to configure SSO for the Index Tool in the Experience Center.
[See image.](#okta-see-image-6)
- (Optional) Copy the **Issuer **URL if you want the Zscaler service to verify the IdP.
-
...
-
In the **SAML Certificates **section, download **Certificate (Base64)**. You need this certificate file when you configure SSO for the Index Tool in the Experience Center.
[See image.](#entra-9)
-
In section four, copy the **Login URL**. You need it when you configure SSO for the Index Tool in the Experience Center.
[See image.](#entra-10)
-
(Optional) Copy the **Microsoft Entra Identifier** if you want the Zscaler service to verify the IdP.
[See image.](#entra-11)
-
...
[]![View of the SAML Settings for the Index Tool SSO configuration in the Okta Admin Console](/downloads/zia/policies/data-loss-prevention/dlp-index-tool/configuring-single-sign-index-tool/ZIA-okta-saml-settings.png)
...
[]![View of the configuration fields for the Index Tool SSO configuration](/downloads/zia/policies/data-loss-prevention/dlp-index-tool/configuring-single-sign-index-tool/ZIA-index-tool-sso-config.png)