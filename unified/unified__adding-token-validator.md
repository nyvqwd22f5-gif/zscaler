...
Source: https://help.zscaler.com/unified/adding-token-validator
PDF: https://help.zscaler.com/pdf/com/en/1532803.pdf

You can configure a token validator in the Admin Portal based on your requirements and use it in Internet & SaaS. During authorization requests, Internet & Saas can verify the identity of the user using the configured claims in the ZIdentity.
ZIdentity Administrators assigned with Full permission to access the Token Validators module can configure the token validator in the Admin Portal. To learn more, see [Admin Roles and Permissions](/unified/admin-roles-and-permissions).
To add a token validator:
- Go to **Administration > API Configuration > OneAPI > Token Validators**.
-
