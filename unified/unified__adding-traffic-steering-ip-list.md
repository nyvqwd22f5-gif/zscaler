...
Source: https://help.zscaler.com/unified/adding-traffic-steering-ip-list
PDF: https://help.zscaler.com/pdf/com/en/1533784.pdf

You can add a list of IP addresses to use for IP inclusions and exclusions when adding a ruleset for traffic steering to use with location-based policies. To learn more, see [About Location-Based Policies](/unified/about-location-based-policies).
...
- Click **Save**.
You can enter a maximum of 300 traffic steering IP lists. After you create a list, you can select it in the IP Inclusion List and IP Exclusion List when [adding a ruleset](/unified/adding-ruleset). You must use the list in a ruleset, and you cannot use it directly in an app profile.
