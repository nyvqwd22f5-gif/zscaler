# About NAT Control
Source: https://help.zscaler.com/unified/about-nat-control
PDF: https://help.zscaler.com/pdf/com/en/1494076.pdf
...
NAT policy-related activities are recorded and displayed in Firewall Insights Logs for all types of traffic, except for DNS traffic. NAT logs for DNS traffic are displayed in DNS Insights Logs. To learn more, see [About Insights Logs](/unified/about-insights-logs).
...
- [Configure a NAT Control rule](/unified/configuring-nat-control-policy).
...
- Edit or duplicate a NAT Control policy rule.
...
- Click the **Firewall Filtering Policy** tab to configure the Firewall Filtering policies. To learn more, see [About Firewall Control](/unified/about-firewall-filtering).
