...
On the Seeds Management Page (Administration > Seeds Management), you can do the following:
- View scan frequency that detects external surface vulnerabilities of the domains.
- Add a domain.
- Add domains by uploading a CSV file.
- View a list of added domains.
- Delete a domain from the list.
![Seeds Management Page](/downloads/risk360/administration-authentication/about-seeds-management/Risk360-Seeds-Management.png)