...
Source: https://help.zscaler.com/unified/editing-predefined-dlp-dictionaries
PDF: https://help.zscaler.com/pdf/com/en/1493096.pdf

Modifying a predefined DLP dictionary is one of the tasks you can complete when configuring DLP policy rules. To learn more, see [Configuring DLP Policy Rules with Content Inspection](/unified/configuring-dlp-policy-rules-content-inspection).
You can use the predefined DLP dictionaries as is, or modify them to suit your needs. To learn more, see [Understanding Predefined DLP Dictionaries](/unified/understanding-predefined-dlp-dictionaries).
...
- **Confidence Score Threshold**: Choose a value of **Low**, **Medium**, or **High**. To learn about configuring the [Confidence Score Threshold](#confidence) for a specific dictionary, see [Understanding Predefined DLP Dictionaires](/unified/understanding-predefined-dlp-dictionaries).
-
...
You can also clone a predefined dictionary or add a custom dictionary. Any combination of cloned, predefined, and custom dictionaries can be added to a DLP engine, which is what you must reference when creating DLP policies. To learn more, see [Cloning Predefined DLP Dictionaries](/unified/cloning-predefined-dlp-dictionaries), [Adding Custom DLP Dictionaries](/unified/adding-custom-dlp-dictionaries), and [About DLP Engines](/unified/about-dlp-engines).
