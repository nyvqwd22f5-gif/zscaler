...
Source: https://help.zscaler.com/unified/maintenance-support-internet-saas-virtual-service-edge
PDF: https://help.zscaler.com/pdf/com/en/1494941.pdf

Internet & SaaS Virtual Service Edges are installed in an organization’s data center and are dedicated to the organization’s traffic, but they are managed and maintained by Zscaler Cloud Operations. Zscaler maintains the Virtual Service Edges with a near zero touch needed from your organization.
...
- Monitor the Virtual Service Edge using supported [SNMP MIBs](/unified/accessing-zscaler-snmp-mibs) to determine the health of the device in the organization’s environment.
...
- Comply with the [firewall configuration requirements](/unified/firewall-configuration-requirements-private-service-edge-deployments), if you use a firewall to control access to the products on the Service Edges.
