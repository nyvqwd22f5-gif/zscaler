...
Source: https://help.zscaler.com/unified/url-format-guidelines
PDF: https://help.zscaler.com/pdf/com/en/1493931.pdf

The following guidelines are for entering URLs when configuring policies or settings in the Admin Portal.
...
- Do not use an asterisk ("*") as a wildcard character at the beginning of a domain. For example, .safemarch.com is permitted, while *safemarch.com is not permitted.
