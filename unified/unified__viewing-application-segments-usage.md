...
Source: https://help.zscaler.com/unified/viewing-application-segments-usage
PDF: https://help.zscaler.com/pdf/com/en/1531253.pdf
...
- **View Application Segments**: Allows you to access the [Defined Application Segments](/unified/about-defined-application-segments) page to manage the defined application segments.
...
- **Transactions**: The number of transactions going through the application segment.
- **Actions**: The available actions for the application segment. This includes:
- **Edit**: Edit the application segment in the Edit Application Segment window. To learn more, see [Editing Defined Application Segments](/unified/editing-defined-application-segments).
- **Application Segments and User Details**: View the application segment's usage details. To learn more, see [Viewing Application Segment Usage Details](/unified/viewing-application-segments-usage-details).
