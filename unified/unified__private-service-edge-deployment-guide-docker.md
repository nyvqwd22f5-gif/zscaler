...
Source: https://help.zscaler.com/unified/private-service-edge-deployment-guide-docker
PDF: https://help.zscaler.com/pdf/com/en/1496751.pdf
...
Prerequisites
- An environment variable named `ZPA_PROVISION_KEY` is required to run this image. You can retrieve the provisioning key from the Admin Portal. To learn more, see [About Private Service Edge Provisioning Keys](/unified/about-private-service-edge-provisioning-keys-private-applications).
- You must configure a Publish IP in the Admin UI. This public IP address receives requests for port 443 from clients and App Connectors when communicating with the Private Service Edge.
