...
Source: https://help.zscaler.com/unified/manage-saas-application-components
PDF: https://help.zscaler.com/pdf/com/en/1529729.pdf
...
Create Groups
To create groups:
- From the **Manage SaaS Application Components** page (Policies > Common Configuration > Out-of-Band CASB > SaaS Application Tenants > Manage SaaS Application Components), select the **Groups** tab.
-
...
-
In the **Add Group** window, enter a name for your group, and under **SaaS Application Tenant** select one of your tenants. If you haven't added one yet, see [Adding SaaS Application Tenants](/unified/adding-saas-application-tenants).
...
- Click **Save**.
To learn more about setting up the DLP policies for groups, see [About Data at Rest Scanning DLP](/unified/about-data-rest-scanning-dlp) and [Configuring the Data at Rest Scanning DLP Policy](/unified/configuring-data-rest-scanning-dlp-policy).
