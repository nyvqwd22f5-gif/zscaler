...
Source: https://help.zscaler.com/unified/viewing-policy-usage-details
PDF: https://help.zscaler.com/pdf/com/en/1531249.pdf

Policy usage details are accessible from the following pages:
-
[Access Policy](/unified/about-access-policy)
-
[Defined Application Segments](/unified/about-defined-application-segments)
-
[Policy Usage](/unified/viewing-policy-usage)
...
), you can view the following policy usage details:
...
-
Depending on what view you have selected, you see the following widgets:
- **Users** view** **(default):
...
- **Top Client Types**: Displays the most impacted client types for the policy.
When you click **View Logs** on a widget, you are taken to the Diagnostics page. To learn more, see [Accessing User Activity Diagnostics](/unified/accessing-user-activity-diagnostics).
[See image.](#AccessPolicyRule_Details)
...
[]
![Policy Usage of Access Policy Rule](/downloads/zpa/dashboard-diagnostics/applications-and-users-monitoring/viewing-policy-usage-details/AccessPolicyRule-Details-1.gif)
[]
![No Data Available](/downloads/tech-pubs-drafts/zpa-draft-articles/viewing-policy-usage-doc-51159/ZPA-PolicyUsagePage-TransactionsDetails.png)