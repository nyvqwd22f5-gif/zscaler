# NSS Feed Output Format: Internet & SaaS DNS Logs
Source: https://help.zscaler.com/unified/nss-feed-output-format-internet-saas-dns-logs
PDF: https://help.zscaler.com/pdf/com/en/1497806.pdf
...
The following tables display information about the DNS fields and example values for those fields. If applicable, the DNS fields are mapped to their corresponding columns in [DNS Insights Logs](/unified/dns-insights-logs-columns) (Logs > Insights > DNS Insights > Logs).
Date/Time
...
-
-
[](/unified/configuring-company-profile)[](/unified/dns-insights-logs-columns)
-
-
-
-
...
| %s{location} | The gateway location or sub-location of the source | Headquarters | Location |
