...
Source: https://help.zscaler.com/unified/accessing-privileged-approval-requests
PDF: https://help.zscaler.com/pdf/com/en/1525496.pdf

You can view and filter data for privileged approval requests as part of [My Approvals](/unified/about-my-approvals). To view privileged approval request data, go to **Logs **> **Insights **> **Privileged Remote Access** > **Requests**.
Requests Tools
The Requests page displays the following information and functionality:
...
![Approval Requests tools on the Approval Requests page in the Admin Portal](/downloads/unified-logs-insights-privileged-approval-requests-tools.png)
Viewing Requests
...
- **Status**: See logs by status for a specific privileged approval request.
...
![Adding filters to the Approval Requests table on the Approval Requests page ](/downloads/unified-logs-insights-privileged-approval-requests-filter.png)
- Click **Apply**.
...
- **Actions**: You can approve or reject the privileged approval reuqests by clicking the following icons:
- ![Approve%20icon.png](/downloads/zpa/dashboard-diagnostics/privileged-remote-access-monitoring/accessing-privileged-requests/Approve%20icon.png)
: Approve a privileged approval request.
- ![Reject%20icon.png](/downloads/zpa/dashboard-diagnostics/privileged-remote-access-monitoring/accessing-privileged-requests/Reject%20icon.png)
: Reject a privileged approval request.
![The Approval Requests table on the Approval Requests page ](/downloads/unified-logs-insights-privileged-approval-requests-table.png)
[]![Privileged Approval Requests total widgets displayed on the Approval Requests page in the Admin Portal](/downloads/unified-logs-insights-privileged-approval-requests-widgets.png)