...
Source: https://help.zscaler.com/unified/adding-cloud-application-risk-profile
PDF: https://help.zscaler.com/pdf/com/en/1494836.pdf
...
- Go to **Policies** > **Access Control** > **Internet & SaaS** > **Risk Profiles**.
-
...
- Select **Yes** or **No** for the following hosting and security characteristics, to see which applications they are applied to. You can also select **Unknown** if that information is not known. To learn more, see [Hosting and Security Characteristics](/unified/about-shadow-it-report#hosting-security).
