...
Source: https://help.zscaler.com/unified/configuring-chrome-enterprise-browser-connector-settings
PDF: https://help.zscaler.com/pdf/com/en/1529461.pdf

Within the Admin Portal, you can configure Chrome Enterprise Browser Connector settings to create access policies to verify if a user is accessing private applications via the Chrome Enterprise browser.
...
- Go to **Policies** > **Access Control** > **Clientless** > **Browser Extension **> **Settings**.
...
- **URL patterns to allow, one per line**: Enter the URL pattern that was copied from the Admin Portal.
- **Service accounts, one per line**: Enter the service account that was copied from the Admin Portal.
