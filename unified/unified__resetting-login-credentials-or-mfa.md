...
PDF: https://help.zscaler.com/pdf/com/en/1507596.pdf
...
-
Click **Re-Login** to log in to Admin Portal.
[See image.](#6success)
[]To reset the password by requesting another administrator, see [Configuring Security Settings for Users](/unified/configuring-security-settings-users).
[]
To reset the MFA option, contact your ZIdentity administrator. An administrator might delete the configured MFA option from the **Security Settings** tab for users. The user is then prompted to reconfigure MFA the next time they log in to the Admin Portal.
