...
Source: https://help.zscaler.com/unified/about-browser-access-log-fields
PDF: https://help.zscaler.com/pdf/com/en/1495996.pdf
...
| Exporter | The Browser Access Service instance to a Public Service Edge for Private Applications or a Private Service Edge for Private Applications instance | %[OPT]s%[OPT]j%[OPT]J%[OPT]o |
...
| NameID | The NameID received by Private Applications in the SAML assertion from the IdP | %[OPT]s%[OPT]j%[OPT]J%[OPT]o |
