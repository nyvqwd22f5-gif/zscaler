...
Source: https://help.zscaler.com/unified/monitoring-wi-fi-dashboard
PDF: https://help.zscaler.com/pdf/com/en/1500031.pdf
...
- Your Digital Experience Monitoring subscription level supports monitoring the Wi-Fi dashboard. To learn more, see [Ranges & Limitations](/unified/ranges-limitations#analytics).
- Your Digital Experience Monitoring role has the proper permission level. To learn more, see [About Digital Experience Monitoring Role-Based Administration](/unified/about-digital-experience-monitoring-role-based-administration).
Viewing the Wi-Fi Dashboard
To access the Wi-Fi Dashboard, go to **Analytics** > **Digital Experience Management** > **Dashboard** > **Wi-Fi Dashboard**. Time range options are available in increments from the previous **2 Hours** to **48 Hours**, or a **Custom range** within the last 14 Days. Use the time range filter and page filters to help narrow your scope of information:
...
- **Departments**: See [About Departments](/unified/about-departments).
- **Zscaler Locations**: See [About Locations](/unified/about-locations).
...
Certain OSs (i.e., macOS, Windows 11), with the latest updates, do not enable [Zscaler Client Connector's privacy settings](/unified/configuring-zscaler-client-connector-collect-digital-experience-monitoring-location-information) by default. When Zscaler Client Connector's **Collection Location Info for ZDX** is not enabled, privacy information for Wi-Fi details, such as SSID and BSSID, are not captured in the Wi-Fi Dashboard.
...
- **Wi-Fi Performance by Geolocation**: The SSID performance distribution via map location. You can switch between **Map View** or **List View**. The **Map View** is the default view.
...
Optionally, you can configure your Wi-Fi data collection to use signal strength and retransmission rate to identify low-performing Wi-Fi devices instead of ZDX Score. To learn more, see [Configuring Inventory Settings](/unified/configuring-inventory-settings#Wi-Fi).
To learn more about ZDX Score categories, see [About the ZDX Score](/unified/about-zdx-score).
...
- A link to view [granular details](#ap-details-page) about the access point.
...
- **BSSID**: The Basic Service Set Identifier.
- **Wi-Fi Adapter**: The adapter brand.
...
- **Wi-Fi Type**: The wireless communication standard.
...
[]![List view of access points](/downloads/zdx/analytics/monitoring-wi-fi-dashboard/zdx-wifi-dash-list-view.png)
