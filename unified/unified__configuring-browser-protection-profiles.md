...
Source: https://help.zscaler.com/unified/configuring-browser-protection-profiles
PDF: https://help.zscaler.com/pdf/com/en/1493166.pdf

Within the Admin Portal, you can add [Browser Protection profiles](/unified/about-browser-protection-profiles) to use in Browser Protection policies. For a complete list of ranges and limits for Browser Protection profiles, see [Ranges & Limitations](/unified/ranges-limitations).
To add a Browser Protection profile:
- Go to **Policies** > **Cybersecurity** > **Inline** **Security **> **Protection Profiles**.
