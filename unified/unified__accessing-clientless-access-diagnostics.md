...
Source: https://help.zscaler.com/unified/accessing-clientless-access-diagnostics
PDF: https://help.zscaler.com/pdf/com/en/1496466.pdf
...
- **JA3**: The JA3 fingerprint. This field only shows if you selected the JA3 hash when [configuring Browser Protection Profiles](/unified/configuring-browser-protection-profiles).
...
- **Application Segment**: The application segment name as configured in the Admin Portal. Click on the name to open the [Edit Application Segment window](/unified/editing-defined-application-segments), which includes the defined application.
...
[]![Clientless Access Diagnostics page within the Admin Portal](/downloads/zpa/dashboard-diagnostics/accessing-clientless-access-diagnostics/Clientless%20Access%20Diagnostics.png)