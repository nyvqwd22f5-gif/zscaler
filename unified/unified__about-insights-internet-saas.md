# About Insights for Internet & SaaS
Source: https://help.zscaler.com/unified/about-insights-internet-saas
PDF: https://help.zscaler.com/pdf/com/en/1497306.pdf

The Insights page is where you can view and define traffic information that you want to view when analyzing traffic through charts. To learn more about how to analyze your traffic on the Insights pages, see [Analyzing Traffic Using Insights](/unified/analyzing-traffic-using-insights).
...
- DNS
- Tunnel
- [Threat](/unified/about-threat-insights) (different from the other Insights pages)
- [SaaS Security](/unified/saas-security-insights)
...
To view Insights pages, go to Logs > Insights > Internet & SaaS and choose the Insights page you want to view.
- Clear all filters.
...
- [Web Data Types and Filters](/unified/web-data-types-and-filters)
- [Mobile Data Types and Filters](/unified/mobile-data-types-and-filters)
- [Firewall Data Types and Filters](/unified/firewall-data-types-and-filters)
- [DNS Data Types and Filters](/unified/dns-data-types-and-filters)
- [Tunnel Data Types and Filters](/unified/tunnel-data-types-and-filters)
- [Endpoint DLP Data Types and Filters](/unified/endpoint-dlp-data-types-and-filters)
- [Email DLP Data Types and Filters](/unified/email-dlp-data-types-and-filters)
- [Extranet Data Types and Filters](/unified/extranet-data-types-and-filters)
...
- Go to the [Insights Logs page](/unified/about-insights-logs).
