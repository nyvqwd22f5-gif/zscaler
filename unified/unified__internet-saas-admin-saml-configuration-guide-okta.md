# Internet & SaaS Admin SAML Configuration Guide for Okta
Source: https://help.zscaler.com/unified/internet-saas-admin-saml-configuration-guide-okta
PDF: https://help.zscaler.com/pdf/com/en/1491056.pdf

This guide illustrates how to configure Okta as the identity provider for the Zscaler service and use [SAML single sign-on (SSO) for admins](/unified/configuring-saml-admins). Refer to the Okta documentation for additional information about the steps in the guide.
Prerequisites
...
[See image.](#seeimage7)
The admin can now access the Admin Portal through Okta by clicking on the configured Zscaler application for Admin SAML.
[See image.](#seeimage0)
