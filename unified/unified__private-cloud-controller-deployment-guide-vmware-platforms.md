...
Source: https://help.zscaler.com/unified/private-cloud-controller-deployment-guide-vmware-platforms
PDF: https://help.zscaler.com/pdf/com/en/1529610.pdf

This deployment guide provides information on prerequisites and how to deploy a [Private Cloud Controller](/unified/deploying-private-cloud-controllers) on a VMware platform. For general information regarding Private Cloud Controller deployment, see [Deploying Private Cloud Controllers](/unified/deploying-private-cloud-controllers).
...
- Step 4: Verify that the deployed [Private Cloud Controller](/unified/deploying-private-cloud-controllers) is [running and healthy](/unified/managing-deployed-private-cloud-controllers#status). Also, check that it meets your sizing requirements.
After you have verified your deployment, you can perform additional tasks to maintain the system (i.e., changing your [Private Cloud Controller](/unified/deploying-private-cloud-controllers) console admin credentials or performing system software updates).
[]
...
[]Before you begin any procedures within the [Private Cloud Controller Deployment Guide for Linux](/zpa/pselabel/private-cloud-controller-deployment-guide-linux), make sure that you have all of the following prerequisites:
...
- A [Private Cloud Controller provisioning key](/zpa/pselabel/about-private-cloud-controller-provisioning-keys) obtained from the ZPA Admin Portal
...
- For **2 Destination > 2a Select name and folder**, the name and folder specified in vCenter has no impact on the Private Applications service. Select a name and folder that is suitable for your organization, then click **Next**.
...
- [Configure Static IP Addressing](/unified/networking-deployed-private-cloud-controllers#Static_IP)
- [Configure the Domain Name System (DNS) Resolver](/unified/networking-deployed-private-cloud-controllers#DNS)
...
- Verify the local time on the VMware machine is correct. If not, update the time using [Network Time Protocol](/unified/networking-deployed-private-cloud-controllers#NTP).
...
[]
[]The following deployment procedure only provides additional information on prerequisites and how to deploy a Private Cloud Controller on a VMware platform with vSphere Hypervisor.
...
-
Enter the following URL for the Private Cloud Controller image into the provided field, then click **Next**:
[https://dist.private.zscaler.com/vms/VMware/2025.04/zpa-pcc-el9-2025.04.ova](https://dist.private.zscaler.com/vms/VMware/2025.04/zpa-pcc-el9-2025.04.ova)
...
- The **Name and Location** specified in vSphere Hypervisor (ESXi) has no impact on the Private Applications service. Select a name and folder that is suitable for your organization, then click **Next**.
...
- [Configure Static IP Addressing](/unified/networking-deployed-private-cloud-controllers)
- [Configure the Domain Name System (DNS) Resolver](/unified/networking-deployed-private-cloud-controllers#DNS)
- Verify the local time on the VMware machine is correct. If not, update the time using [Network Time Protocol](/unified/networking-deployed-private-cloud-controllers#NTP).
- Make any necessary network configuration changes before applying the provisioning key.
