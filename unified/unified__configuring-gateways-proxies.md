...
- **Primary Proxy**: Select the primary proxy for the gateway. For information on configuring a proxy, see [Configuring Third-Party Proxies](/unified/configuring-third-party-proxies).
