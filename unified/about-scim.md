...
PDF: https://help.zscaler.com/pdf/com/en/1484426.pdf

System for Cross-domain Identity Management (SCIM) is a standard protocol for automating the exchange of identity information. Enabling SCIM allows ZPA to quickly remove users from ZPA when a user is disabled or deleted in your user directory and to enforce policies based on SCIM attributes and SCIM groups. To learn more, see [Deleting Users in SCIM](/zpa/deleting-users-scim).
...
Setting up SCIM requires [configuration](/zpa/enabling-scim-identity-management) in the ZPA Admin Portal and the use of an identity provider (IdP) partnered with Zscaler for SCIM:
...
You can also use custom SCIM clients to make REST API calls to Zscaler. To learn more, see [About SCIM APIs](/zpa/about-scim-apis) and [SCIM API Examples](/zpa/scim-api-examples).
[]About the SCIM Attributes Page
The** **SCIM Attributes page is a read-only table, and ZPA does not support custom attributes. You must enable SCIM for any information to appear on this page. To learn more, see [Enabling SCIM for Identity Management](/zpa/enabling-scim-identity-management).
...
![Viewing the SCIM Attributes page](/downloads/zpa/authentication/about-scim/zpa-scim-attributes-page-react.png)
