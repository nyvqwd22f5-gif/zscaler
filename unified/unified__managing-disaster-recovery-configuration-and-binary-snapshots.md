...
Source: https://help.zscaler.com/unified/managing-disaster-recovery-configuration-and-binary-snapshots
PDF: https://help.zscaler.com/pdf/com/en/1496981.pdf

After an App Connector Group or Private Service Edge Group is designated for [disaster recovery](/unified/understanding-disaster-recovery), a configuration and binary snapshot is saved in the local configuration files on your App Connector or Private Service Edge.
...
- `other_conf.json`: Contains uncategorized configuration data (e.g., App Connector-specific configuration data within a Private Service Edge).
...
If the disk space utilization of the App Connector or Private Service Edge exceeds 90%, the configuration and binary snapshots used for disaster recovery are not captured. To learn more, see [Troubleshooting App Connectors](/unified/troubleshooting-app-connectors) and [Troubleshooting Private Service Edges](/unified/troubleshooting-private-service-edges-private-applications).
