...
PDF: https://help.zscaler.com/pdf/com/en/1447906.pdf

This article describes how to add, edit, or delete multiple GRE tunnels by importing a CSV file. You can add up to 3,000 GRE tunnels. For a complete list of ranges and limits, see [Ranges & Limitations](/zia/ranges-limitations).
To import a CSV file:
- Go to **Administration** > **Static IPs & GRE Tunnels **>** GRE Tunnels**.
- Click **Sample Import CSV file** to download the GRE tunnels template.
