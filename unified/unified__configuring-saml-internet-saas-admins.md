# Configuring SAML for Internet & SaaS Admins
Source: https://help.zscaler.com/unified/configuring-saml-internet-saas-admins
PDF: https://help.zscaler.com/pdf/com/en/1490821.pdf
...
- [Admin SAML Configuration Guide for AD FS 3.0](/unified/admin-saml-configuration-guide-ad-fs-3-0)
- [Admin SAML Configuration Guide for Okta](/unified/admin-saml-configuration-guide-okta)
- [Admin SAML Configuration Guide for Microsoft Entra ID](/unified/admin-saml-configuration-guide-microsoft-entra-id)
