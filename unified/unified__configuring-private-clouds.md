...
Source: https://help.zscaler.com/unified/configuring-private-clouds
PDF: https://help.zscaler.com/pdf/com/en/1528621.pdf

To configure Private Clouds:
- Go to **Infrastructure **> **Private Access** > **Business Continuity **> **Private Clouds**.
-
Click **Add**.
Private Clouds that are managed by Zscaler are read only and cannot be configured, edited, or deleted. To learn more, see [Understanding Zscaler-Managed Business Continuity Cloud](/unified/understanding-zscaler-managed-business-continuity-cloud).
