...
PDF: https://help.zscaler.com/pdf/com/en/1355786.pdf
...
You can investigate what is causing a low score through the Applications Overview by clicking the name of the application. To learn more, see [Monitoring the Applications Overview](/zdx/monitoring-applications-dashboard#indivapp).
...
- Click **View in Users Page** to see data filtered by these locations. The [Users Overview](/zdx/monitoring-users-dashboard) appears with data relevant only to those locations.
After applying the fence, you can also go to the [Applications Overview](/zdx/monitoring-applications-dashboard) or return to the Performance Dashboard and the location fence remains as part of your filters.
