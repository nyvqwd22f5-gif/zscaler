...
PDF: https://help.zscaler.com/pdf/com/en/1472706.pdf
...
This feature applies only to Zscaler Client Connector version 4.2.1 and later for Windows. These passwords are not used when users manually update, uninstall, or revert Zscaler Client Connector from their own devices. You can set up required passwords for those actions on the app profile. To learn more, see [Configuring Zscaler Client Connector Profiles](/zscaler-client-connector/configuring-zscaler-client-connector-profiles).
