...
Source: https://help.zscaler.com/unified/adding-hosting-providers-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494721.pdf
...
Hosting providers such as AWS and IBM SmartCloud are widely used, and this category allows you to create rules specifically for these and other similar services. You can specify which applications your users are allowed to access and define a daily quote by bandwidth or time.
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Hosting Providers**.
The **Add Hosting Providers** window appears.
- In the **Add Hosting Providers** window, enter the rule attributes:
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-hosting-providers-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Hosting-Provider-Click-See-More.png)
...
You can select multiple profiles per rule for **Google Cloud Platform** only if the **Allow Cloud Storage Resources** field selection is the same for the profiles.
