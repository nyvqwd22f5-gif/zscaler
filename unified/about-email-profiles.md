...
PDF: https://help.zscaler.com/pdf/com/en/1492721.pdf

Email profiles let you create and manage domain and recipient email profiles that can be used as part of Zscaler's Data Loss Prevention (DLP) tools to detect and take action on sensitive data across multiple channels. To learn more, see [About Data Loss Prevention](/zia/about-data-loss-prevention), [About SaaS Security API DLP](/zia/about-saas-security-api-dlp), and [About Outbound Email Policy](/zia/about-outbound-email-policy).
...
On the Email Profiles page (Administration > Email Profiles), you can view and add the following profiles:
- [Domain Profiles](#domain-profiles)
- [Recipient Profiles](#recipient-profiles)
[]On the **Domain Profiles** page, you can do the following:
- [Add a domain profile](/zia/adding-domain-profile).
- Search for a domain profile.
- View a list of all domain profiles created for your organization. For domain profiles, you can see:
...
- [Edit, duplicate, or delete a domain profile](/zia/how-do-i-edit-delete-or-duplicate-items-admin-portal).
- Open the [Recipient Profiles page](/zia/adding-domain-profile).
![Domain Profile page](/downloads/zia/policies/outbound-email-policy/ZIA-Email-Profiles-Domain-Profiles_annotation_v2.png)
[]On the **Recipient Profiles** page, you can do the following:
- [Add a recipient profile](/zia/adding-domain-profile).
- Search for a recipient profile.
- View a list of all recipient profiles created for your organization. For recipient profiles, you can see:
...
- [Modify the table and its columns](/zia/how-do-i-use-tables-admin-portal).
- [Edit, duplicate, or delete a recipient profile](/zia/how-do-i-edit-delete-or-duplicate-items-admin-portal).
- Open the [Domain Profiles page](/zia/adding-domain-profile).
![Domain Profile page](/downloads/zia/policies/outbound-email-policy/ZIA-Email-Profiles-Recipient-Profiles_annotation.png)