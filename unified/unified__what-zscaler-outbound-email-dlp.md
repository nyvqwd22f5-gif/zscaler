...
Source: https://help.zscaler.com/unified/what-zscaler-outbound-email-dlp
PDF: https://help.zscaler.com/pdf/com/en/1503646.pdf
...
To learn more about how the Zscaler service enforces outbound email policy rules, see [Understanding Outbound Email Policy Enforcement](/unified/understanding-outbound-email-policy-enforcement).
...
[]![Diagram of the basic flow for the Zscaler Outbound Email DLP](/downloads/zia/policies/outbound-email-policy/ZIA-Email-DLP_Workflow-Diagram_v4.png)
To learn more about configuring Zscaler Outbound Email DLP, see [Step-by-Step Configuration Guide for Zscaler Outbound Email DLP](/unified/step-step-configuration-guide-zscaler-outbound-email-dlp).