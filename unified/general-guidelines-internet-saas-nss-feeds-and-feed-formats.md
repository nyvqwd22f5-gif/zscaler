# General Guidelines for Internet & SaaS NSS Feeds and Feed Formats
Source: https://help.zscaler.com/unified/general-guidelines-internet-saas-nss-feeds-and-feed-formats
PDF: https://help.zscaler.com/pdf/com/en/1496641.pdf
...
When configuring an NSS feed in the Admin Portal, enter the desired fields in the **Feed Output Format **text box.
Guidelines
...
- [NSS Feed Output Format: Web Logs](/unified/nss-feed-output-format-web-logs)
- [NSS Feed Output Format: Firewall Logs](/unified/nss-feed-output-format-firewall-logs)
- [NSS Feed Output Format: DNS Logs](/unified/nss-feed-output-format-dns-logs)
- [NSS Feed Output Format: Tunnel Logs](/unified/nss-feed-output-format-tunnel-logs)
- [NSS Feed Output Format: SaaS Security Logs](/unified/nss-feed-output-format-saas-security-logs)
- [NSS Feed Output Format: SaaS Security Activity Logs](/unified/nss-feed-output-format-saas-security-activity-logs)
- [NSS Feed Output Format: Admin Audit Logs](/unified/nss-feed-output-format-admin-audit-logs)
- [NSS Feed Output Format: Endpoint DLP Logs](/unified/nss-feed-output-format-endpoint-dlp-logs)
- [NSS Feed Output Format: Email DLP Logs](/unified/nss-feed-output-format-email-dlp-logs)
