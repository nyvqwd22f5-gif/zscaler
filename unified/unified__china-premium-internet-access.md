...
Source: https://help.zscaler.com/unified/china-premium-internet-access
PDF: https://help.zscaler.com/pdf/com/en/1494966.pdf

Zscaler's China Premium Internet Access feature provides fast and secure internet access for users residing in mainland China. The feature enables users to access international sites or applications such as Salesforce, Office 365, etc.
Premium Services
...
Zscaler associates the virtual IP (VIP) with the service and makes the required changes to the Internet & SaaS Public Service Edge within 48 hours.
-
...
- Define the [subcloud](/unified/about-subclouds) for both the Beijing and Shanghai DCs in the [PAC file](/unified/writing-pac-file) for remote users, so based on the users' location they are connected to the closest DC.
...
-
Open a Zscaler Support ticket to provide the source tunnel IP to the China POP for GRE.
Zscaler associates the VIP with the service and makes the required changes to the Internet & SaaS Public Service Edge within 48 hours.
-
Set the bandwidth limit for the IPSec/GRE tunnel to avoid exceeding the bandwidth purchased for the service.
You can view the bandwidth purchased in the purchase order.
- After your organization is provisioned, set up the tunnel to the VIP.
