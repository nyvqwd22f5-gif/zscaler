...
Source: https://help.zscaler.com/unified/multiple-language-support-euns
PDF: https://help.zscaler.com/pdf/com/en/1493846.pdf

The Zscaler service supports the following languages for [end user notifications](/unified/configuring-end-user-notifications) (EUNs):
- English
- Simplified Chinese
- Traditional Chinese
- Dutch
...
The Zscaler service only displays the Authentication dialog box in English. When configuring the [Acceptable Use Policy](/unified/configuring-acceptable-use-policy) notification, you can create a message containing multiple languages, because it's a free-form text field. However, a browser language check won't take place.