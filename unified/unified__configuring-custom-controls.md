...
Source: https://help.zscaler.com/unified/configuring-custom-controls
PDF: https://help.zscaler.com/pdf/com/en/1493026.pdf

Within the Admin Portal, you can add custom controls to use as part of your AppProtection profiles. To learn more, see [About AppProtection Profiles](/unified/about-appprotection-profiles). For a complete list of ranges and limits for custom controls, see [Ranges & Limitations](/unified/ranges-limitations).
To add a new custom control:
- Go to **Policies **>** Cybersecurity **>** Inline Security **>** Protection Controls.**
...
Click **Add More** if you need additional values for this control parameter. To learn more about the available Regex values, see [Defining Regular Expression Values](/unified/defining-regular-expression-values).
[See image.](#img-value)
...
- **UNLOCK**
- **Not UNLOCK**
- Repeat previous steps for each control parameter.
...
In addition to severity levels, custom controls have a paranoia level of 1 as they are used in an [AppProtection profile](/unified/configuring-appprotection-profiles#paranoia-execution).
- For **Action**, select how the user traffic will be handled for the control parameters selected in the **Select Control Type** tab and defined on the **Set Control Definition** tab:
