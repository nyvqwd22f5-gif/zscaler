...
Source: https://help.zscaler.com/unified/about-user-risk-report
PDF: https://help.zscaler.com/pdf/com/en/1492876.pdf
...
On the User Risk Score Report page (Analytics > Internet & SaaS > Analytics > Company Risk Score Report > Top Risky Users), you can view the following sections:
- **Overview**: The section shows the following information about the user:
- **Email Address**: The email address of the user.
- **Department**: The [department](/unified/about-departments) that the user belongs to in your organization.
- **User Group**: The name of the [groups](/unified/about-groups) that the user belongs to in your organization.
...
- **Recent Risk Increases**: Any risk score increases since the last daily risk score computation. You can view the recent increases in the recent risk score only when **Real-Time Risk Score Updates **is enabled in the [Advanced Settings](/unified/configuring-advanced-settings).
...
Click **View All Events** to view all the events that have contributed to the risk score. Click on an event, and you are redirected to the [Web Insights logs](/unified/about-insights-logs) page, where you can view the logs for that event.
