...
Source: https://help.zscaler.com/unified/configuring-index-tool-vmware
PDF: https://help.zscaler.com/pdf/com/en/1493296.pdf
...
To learn more about the AWS Index Tool, see [Configuring the Index Tool with Amazon Web Services](/unified/configuring-index-tool-amazon-web-services) and [Configuring the Index Tool for Azure VMs](/unified/configuring-index-tool-azure).
...
[See image.](#VM_CLI4)
- Go back to the Admin Portal, and go to **PPolicies** >** Data Protection **>** Common Resources **>** Index Tool**.
