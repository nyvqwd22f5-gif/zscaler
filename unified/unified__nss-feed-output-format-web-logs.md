...
Source: https://help.zscaler.com/unified/nss-feed-output-format-web-logs
PDF: https://help.zscaler.com/pdf/com/en/1497796.pdf
...
The following tables display information about the web log fields and example values for those fields. If applicable, the web log fields are mapped to their corresponding columns in [Web Insights Logs](/unified/web-insights-logs-columns) (Logs > Insights > Web Insights > Logs).
Date/Time
...
Bandwidth Control
-
- [](/unified/about-bandwidth-control)
-
- [](/unified/about-bandwidth-control)
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
...
| %s{bwclassname} | The name of the bandwidth class | Entertainment, General Surfing, Office AppsThe full list is under the Bandwidth Classes field on the Bandwidth Control page (Infrastructure > Internet & SaaS > Network Policies > Bandwidth Control). | Bandwidth Class |
| %s{bwrulename} | The name of the bandwidth rule | Office 365Any name under the Rule Name column on the Bandwidth Control page (Infrastructure > Internet & SaaS > Network Policies > Bandwidth Control) | Bandwidth Rule |
Cloud Application
-
- [](/unified/about-cloud-applications)
-
- [](/unified/about-cloud-app-control)
-
-
-
-
-
[](/unified/about-instance-discovery-report)[](/unified/about-instance-discovery-report)[](/unified/about-instance-discovery-report)[](/unified/about-instance-discovery-report)[](/unified/about-instance-discovery-report)[](/unified/about-instance-discovery-report)
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
| %s{appname} | The name of the cloud application | Adobe Connect, Craigslist, DropboxThe full list is on the Cloud Applications page (Policies > Access Control > Internet & SaaS > SaaS Applications). | Cloud Application |
| %s{appclass} | The cloud application category of the application that was accessed | Administration, Collaboration, Web MailThe full list is on the Cloud App Control Policy page (Policies > Access Control > Internet & SaaS > Policies). | Cloud Application Class |
...
DLP
-
- [](/unified/about-dlp-dictionaries)
-
- [](/unified/about-dlp-dictionaries)
-
- [](/unified/about-data-loss-prevention)
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
| %s{dlpdict} | The DLP dictionaries that were matched, if any | Credit Cards|Gambling|MRN NumbersThe full list is under the Name column on the DLP Dictionaries page (Policies > Data Protection > Common Resources > Dictionaries & Engines). | DLP Dictionaries |
| %s{dlpdicthitcount} | The number of hits for each of the dictionaries that were matched in the transaction | 4|5|1|2 |  |
| %s{dlpeng} | The DLP engine that was matched, if any | HIPAAThe full list is under the Name column on the DLP Engines page (Policies > Data Protection > Common Resources > Dictionaries & Engines). | DLP Engine |
...
| %s{dlprulename} | The name of the DLP rule applied to the transaction. Applies only to Allow rules, not Block. To enable logging for DLP Allowed Rule Name, contact Zscaler Support. | DLP_Rule_1Any Rule Name with the Allow Action on the Data Loss Prevention page (Policies > Data Protection > Policy > Inline Controls > Data Loss Prevention) | Allowed DLP Rule Name |
...
File Type Control
-
- [](/unified/about-file-type-control)
-
- [](/unified/about-file-type-control)
-
- [](/unified/about-file-type-control)
...
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
| %s{ft_rulename} | The name of the File Type Control rule applied to the transaction. Applies only to Allow rules, not Block | File_Type_1Any Rule Name with the Allow Action on the File Type Control page (Policies > Access Control > Internet & SaaS > File Type Control) | Allowed File Type Rule |
| %s{fileclass} | The class of file downloaded during the transaction | Active Web Contents, Archive Files, AudioThe full list is under the File Type field on the File Type Control page (Policies > Access Control > Internet & SaaS > File Type Control). |  |
| %s{filetype} | The type of file downloaded during the transaction | RAR Files, ZIP, Windows ExecutablesThe full list is under the File Type field on the File Type Control page (Policies > Access Control > Internet & SaaS > File Type Control). | Download File Type |
| %s{filename} | The name of downloaded files during the transaction | nssfeed.txt | Download File Name |
| %s{filesubtype} | The subtype of the downloaded file (extension name) | rar, exe, pptSubtypes are in parentheses under the File Types field on the File Type Control page (Policies > Access Control > Internet & SaaS > File Type Control). |  |
| %s{upload_fileclass} | The class of file uploaded during the transaction | Active Web Contents, Archive Files, AudioThe full list is under the File Type field on the File Type Control page (Policies > Access Control > Internet & SaaS > File Type Control). |  |
| %s{upload_filetype} | The type of file uploaded during the transaction | RAR Files, ZIP, Windows ExecutablesThe full list is under the File Type field on the File Type Control page (Policies > Access Control > Internet & SaaS > File Type Control). | Upload File Type |
| %s{upload_filename} | The name of uploaded files during the transaction | nssfeed.exe | Upload File Name |
| %s{upload_filesubtype} | The subtype of the uploaded file (extension name) | rar, exe, pptSubtypes are in parentheses under the File Types field on the File Type Control page (Policies > Access Control > Internet & SaaS > File Type Control). |  |
...
Forwarding Control
-
- [](/unified/about-forwarding-control)
-
-
-
-
...
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
| %s{rdr_rulename} | The name of the redirect/forwarding policy | FWD_Rule_1Any name under the Rule Name column on the Forwarding Control page (Infrastructure > Internet & SaaS > Network Policies > Forwarding Control Policy) | Forwarding Rule |
...
| %s{zpa_app_seg_name} | The name of the Private Applications' application segment | test_app_segment | Application Segment |
HTTP Transaction
-
-
-
...
-
-
- [](/unified/web-insights-logs-filters)
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
...
| %s{contenttype} | The name of the content type | application/vnd_apple_keynoteimage/giftext/x_pythonThe full list is under the Content Type filter on the Web Insights page (Logs > Insights > Web Insights). | Content Type |
Mobile Application
-
- [](/unified/mobile-insights-logs-filters)
-
- [](/unified/mobile-insights-logs-filters)
-
- [](/unified/mobile-insights-logs-filters)
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
| %s{mobappname} | The name of the mobile app, if any | Adobe Reader, Amazon, DropboxThe full list is under the Mobile Application filter on the Mobile Insights page (Logs > Insights > Mobile Insights). | Mobile Application |
| %s{mobappcat} | The category of the mobile app, if any | Communication, Education, GamesThe full list is under the Mobile Application Category filter on the Mobile Insights page (Logs > Insights > Mobile Insights). | Mobile Application Category |
| %s{mobdevtype} | The type of mobile device | iOS, Google Android, Apple iPhoneThe full list is under the Mobile Device Type filter on the Mobile Insights page (Logs > Insights > Mobile Insights). | Mobile Device Type |
Network
-
- [](/unified/web-insights-logs-filters)
-
...
| %s{proto} | The protocol type of the transaction | HTTP, FTPThe full list is under the Protocol filter on the Web Insights page (Logs > Insights > Web Insights). | Protocol |
| %s{alpnprotocol} | The Application-Layer Protocol Negotiation (ALPN) protocol | FTP, SMBThe full list is under the ALPN Protocol filter on the Web Insights page (Logs > Insights > Web Insights). | ALPN Protocol |
| %s{trafficredirectmethod} | The traffic forwarding method to Internet & SaaS Public Service Edges | DNAT (Destination Translation)GRE (GRE Tunnel)IPSEC (IPSec Tunnel)PBF (Policy Based Forwarding)PAC (PAC File)PAC_GRE (PAC File over GRE Tunnel)PAC_IPSEC (PAC File over IPSec Tunnel)Zscaler Client Connector (Zscaler App) | Traffic Forwarding |
...
| %s{urlfilterrulelabel} | The name of the rule that was applied to the URL filter | URL_Filtering_1Any name under the Rule Name column on the URL & Cloud App Control page (Policies > Access Control > Internet & SaaS > URL Filtering) | URL Filtering Policy Name |
| %s{apprulelabel} | The name of the rule that was applied to the application | File_Sharing_1Any name under the Rule Name column on the URL & Cloud App Control page (Policies > Access Control > Internet & SaaS > Policies) | Cloud Application Policy Name |
Sandbox
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
...
| %s{externalspr} | The SSL policy reasons | BlockedInspectedN/ANot inspected because of O365 bypassNot inspected because of SSL policyNot inspected because of UCaaS bypassNot inspected because of Zscaler best practicesThe full list is under the SSL Policy Reason filter on the Web Insights page (Logs > Insights > Web Insights). | SSL Policy Reason |
...
| %s{cltsslfailreason} | The reason for the client SSL handshake failure | Bad Record Mac, Certificate Unknown, Close Notify, etc.The full list is under the Client SSL Handshake Failure Reason filter on the Web Insights page (Logs > Insights > Web Insights). | Client SSL Handshake Failure Reason |
...
| %s{srvtlsversion} | The TLS/SSL version used for communication between the Internet & SaaS Public Service Edge and the server | SSL2SSL3TLS1_1TLS1_2TLS1_3 | Server Connection TLS Version |
...
| %s{is_sslselfsigned} | Indicates whether the certificate presented by the server to the Internet & SaaS Public Service Edge was self-signed | NoNoneYes | Server Certificate Self Signed |
...
Threat Protection
[](/unified/web-insights-logs-filters#SusC)[](/unified/web-insights-logs-filters#SusC)
-
-
-
-
...
- [](/unified/about-url-categories)
- [](/unified/web-insights-logs-filters)
[](/unified/web-insights-logs-columns)
-
-
-
-
...
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
| %s{urlclass} | The class of the destination URL | Bandwidth Loss, General Surfing, Privacy RiskThe full list is on the URL Categories page (Policies > Access Control > Internet & SaaS > URL Categories). | URL Class |
| %s{urlsupercat} | The super category of the destination URL | Entertainment/Recreation, Travel, SecurityThe full list is on the URL Categories page (Policies > Access Control > Internet & SaaS > URL Categories). | URL Super Category |
| %s{urlcat} | The category of the destination URL | Entertainment, Adult Themes, GamesSpyware CallbackThe full list is on the URL Categories page (Policies > Access Control > Internet & SaaS > URL Categories).Also includes the Advanced Threat Category. The full list is under the Advanced Threat Category filter on the Web Insights page (Logs > Insights > Web Insights). | URL Category |
...
Miscellaneous
[](/unified/configuring-company-profile)[](/unified/web-insights-logs-columns)
| Field | Description | Example | Insights Logs |
| ----- | ----------- | ------- | ------------- |
