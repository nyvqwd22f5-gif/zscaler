...
Source: https://help.zscaler.com/unified/about-failed-posture-devices
PDF: https://help.zscaler.com/pdf/com/en/1532413.pdf

Failed Posture Devices is available for Windows users only. You must also have Digital Experience Monitoring or Zscaler Client Connector Telemetry (formerly [Health Metrics](/unified/configuring-zscaler-client-connector-app-profiles#Health_Metrics)) enabled.
You can view a list of devices that failed posture checks. To view a trend of devices failing posture checks and what posture profiles are involved, see [Understanding the Zscaler Client Connector Dashboard](/unified/understanding-zscaler-client-connector-dashboard).
...
- [View device fingerprint information for failed posture devices](/unified/viewing-device-fingerprint-information-failed-posture-devices).
