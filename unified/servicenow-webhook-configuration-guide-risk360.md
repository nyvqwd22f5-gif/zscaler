...
PDF: https://help.zscaler.com/pdf/com/en/1533800.pdf
...
- In the Risk360 Admin Portal, go to **Analytics** > **Risk360** > **Alerts** > **Webhooks** > **Add Webhooks**.
...
-
Edit the token in your script to the one used for the webhook configuration in the [Experience Center](#token-step).
