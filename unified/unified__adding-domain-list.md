...
Source: https://help.zscaler.com/unified/adding-domain-list
PDF: https://help.zscaler.com/pdf/com/en/1533783.pdf

You can add a list of domains to use when adding a ruleset for traffic steering to use with location-based policies. To learn more, see [About Location-Based Policies](/unified/about-location-based-policies).
...
- Click **Save**.
You can enter a maximum of 300 domain lists. After you create a list, you can select it in Domain Inclusion and Domain Exclusion when [adding a ruleset](/unified/adding-ruleset). You must use the list in a ruleset, and you cannot use it directly in an app profile.
