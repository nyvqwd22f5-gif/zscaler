...
Source: https://help.zscaler.com/unified/configuring-password-policy
PDF: https://help.zscaler.com/pdf/com/en/1505601.pdf

The Password Policy page allows you to configure policies that users must follow while creating or resetting passwords to access the Admin Portal.
To configure the password policy:
- Go to **Administration >** **Identity > ZIdentity > Password Complexity**.
