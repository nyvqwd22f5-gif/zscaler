...
Source: https://help.zscaler.com/unified/about-vpn-user-enablement
PDF: https://help.zscaler.com/pdf/com/en/1532367.pdf
...
On the User Enablement page (Infrastructure > Private Access > Component > VPN (For Legacy Apps) > User Enablement), you can do the following:
- View a list of applied filters available from the current and previous user enablement rules. Applied filters must be saved to the user enablement rule first before they can be viewed. Use the drop-down menu to select the applied filters to view. To learn more, see [Using Tables](/unified/using-tables#filter).
...
- Filter the information that appears in the table. By default, no filters are applied. You can also save applied filters to your preferences so that they're visible in future user enablement rules. To learn more, see [Using Tables](/unified/using-tables).
- [Add a new user enablement rule.](/unified/configuring-vpn-user-enablement)
...
- [Edit an existing user enablement rule.](/unified/editing-vpn-user-enablement)
- Delete a user enablement rule.
- [Modify the columns displayed in the table.](/unified/using-tables)
- Display more rows or a different page of the table.
![VPN User Enablement page within the Admin Portal](/downloads/zpa/editing-vpn-user-enablement/5.1.25%20update%20user%20enablement%20page%20w%20steps.png)