...
Source: https://help.zscaler.com/unified/configuring-custom-url-categories
PDF: https://help.zscaler.com/pdf/com/en/1493946.pdf

Creating and configuring custom categories provides you with greater flexibility when creating [URL filtering policies](/unified/about-url-filtering), allowing specific websites, keywords, and IP ranges to be controlled as desired. You can create up to 64 custom categories and you can also choose whether the URLs, keywords, and IP ranges you add remain mapped to their parent URL category (the [predefined URL category](/unified/about-url-categories) to which they currently belong).
Custom categories can only be managed by super admins, admins with the Custom URL Management role, or admins with the Custom URL Management and Override Existing URLs role. To learn more, see [Adding Admin Roles](/unified/adding-admin-roles).
To add a custom URL category:
- Go to **Policies **> **Access Control **> **Internet & SaaS** >** URL Categories**.
- In the upper left corner, click **Add URL Category**.
or,
...
To learn how to find the parent category of a given URL, see [Looking up URLs in the Admin Portal](/unified/looking-urls-internet-saas). For guidance on entering URLs, see the [URL format guidelines](/unified/url-format-guidelines).
-
