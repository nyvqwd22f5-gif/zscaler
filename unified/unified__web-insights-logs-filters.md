...
Source: https://help.zscaler.com/unified/web-insights-logs-filters
PDF: https://help.zscaler.com/pdf/com/en/1497391.pdf

Filters define the traffic information that you view in your Web Insights Logs. To learn more about logs, see [About Insights Logs](/unified/about-insights-logs).
...
- Upload/Attachments
- View
[]Use this filter to view transactions associated with a specific [application segment](/unified/about-applications). The default option for this filter is **None**. You can search for specific application segments.
...
- None
- Yes
[]Use this filter to view the cipher suite agreed upon during the SSL handshake between the client and the Internet & SaaS Public Service Edge. This filter applies to SSL inspected traffic. The default option for this filter is **None**. You can search for specific cipher suites.
...
[]Use this filter to see the version of TLS used for communication between the client and the Internet & SaaS Public Service Edge. This filter applies to SSL inspected traffic. The default option for this filter is **None**. You can search for specific TLS versions.
...
- **Collaboration & Online Meetings App Control**: This refers to the [Collaboration & Online Meetings rule](/unified/adding-collaboration-online-meetings-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Consumer**: This refers to the [Consumer rule](/unified/adding-consumer-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **DNS Over HTTPS Services**: This refers to the [DNS Over HTTPS Services Rule](/unified/adding-dns-over-https-services-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **File Sharing**: This refers to the [File Sharing rule](/unified/adding-file-sharing-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Finance**
- **Health Care**
- **Hosting Providers**: This refers to the [Hosting Providers rule](/unified/adding-hosting-providers-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Human Resources**: This refers to the [Human Resources rule](/unified/adding-human-resources-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Instant Messaging**: This refers to the [Instant Messaging rule](/unified/adding-instant-messaging-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **IT Services**: This refers to the [IT Services rule](/unified/adding-it-services-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Legal**
- **Productivity and CRM Tools**: This refers to the [Productivity & CRM tools rule](/unified/adding-productivity-crm-tools-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Sales & Marketing**: This refers to the [Sales & Marketing rule](/unified/adding-sales-marketing-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Social Networking**: This refers to the [Social Networking & Blogging rule](/unified/adding-social-networking-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **System & Development**: This refers to the [System & Development rule](/unified/adding-system-development-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Video Streaming**
- **Webmail**: This refers to the [Webmail rule](/unified/adding-webmail-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
...
[]Use this filter to view transactions associated with a specific hostname from support devices. Enter all or part of the device model in the text field and **Contains**, **Starts With**, **Ends With**, **Exact Match**, **Does Not Contain**, **Does Not End With**, **Not Null**, or **Is Null**. This filter is not available for admins with [device information obfuscation](/unified/obfuscating-device-information-admins) enabled.
...
- **Advanced Threat Protection**: This refers to the [Advanced Threat Protection policy](/unified/configuring-advanced-threat-protection-policy).
- **Collaboration & Online Meetings App Control**: This refers to the [Collaboration & Online Meetings rule](/unified/adding-collaboration-online-meetings-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Consumer**: This refers to the [Consumer rule](/unified/adding-consumer-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Data Loss Prevention**: This refers to the [Data Loss Prevention policy](/unified/about-data-loss-prevention).
- **DNS**: This refers to the [DNS Control policy](/unified/about-dns-control).
- **DNS Over HTTPS Services**: This refers to the [DNS Over HTTPS Services Rule](/unified/adding-dns-over-https-services-rule-cloud-app-control) for the [Could App Control policy](/unified/about-cloud-app-control).
- **File Sharing**: This refers to the [File Sharing rule](/unified/adding-file-sharing-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **File Type Control**: This refers to the [File Type Control policy](/unified/about-file-type-control).
- **Firewall Filtering**: This refers to the [Firewall Control policy](/unified/about-firewall-filtering).
- **Hosting Providers**: This refers to the [Hosting Providers rule](/unified/adding-hosting-providers-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Human Resources**: This refers to the [Human Resources rule](/unified/adding-human-resources-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Instant Messaging**: This refers to the [Instant Messaging rule](/unified/adding-instant-messaging-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Intrusion Prevention**
- **IT Services**: This refers to the [IT Services rule](/unified/adding-it-services-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Malware Protection**: This refers to the [Malware Protection policy](/unified/configuring-malware-protection-policy).
- **Mobile App Store Control**: This refers to the [Mobile App Store Control policy](/unified/about-mobile-app-store-control).
- **NAT Control**: This refers to the [NAT Control policy](/unified/about-nat-control).
- **Productivity and CRM Tools**: This refers to the [Productivity & CRM tools rule](/unified/adding-productivity-crm-tools-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Sales & Marketing**: This refers to the [Sales & Marketing rule](/unified/adding-sales-marketing-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **Sandbox**: This refers to the [Sandbox policy](/unified/about-sandbox).
- **Social Networking**: This refers to the [Social Networking & Blogging rule](/unified/adding-social-networking-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **System & Development**: This refers to the [System & Development rule](/unified/adding-system-development-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
- **URL Filtering**: This refers to the [URL filtering policy](/unified/about-url-filtering).
- **Video Streaming**
- **Webmail**: This refers to the [Webmail rule](/unified/adding-webmail-rule-cloud-app-control) for the [Cloud App Control policy](/unified/about-cloud-app-control).
...
- **HTTP Proxy**: Transactions from HTTP CONNECT requests destined to a Internet & SaaS Public Service Edge IP address.
...
- Above 100MB
- Custom
[]Use this filter to see if the certificate presented by the Origin Content Server (web server) to the Internet & SaaS Public Service Edge was self-signed. The default option for this filter is **None**. The following options appear under this filter:
- No
- None
- Yes
[]Use this filter to view the validation type for the certificate presented by the server to the Internet & SaaS Public Service Edge. The default option for this filter is **None**. The following options appear under this filter:
- Domain Validation
- Extended Validation
- None
- Organization Validation
[]Use this filter to view the validity duration of the certificate presented by the server to the Internet & SaaS Public Service Edge (i.e. How long is the certificate valid for?). The default option for this filter is **None**. The following options appear under this filter:
- 0–3 months
- 3–12 months
- More than 12 months
- None
[]Use this filter to view the cipher suite agreed upon during the SSL handshake between the Internet & SaaS Public Service Edge and the server. The default option for this filter is **None**. You can search for specific cipher suites.
The cipher suite names are listed in OpenSSL format. To view them in RFC format, use this [link](https://testssl.sh/openssl-iana.mapping.html) to map between the two notations.
[]Use this filter to see the version of TLS used for communication between the Internet & SaaS Public Service Edge and the server. The default option for this filter is **None**. You can search for specific versions. The following versions appear under this filter:
- SSL 2.0
- SSL 3.0
- TLS 1.0
- TLS 1.1
...
- Listen
- Upload
[]Use this filter to view transactions based on the “raw” Page Risk Index score of a URL; it filters based on the Suspicious Content [column](/unified/web-insights-logs-columns). You can view transactions for a certain range of Page Risk Index scores by entering a minimum and maximum value. The value ranges are from 0 to 100. To learn more about the Suspicious Content Protection (Page RiskTM), see [Configuring the Advanced Threat Protection Policy](/unified/configuring-advanced-threat-protection-policy).
...
-
Click **Apply Filter**.
For optimized and accelerated results, the Admin Portal might show recommendations to switch between **URL**, **Path**, **Host**, and **Domain **based on your seach inputs. You can choose to **Apply Recommentation**, **Ignore **it,** **or **Cancel **the search. For example, if you select **URL** and enter `www.zscaler.com` in the Search field, the Internet & SaaS service shows a recommendation pop-up window to search it as **Host** to minimize the processing time in generating the logs.
...
- **Allowed - No Active Content**: View download transactions of unknown PDF or Microsoft Office files that are allowed because they are classified as benign in [Sandbox static analysis](/unified/configuring-sandbox-policy#first-time-action).
- **Allowed and No Scan**: View download transactions of unknown files that were allowed but not scanned due to your [configured Sandbox policy](/unified/configuring-sandbox-policy#first-time-action).
...
- **Blocked - Tenant Restricted**: View blocked transactions because of your configured [Tenant Restriction ](/unified/about-tenant-profiles)policies.
- **Blocked with caution**: View blocked transactions where the service displayed a caution notification.
- **Isolate**: View transactions sent for isolation by Isolation.
...
This filter is disabled by default. To enable the filter, contact Zscaler Support.
[]Use this filter to view the data to activities associated with DLP rules that are evaluated, but no action was taken based on the rule. To populate this field, you must enable the **Evaluate All Rules** mode for inline DLP rule evaluation in the [DLP Advanced Settings](/unified/configuring-dlp-advanced-settings#RuleEvaluation) page (Policies > Data Protection > Common Resources > Advanced Settings > DLP Advanced Settings). To learn more, see [Configuring DLP Policy Rules with Evaluate All Rules Mode Enabled](/unified/configuring-dlp-policy-rules-evaluate-all-rules-mode-enabled#EvaluateAllRules).
