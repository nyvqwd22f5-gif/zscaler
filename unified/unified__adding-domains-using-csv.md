...
Source: https://help.zscaler.com/unified/adding-domains-using-csv
PDF: https://help.zscaler.com/pdf/com/en/1530708.pdf

You can add domains on the Seeds Management page to run frequent scans on them to detect vulnerabilities for external attack surfaces. The Risk360 service then quantifies the risk determined on various parameters on exposed assets for potential breach and visualizes them as factors on the [Factors](/unified/viewing-risk-factors) page.
To add domains:
- Go to **Administration** > **Admin Management** > **Administrator Management **> **Seeds Management**.
...
The [Seeds Management](/unified/about-risk360-seeds-management) page displays all the domains from the CSV file. The Risk360 service takes up to 24–48 hours to scan and analyze the domains.
