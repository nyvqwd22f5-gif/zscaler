# About Compliance
Source: https://help.zscaler.com/unified/about-compliance
PDF: https://help.zscaler.com/pdf/com/en/1514861.pdf
...
If you subscribed to the Advanced SSPM service, you can access the Compliance page. To learn more, see [What Is Advanced Posture Management?](/unified/what-advanced-posture-management)
...
- View the compliance status by framework or platform. Expand a framework or a platform to view the status breakdown by tenants.
...
- **Framework**: The name of the framework. Expand the framework name to view a list of security checks associated with that framework. Click a security check to open the [control panel](/unified/about-control-panel) and further review it.
...
![Compliance Page](/downloads/zia/policies/saas-security/posture-management/posture-management-advanced/about-compliance/CompliancePage_New1.png)