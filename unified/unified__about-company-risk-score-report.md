...
Source: https://help.zscaler.com/unified/about-company-risk-score-report
PDF: https://help.zscaler.com/pdf/com/en/1497206.pdf

The following conditions apply when accessing the Company Risk Score Report:
- Risk scores are calculated only for organizations with Advanced Threat Protection (Available in the Business bundle and higher or sold separately).
...
- Configure stronger polices by monitoring your organizational, location, and user-level risk exposure.
...
- **Top Risky Users**: The top risky users in your organization. Conduct further investigation of their activity. Click on a user, and you are redirected to the [User Risk Report](/unified/about-user-risk-report) page.
