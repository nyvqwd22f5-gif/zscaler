...
Source: https://help.zscaler.com/unified/configuring-private-cloud-controllers
PDF: https://help.zscaler.com/pdf/com/en/1528636.pdf

Within the Admin Portal, you can create Private Cloud Controllers, Private Cloud Controller groups, and provisioning keys. For a complete list of ranges and limits per feature, see [Ranges & Limitations](/unified/ranges-limitations).
To add a new Private Cloud Controller:
- Go to **Infrastructure** > **Private Access** > **Business Continuity** > **Private Cloud Controllers**.
-
Click **Add**.
Private Cloud Controllers that are managed by Zscaler are read only and cannot be configured, edited, or deleted.
...
After deployment, the Private Cloud Controller launches and makes initial contact with the cloud. It presents a key as its ID, allowing the cloud to verify that this is an authentic Private Cloud Controller and to identify which Private Cloud Controller group it belongs to. Private Applications then automatically completes the deployment process.
...
[]![Choosing an Existing Provisioning Key in the Add Private Cloud Controller Page](/downloads/zpa/configuring-private-cloud-controllers/zpa-add-private-cloud-controller-page-step1-choose-existing-pkey.jpg)
[]Click **Next**.
- []On the **Signing Certificate** page, select the certificate from the drop-down menu that is used to sign certificates it issues to the Private Cloud Controller. If you need to generate a new enrollment certificate, see [Generating an Enrollment Certificate](/unified/generating-zscaler-issued-enrollment-ca-certificates).
[See image.](#seeimage2)
- Click **Next**.
...
The **Instances of Provisioning Key Reuse** field cannot be modified. The number of Private Cloud Controllers enrolled in this Private Cloud Controller group are tracked and automatically display the number in this field. This helps ensure that keys are not being used improperly by unknown parties to enroll Private Cloud Controllers.
[See image](#seeimage5)
- Click **Next**.
[]![Creating a Provisioning Key in the Add Private Cloud Controller Page](/downloads/zpa/configuring-private-cloud-controllers/zpa-add-private-cloud-controller-page-step4-create-pkey.jpg)
...
[See image.](#seeimage7)
- Click **Done**.
[]![Reviewing the Documentation in the Add Private Cloud Controller Page of the Admin Portal](/downloads/zpa/business-continuity-management/private-cloud-controllers/configuring-private-cloud-controllers/zpa-add-private-cloud-controller-step6-review-docs.png)