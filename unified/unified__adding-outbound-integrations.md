...
Source: https://help.zscaler.com/unified/adding-outbound-integrations
PDF: https://help.zscaler.com/pdf/com/en/1515291.pdf
...
- Under** Revocation Email**, enter an email address to be used to notify the users when a previously accessible app is revoked or banned. To learn more, see[ Revoking and Banning Apps](/unified/revoking-and-banning-apps).
