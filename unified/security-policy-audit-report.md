...
PDF: https://help.zscaler.com/pdf/com/en/1400711.pdf

[Watch a video about the Security Policy Audit Report](https://fast.wistia.net/embed/iframe/18ox800one)
...
You can view the report in the ZIA Admin Portal by going to **Analytics** > **Security Policy Audit Report**.
[See image.](#report)
Report Sections
...
In **Policy** > **Browser Control**, the Browser Vulnerability Protection section is only applicable when you are using browser-based authentication.
...
| Sandbox | Known malicious files from any URL category of any file type | Action = Block
ALL FILE TYPES
ALL URL CATS |
