...
Source: https://help.zscaler.com/unified/viewing-quarterly-business-review-reports
PDF: https://help.zscaler.com/pdf/com/en/1531254.pdf
...
Go to **Logs** > **Insights** > **Private Applications** > **Usage** > **Quarterly Business Reports** to view a list of downloadable quarterly business reports based on your organization's private application usage.
...
- **Where are my apps hosted?**: A geospatial distribution of your users around the world by showing the number of users, number of App Connectors, and traffic percentage originating from each location.
...
- Go to **Logs** > **Insights** > **Private Applications** > **Usage** > **Quarterly Business Reports**.
- Click the **Download** icon to download a specific report.
![Download QBR](/downloads/zia/dashboard-analytics/reports/viewing-quarterly-business-review-reports/ZPA-QBR-Download_0.png)