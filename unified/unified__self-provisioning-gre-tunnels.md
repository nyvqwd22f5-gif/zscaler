...
Source: https://help.zscaler.com/unified/self-provisioning-gre-tunnels
PDF: https://help.zscaler.com/pdf/com/en/1495331.pdf

You can self-provision your GRE tunnels to connect to the Zscaler service via the Admin Portal. To learn more, see [About GRE Tunnels](/unified/about-gre-tunnels).
...
To configure the self-service GRE tunnels from the Admin Portal:
- Go to **Infrastructure** > **Internet & SaaS** > **Traffic Forwarding** > **Static IPs & GRE Tunnel**.
- On the **GRE Tunnels** page, click **Add GRE Tunnels**. The** Add GRE Tunnel Configuration** wizard opens. If you edit an existing configuration, the **Edit GRE Tunnel Configuration** wizard opens.
...
- **Domestic Preference**: &amp;amp;amp;amp;lt;!--td {border: 1px solid #ccc;}br {mso-data-placement:same-cell;}--&amp;amp;amp;amp;gt;
...
- **Primary Data Center VIP**: &amp;amp;amp;amp;lt;!--td {border: 1px solid #ccc;}br {mso-data-placement:same-cell;}--&amp;amp;amp;amp;gt;
