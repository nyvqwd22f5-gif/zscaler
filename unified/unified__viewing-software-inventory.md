...
Source: https://help.zscaler.com/unified/viewing-software-inventory
PDF: https://help.zscaler.com/pdf/com/en/1495086.pdf
...
- Your Digital Experience Monitoring subscription level supports Software Inventory. To learn more, see [Ranges & Limitations](/unified/ranges-limitations#analytics).
- You've enabled the setting for inventory data collection. To learn more, see [Configuring Inventory Settings](/unified/configuring-inventory-settings).
...
- Go to **Analytics **> **Digital Experience Management** > **Inventory **> **Software Overview**. Use the filters to help you find specific software or applications, and select the associated color-coded tile.
- Go to **Analytics** > **Digital Experience Management** > **Inventory **> **Software Inventory**. Use the filters to help you find specific software or applications listed within the table.
...
- **Install Type**: The install type is identified as one of the following:
- **32-bit**: Installed for all users.
- **64-bit**: Installed for all users.
- **CurrentUser**: Either 32-bit or 64-bit installed only for the current user.
![Example of Software Inventory table](/downloads/zdx/analytics/inventory/viewing-software-inventory/zdx-sw-inventory-group-versions6.1.png)
...
[]![Software details page](/downloads/zdx/analytics/inventory/viewing-software-inventory/zdx-sw-details-table5.png)
