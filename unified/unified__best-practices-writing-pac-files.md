...
Source: https://help.zscaler.com/unified/best-practices-writing-pac-files
PDF: https://help.zscaler.com/pdf/com/en/1495446.pdf

If your organization needs to use [custom PAC files](/unified/writing-pac-file), Zscaler highly recommends that you copy and paste the default PAC file in the Admin Portal and edit the file accordingly. This article provides best practices for [writing a PAC file](/unified/writing-pac-file):
...
- Keep the file as small and efficient as possible. Configure SSL exceptions in the Admin Portal instead of adding them to the PAC file.
