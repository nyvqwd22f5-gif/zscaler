...
PDF: https://help.zscaler.com/pdf/com/en/1402646.pdf
...
- In the **Intermediate CA Certificates** page, click **Add Intermediate CA Certificate **> **Cloud HSM Protection**.
- In the** Add Cloud HSM Intermediate CA Certificate **window, under the **General** tab, complete the following sections:
