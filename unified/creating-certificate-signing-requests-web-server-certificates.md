...
PDF: https://help.zscaler.com/pdf/com/en/1484056.pdf
...
- The **Certificates** page automatically updates to display your pending CSR in the table, where you must [upload the web server certificate](/zpa/uploading-web-server-certificates#UploadPending).