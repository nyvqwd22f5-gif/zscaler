...
Source: https://help.zscaler.com/unified/about-data-discovery-report
PDF: https://help.zscaler.com/pdf/com/en/1497576.pdf

The Data Discovery Report gives high-level visibility and insight into your organization's [Data Loss Prevention (DLP)](/unified/about-data-loss-prevention) content, allowing you to monitor and analyze DLP data in a single location. The report provides not only information based on your organization's DLP policies and dictionaries, but also on machine-learning data based on Zscaler analysis of the content in your organization.
...
On the Data Discovery Report page (Analytics > Internet & SaaS > Analytics > Data Discovery Report), you can do the following:
...
[]Select **All**, **Allow**, or **Block**. To learn more, see [Understanding Policy Enforcement](/unified/understanding-policy-enforcement).
[]Select **All**, **Sanctioned**, or **Unsanctioned**. To learn more, see [About Cloud Applications](/unified/about-cloud-applications).
[]Select an option to filter by content type:
- **DLP Dictionaries: **Filter data based on the DLP dictionaries configured for your organization. To learn more, see [About DLP Dictionaries](/unified/about-dlp-dictionaries).
- **DLP Engines: **Filter data based on the DLP engines configured for your organization. To learn more, see [About DLP Engines](/unified/about-dlp-engines).
- **DLP Rules: **Filter data based on the DLP rules configured for your organization. To learn more, see [Configuring DLP Policy Rules with Content Inspection](/unified/configuring-dlp-policy-rules-content-inspection) and [Configuring DLP Policy Rules without Content Inspection](/unified/configuring-dlp-policy-rules-without-content-inspection).
- **ML Categories: **Filter data based on machine-learning analysis by the Zscaler service. The content is divided into Document Type categories. To learn more, see [Web Insights Logs: Filters](/unified/web-insights-logs-filters/#download-document-type).
[]Select **All**, **Download**, or **Upload**. To learn more, see [Web Data Types and Filters](/unified/web-data-types-and-filters).
