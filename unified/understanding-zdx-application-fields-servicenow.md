...
PDF: https://help.zscaler.com/pdf/com/en/1456846.pdf
...
- The supported format is `[subdomain].[second-level-domain].[top-level-domain]`. To learn more, see [What Is My Cloud Name for ZDX?](/zdx/what-my-cloud-name-zdx)
-
...
Mappings Module
Prior to configuring the Mappings module, you must map the ZDX Alert Types to the ServiceNow categories and subcategories. To learn more, see [ZDX Integration with ServiceNow](/zdx/zdx-integration-servicenow).
