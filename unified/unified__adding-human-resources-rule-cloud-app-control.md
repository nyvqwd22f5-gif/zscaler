...
Source: https://help.zscaler.com/unified/adding-human-resources-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494731.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Human Resources**.
The **Add Human Resources** Rule window appears.
- In the **Add Human Resources** Rule window, enter the rule attributes:
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-human-resources-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Human-Resources-Click-See-More.png)
