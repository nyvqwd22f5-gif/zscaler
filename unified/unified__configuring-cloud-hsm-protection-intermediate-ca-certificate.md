...
Source: https://help.zscaler.com/unified/configuring-cloud-hsm-protection-intermediate-ca-certificate
PDF: https://help.zscaler.com/pdf/com/en/1493796.pdf

To configure a Cloud HSM Protection certificate for your organization during SSL negotiations:
- Go to **Policies **>** Common Configuration **>** SSL/TLS Inspection **>** SSL/TLS Inspection Intermediate Certificate**.
- Click **Add Intermediate CA Certificate **and select **Cloud HSM Protection**.
- In the** Add Cloud HSM Intermediate CA Certificate **window, under the **General** tab:
...
- **Path Length Constraint: **The path length constraint for the Cloud HSM intermediate certificate is set to 0 by default.
