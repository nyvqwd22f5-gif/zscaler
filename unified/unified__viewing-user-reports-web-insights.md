...
Source: https://help.zscaler.com/unified/viewing-user-reports-web-insights
PDF: https://help.zscaler.com/pdf/com/en/1497331.pdf
...
By default, user reports also include locations. You can [exclude locations](/unified/excluding-locations-user-related-reports) in user reports by creating new or editing existing widgets.
Time-Based Reports
...
[See image.](#time-unit)
- You can drill down and get more information about the user's internet activities and view the logs as well. To learn more about drilling down, see [Analyzing Traffic Using Insights](/unified/analyzing-traffic-using-insights).
