...
Source: https://help.zscaler.com/unified/customizing-zscaler-client-connector-install-options-linux
PDF: https://help.zscaler.com/pdf/com/en/1515671.pdf
...
- Download the Zscaler run file from the Zscaler Client Connector App Store on the Admin Portal. To learn more, see [Understanding Zscaler Client Connector App Downloads](/unified/understanding-zscaler-client-connector-app-downloads).
...
- For openSUSE, use `sudo zypper install zscaler-client-3.7.1.51-1.x86_64..rpm`
