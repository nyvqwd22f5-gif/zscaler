...
Source: https://help.zscaler.com/unified/understanding-webex-call-quality-zdx
PDF: https://help.zscaler.com/pdf/com/en/1494456.pdf
...
To monitor calls or meetings with Webex Call Quality, you'll first need to configure the application and meet the feature prerequisites. To learn more, see [Configuring Webex Call Quality for Digital Experience Monitoring](/unified/configuring-webex-call-quality-digital-experience-monitoring).
To access Webex Call Quality monitoring, do one of the following from the Admin Portal:
...
- **Probe Status**: The metrics for Cloud Path probes configured for the Webex Call Quality application. Only Cloud Path probes can be configured, as Web probes are not allowed for this application. The following image shows metrics calculated for a Cloud Path host discovered by Autosense, which can dynamically detect a destination IP address and provide an automated Cloud Path probe when you onboard a Webex Call Quality tenant. To learn more, see [Configuring Webex Call Quality for Digital Experience Monitoring](/unified/configuring-webex-call-quality-digital-experience-monitoring).
...
- **Zscaler Locations**: Your locations, as defined in Internet & SaaS. To learn more, see [About Locations for Internet & SaaS](/unified/about-locations).
- **Users**: The names of your users participating in calls.
The table provides the following information for each meeting:
- **Meeting ID**: You can click any meeting ID to view details of scheduled meetings. For confidentiality, the internal meeting ID is displayed, and not the actual meeting topic name.
...
![Table headings on Webex Call Quality Meetings page](/downloads/zdx/analytics/applications/understanding-webex-call-quality-zdx/zdx-webex-meetings-tab3.png)
Meeting Details
...
- Some Internet & SaaS users might not have Digital Experience Monitoring enabled, and therefore, their user details are unavailable.
- Some user devices might not map to a corresponding registered Digital Experience Monitoring device.
- Some Digital Experience Monitoring users are not being monitored for Call Quality.
- Insufficient information is available to map a user to a Digital Experience Monitoring device.
...
[]![Webex Call Quality application card](/downloads/zdx/analytics/applications/understanding-webex-call-quality-zdx/zdx-webex-app-card2.png)
[]![Viewing the Webex Call Quality page](/downloads/zdx/analytics/applications/understanding-webex-call-quality-zdx/zdx-autosense-webex-probe-status2.png)
[]![Example of Meeting Details page for Webex Call Quality](/downloads/zdx/analytics/applications/understanding-webex-call-quality-zdx/zdx-webex-meeting-details.png)
[]![Meeting Monitoring Metrics graph](/downloads/zdx/analytics/applications/understanding-webex-call-quality-zdx/zdx-webex-mmm2.png)