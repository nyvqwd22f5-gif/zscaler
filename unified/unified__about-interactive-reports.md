...
Source: https://help.zscaler.com/unified/about-interactive-reports
PDF: https://help.zscaler.com/pdf/com/en/1488296.pdf
...
An administrator's [role](/unified/adding-admin-roles) and [scope](/unified/about-admin-scope) define which reports the administrator can view.
About the Interactive Reports Page
On the Interactive Reports page (Analytics > Internet & SaaS > Analytics > Interactive Reports), you can do the following:
- Search for a specific report or for any [scheduled reports](/unified/scheduling-reports).
-
Create a custom report from scratch, copy from an existing report, or import a report. To learn more, see [Creating or Copying a Report](/unified/creating-or-copying-report) and [Exporting and Importing Reports](/unified/exporting-and-importing-reports).
...
You can also export a custom report. To learn more, see [Exporting and Importing Reports](/unified/exporting-and-importing-reports).
...
Scheduled Reports
In the Scheduled Reports tab, you can schedule a standard or custom report for regular distribution to specified recipients. To learn more, see [Scheduling Reports](/unified/scheduling-reports).
Viewing a Report
...
- View the widgets that the report contains. To learn more, see [About Widgets](/unified/about-widgets).
- Hover over a chart’s data, and click on it to obtain more information.
- Click the **View Logs** option to view the chart’s logs in the [Insights Logs](/unified/about-insights-logs) page. If you want to go back to the report, click **Back to Original**. This option is not available for charts that display secure browsing class, data or status, because they only use samples as their data units.
- Click the **Analyze Chart** option to view the chart in an [Insights](/unified/about-insights) page. If you want to go back to the report, click **Back to Original**. To learn more, see [Analyzing Traffic Using Insights](/unified/analyzing-traffic-using-insights).
...
- Edit or delete a note. To learn more, see [Adding Notes to Dashboards and Interactive Reports](/unified/adding-notes-dashboards-and-interactive-reports).
...
- Add a note to the report. To learn more, see [Adding Notes to Dashboards and Interactive Reports](/unified/adding-notes-dashboards-and-interactive-reports).
...
- Schedule a standard or custom report for regular distribution to specified recipients. To learn more, see [Scheduling Reports](/unified/scheduling-reports).
- Print a report. To learn more, see [Printing Reports](/unified/printing-reports).
