...
Source: https://help.zscaler.com/unified/adding-legal-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494746.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Legal**.
The **Add Legal Rule** window appears.
- In the **Add Legal Rule** window, enter the rule attributes:
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-legal-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Legal-Click-See-More.png)
