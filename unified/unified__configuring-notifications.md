...
Source: https://help.zscaler.com/unified/configuring-notifications
PDF: https://help.zscaler.us/pdf/com/en/1491556.pdf

Within the Admin Portal, you can create notifications.
Adding a Notification
To add a new notification:
- Go to **Administration **> **Alerts** > **Notifications**.
-
Click **Add**.
...
[]
[](/unified/about-backup-and-restore-private-applications)[](/unified/restoring-policies-and-configurations-backup-private-applications)[](/unified/about-backup-and-restore-private-applications)[](/unified/monitoring-app-connector-performance)[](/unified/monitoring-app-connector-performance)[](/unified/about-enrollment-ca-certificates)[](/unified/monitoring-app-connector-performance#filedscrpt)[](/unified/about-backup-and-restore-private-applications)[](/unified/restoring-policies-and-configurations-backup-private-applications)[](/unified/about-backup-and-restore-private-applications)[](/unified/restoring-policies-and-configurations-backup-private-applications)[](/unified/monitoring-app-connector-performance)
...
| Control Connection Disconnected | Connectivity and Upgrade | App Connectors, Private Cloud Controllers, Private Service Edges | An event indicating when the control connection for an App Connector, Private Cloud Controller, or Private Service Edge for Private Applications disconnects. |
...
| Invalid System Listen IP Configuration | System Resource | Private Cloud Controllers, Private Service Edges | An event indicating when the listen IP address configuration for a Private Service Edge for Private Applications or Private Cloud Controller is invalid. |
...
- **Private Cloud Controller**: To learn more, see [About Private Cloud Controllers](/unified/about-private-cloud-controllers).
- **Private Service Edges**: To learn more, see [About Private Service Edges for Private Applications](/unified/about-private-service-edges-private-applications).
- **Cloud Connectors**: To learn more, see [About Cloud Connectors](/unified/about-cloud-connectors).
- **Zscaler Client Connector**
If you are within a [Microtenant](/unified/about-microtenants), you can only create notifications for App Connectors and Private Service Edges for Private Applications, or Private Cloud Controllers.
...
A drop-down menu is not available for the **Backup and Restore** and **Zscaler Client Connector** component.
...
[]
`Subject: [!] Private Applications: Automatic Usage Metrics for Connector Lab App Connector with HIGH priority`
`Body: You are receiving this message because you requested notifications for:`
- `Tenant Name: SafemarchTenant ID: 198745983939657747Private Applications`
- `Cloud Name: ProductionPrivate Applications`
- `Component: App ConnectorName: Lab App Connector`
- `Priority: HIGH`
- `Event/Notification alert: Event triggered as a result of Memory exceeded`
- `Review the relevant dashboards, analytics, and configuration settings in the Admin Portal.`
`Thank you,`
`Zscaler`
