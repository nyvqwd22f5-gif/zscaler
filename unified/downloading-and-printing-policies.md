...
PDF: https://help.zscaler.com/pdf/com/en/1398761.pdf
...
To download or print all policies, go to **Administration** > **Print All Policies**.
...
-
To print policies, click **Print**. In the window that appears, you can change your preferred settings and then proceed to print the policies.
[See image.](#download-print-policies)
[See sample files.](#policy-files)
[]![Option to print or download ZIA policies in PDF or ZIP (JSON) formats](/downloads/zia/policies/printing-policies/ZIA-policy-download-print.png)
[]![Downloaded policy files in ZIP and PDF formats](/downloads/zia/policies/printing-policies/ZIA-policy-files.png)