# About Security & UEBA Alerts for Internet & SaaS
Source: https://help.zscaler.com/unified/about-security-ueba-alerts-internet-saas
PDF: https://help.zscaler.com/pdf/com/en/1529991.pdf
...
- [Security Alerts](#security-alert-intro)
- [UEBA Alerts](#ueba-alert-intro)
...
On the Alerts page (Administration > Alerts > Security & UEBA Alerts), you can do the following:
- [View the details of all ongoing alerts](/zia/about-ongoing-alerts).
- [View the list of alert history](/unified/about-alert-history).
- View the [overview section](/unified/about-ongoing-alerts#securityalert-ongoingalert-overview) that provides a graphical representation of the impacted systems and threat event types along with the total number of impacted locations, systems, departments, and ongoing alerts.
- View the [alert summary](/unified/about-ongoing-alerts#securityalerts-alertsummary) table.
...
- Go to the [Alert Rules page](/unified/about-alert-rules).
- Go to the [Webhooks page](/unified/about-webhooks).
![The Alerts page displays the ongoing alerts and alert history details.](/downloads/zia/security-alerts/about-security-alerts/About-Alerts.png)
...
The Internet & SaaS UEBA alerts provide extensive functionality to detect and respond to flagged activities. This alert type is available for Inline and API channels for better monitoring.