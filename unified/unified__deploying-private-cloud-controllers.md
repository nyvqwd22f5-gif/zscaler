...
Source: https://help.zscaler.com/unified/deploying-private-cloud-controllers
PDF: https://help.zscaler.com/pdf/com/en/1528751.pdf

After you [add a Private Cloud Controller](/unified/configuring-private-cloud-controllers), you must deploy it. Deployment consists of installing and enrolling the Private Cloud Controller, which allows it to obtain a TLS client certificate that it must use to authenticate itself to the cloud. After deployment, the Private Cloud Controller is ready to act as a per-tenant controller for users, Private Service Edges for Private Applications, and App Connectors to leverage when the cloud is not available or reachable.
...
- It uses the provisioning key to authenticate the CSR to the cloud. This is the [provisioning key](/unified/about-private-cloud-controller-provisioning-keys) that is generated in the Admin Portal and provided to the Private Cloud Controller during installation.
