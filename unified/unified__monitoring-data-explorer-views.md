...
Source: https://help.zscaler.com/unified/monitoring-data-explorer-views
PDF: https://help.zscaler.com/pdf/com/en/1493901.pdf
...
Make sure you meet the feature prerequisites to monitor Data Explorer views. To learn more, see [Configuring Data Explorer Views](/unified/configuring-data-explorer-views).
...
![Table of Data Explorer views](/downloads/zdx/analytics/monitoring-data-explorer-views/zdx-de-table-headers2.png)
In addition to Search, the following actions are available within the Data Explorer table:
- [Create a Data Explorer view](/unified/configuring-data-explorer-views).
- Click a name to display its Data Explorer view. For details about the interaction and format of Data Explorer charts, see [Viewing System-Generated Reports](/unified/viewing-system-generated-reports).
- [Edit or delete a Data Explorer view](/unified/configuring-data-explorer-views).
[See image.](#de-table-actions)
[]![Data Explorer table actions](/downloads/zdx/analytics/monitoring-data-explorer-views/zdx-de-table-actions2.png)
