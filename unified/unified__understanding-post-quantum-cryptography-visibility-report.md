...
Source: https://help.zscaler.com/unified/understanding-post-quantum-cryptography-visibility-report
PDF: https://help.zscaler.com/pdf/com/en/1533572.pdf
...
As organizations prepare for the transition to PQC, it is critical to have logging and visibility into PQC-related security events. PQC logging Internet & SaaS ensures security teams can monitor and analyze PQC-related traffic and threats. The following are the key features of PQC logging:
...
To learn more, see [Web Insights Logs: Filters](/unified/web-insights-logs-filters), [Web Insights Logs: Columns](/unified/web-insights-logs-columns), and [Web Data Types and Filters](/unified/web-data-types-and-filters).
Key Benefits
The Post-Quantum Cryptography Visibility Report provides the following benefits and enables customers to:
- Capture logs and generate reports for all sessions that are negotiated using PQC, Classical, and Hybrid algorithms, and facilitates real-time and historical search capabilities through the Admin Portal.
...
To learn more about how to view and analyze the Post-Quantum Visibility Report, see [Viewing the Post-Quantum Cryptography Visibility Report](/unified/viewing-post-quantum-cryptography-visibility-report).