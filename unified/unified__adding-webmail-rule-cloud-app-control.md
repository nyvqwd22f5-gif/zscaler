...
Source: https://help.zscaler.com/unified/adding-webmail-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494776.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Webmail**.
The **Add Webmail Rule** window appears.
- In the **Add Webmail Rule** window, enter the rule attributes:
...
You can choose either **Allow** or **Block** action for **Sending Mail **and **Sending Attachment**.
- [Allow](#allow)
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-webmail-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Webmail-See-More.png)
...
-
**Tenant Profiles**: Appears only when **Gmail** is selected as the cloud application. You can select the tenant profiles for which you want to apply the rule. To learn more, see [About Tenant Profiles](/unified/about-tenant-profiles).
