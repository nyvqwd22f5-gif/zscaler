...
Source: https://help.zscaler.com/unified/configuring-internet-saas-virtual-service-edge-microsoft-azure
PDF: https://help.zscaler.com/pdf/com/en/1495656.pdf
...
If you face any issues with Virtual Service Edge, see [Troubleshooting Internet & SaaS Virtual Service Edge](/unified/troubleshooting-virtual-service-edges).
[]To associate Virtual Service Edge with Azure LB:
- [1. Create an Azure LB in the resource group](#azure-lb-resource-group)
- [2. Create a backend pool and link Virtual Service Edge VMs](#backend-pool)
- [3. Create health probes for the ports](#health-probes)
- [4. Create load balancing rules](#load-balancing-rules)
...
You can find the <Zscaler Cloud Name> in the URL you use to log in to the Admin Portal. For example, if you log in to admin.zscaler.net, then go to https://config.zscaler.com/zscaler.net/zia-v-sedge. ​​​​​​
...
If this option is enabled, you cannot establish a support tunnel from the Admin Portal. Also, the **Establish Support Tunnel** option is grayed out.
-
...
[]![Screenshot of Azure Create Virtual Machine Page](/downloads/zia/traffic-forwarding/service-edges/virtual-zen/configuring-vzen-microsoft-azure/Azure-VM-Create-VM.png)
[]![Screenshot of Azure Edit IP Configuration Page](/downloads/zia/traffic-forwarding/service-edges/virtual-zen/configuring-vzen-microsoft-azure/Azure-Resource-Group-Edit-IP-Config.png)
[]![Screenshot of Azure VM Network Settings Page](/downloads/zia/traffic-forwarding/service-edges/virtual-zen/configuring-vzen-microsoft-azure/Azure-VM-Network-Settings-Attach-Network-Interface.png)
...
- Complete the configuration for the new rule as detailed in [Configuring Firewall Filtering Policy](/unified/configuring-firewall-filtering-policy).
...
[]![Screenshot of the Resource Group page in the Azure Portal](/downloads/zia/traffic-forwarding/service-edges/virtual-zen/configuring-vzen-microsoft-azure/ZIA-AP-Resource-Group-Final.PNG)
[]![Screenshot of the Zscaler Network Security Group settings in Azure](/downloads/zia/traffic-forwarding/service-edges/virtual-zen/configuring-vzen-microsoft-azure/zia-azure-vzen-inbound-outbound.PNG)