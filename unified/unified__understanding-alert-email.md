...
Source: https://help.zscaler.com/unified/understanding-alert-email
PDF: https://help.zscaler.com/pdf/com/en/1491741.pdf

Alert notifications are sent via email if this option is chosen when configuring the alert rule. To learn more, see [Configuring a Rule](/unified/configuring-alert-rule).
...
- **Alert Rule**: The name of the alert rule. Click the name of the alert rule to view further details in the Admin Portal.
...
[See image.](#Alertinformation_inEmail)
Click **View Alert** to view further details in the Admin Portal.
...
For example, if the incident type is Application, then the epicenter shows the area of impacted users. To learn more, see [Monitoring the Incidents Dashboard](/unified/monitoring-incidents-dashboard).
