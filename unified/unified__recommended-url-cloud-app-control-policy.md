...
Source: https://help.zscaler.com/unified/recommended-url-cloud-app-control-policy
PDF: https://help.zscaler.com/pdf/com/en/1493966.pdf

This article contains the recommended policy for URL Filtering and Cloud App Control.
URL Filtering
Zscaler recommends that you [configure](/unified/configuring-url-filtering-policy) the following for the [URL Filtering](/unified/about-url-filtering) policy:
...
- **URL Categories**: Select all categories in the **Legal Liability** class. To see which URL categories are in the Legal Liability class, see [About URL Categories](/unified/about-url-categories).
...
Zscaler recommends that you configure the following in the [Advanced Policy Settings](/unified/configuring-advanced-policy-settings).
- **Enable Suspicious New Domains Lookup**:** **Select** Enable**.** **This enables you to use the Newly Registered and Observed Domains [URL category](/unified/about-url-categories) in your URL Filtering policy.
-
...
**SafeSearch Applications**: Select **Any** to return safe content from searches on AOL, Bing Search, Dailymotion, DuckDuckGo, Flickr, Google, Yahoo, and YouTube. [SSL Inspection](/unified/about-ssl-inspection) must be enabled for this option.
...
When using Amazon Q, be aware that Zscaler and AWS are technology partners.
Zscaler recommends that you configure the following in the [Advanced Policy Settings](/unified/configuring-advanced-policy-settings).
