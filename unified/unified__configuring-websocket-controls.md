...
Source: https://help.zscaler.com/unified/configuring-websocket-controls
PDF: https://help.zscaler.com/pdf/com/en/1492966.pdf

Within the Admin Portal, you can add WebSocket Controls to use as part of your [AppProtection profiles](/unified/about-appprotection-profiles). To learn more, see [About WebSocket Controls](/unified/about-websocket-controls).
To add a new WebSocket control:
- Go to **Policies **>** Cybersecurity **>** Inline Security **>** Protection Controls** > **WebSocket Controls**.
...
- Click **Next**.
[]On the **Control Definition** tab, you see the control parameters selected on the **Control Details** tab. There are different required settings to enter depending on what you selected. This lets you define how user traffic is inspected.
To set the control:
...
In addition to severity levels, WebSocket custom controls have a paranoia level of 1 as they are used in an[ AppProtection profile](/unified/configuring-appprotection-profiles#paranoia-execution).
[See image.](#Step3)
- Click **Next**.
