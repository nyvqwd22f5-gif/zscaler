...
Source: https://help.zscaler.com/unified/configuring-dlp-policy-rules-without-content-inspection
PDF: https://help.zscaler.com/pdf/com/en/1493051.pdf
...
- [1. Configure DLP notification templates](/unified/configuring-dlp-notification-templates) if you want to email notifications to your organization's auditor when your users' transactions violate DLP policy rules.
- [2. (Optional) Configure ICAP receivers](/unified/adding-icap-receiver) if you want to forward information about transactions that violate DLP policy to your third-party solution. Skip this step if you don't have a third-party DLP solution or if you don't want to forward content.
...
- **Rule Order**: Policy rules are evaluated in ascending numerical order (Rule 1 before Rule 2, and so on), and the rule order reflects this rule's place in the order. You can change the value, but if you've enabled [admin ranking](/unified/about-admin-rank), your assigned admin rank determines the rule order values you can select.
...
- **Source IP Groups**: Select **Any** to apply the rule to all [source IP groups](/unified/about-source-ip-groups-internet-saas), or select any number of source IP groups. You can also search for source IP groups or click the **Add** icon to add a new [source IP group](/unified/about-source-ip-groups-internet-saas).
...
-
**File Type**:** **This is only applicable if you choose **Select File Types**.** **Select the file types you want the rule to apply to. You can select any number of file types and also search for file types. You can also select custom file types you have previously configured.
...
- **Groups**:** **You can specify how the DLP rule applies to your [groups](/unified/about-internet-saas-groups).
...
- **Departments**:** **You can specify how the DLP rule applies to your [departments](/unified/about-departments-internet-saas).
...
-
**Locations**: Select **Any** to apply the rule to all [locations](/unified/about-locations-internet-saas), or select up to 32 locations. You can also search for a location or click the **Add **icon to add a new location.
...
To learn how to use the Zscaler DLP engines to detect data and also forward information about the data to your third-party DLP solution, see [Configuring DLP Policy Rules with Content Inspection](/unified/configuring-dlp-policy-rules-content-inspection).
