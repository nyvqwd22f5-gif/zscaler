...
Source: https://help.zscaler.com/unified/monitoring-applications-overview
PDF: https://help.zscaler.com/pdf/com/en/1494436.pdf

The Applications Overview page (Analytics > Digital Experience Management > Applications) provides information about the applications users are accessing and the impact of those applications on your organization's digital experience.
...
- **Share a Digital Experience Monitoring Snapshot**: Click **Share Snapshot **to capture a snapshot of the current state of the Applications Overview page. Share it with other Digital Experience Monitoring users or admins for view-only access. To learn more, see [Sharing Digital Experience Monitoring Snapshots](/unified/sharing-digital-experience-monitoring-snapshots).
...
[]The **Applications** column provides a list of applications. These names are defined when you configure the application. To learn more, see [About Applications](/unified/about-applications-0).
...
Click a name to see more information about each application. To learn more, see [Evaluating Individual Application Details](/unified/monitoring-applications-overview#indivapp).
...
Along with the score is a small graph showing the rise and fall of the score for the selected time period. To see more information for a particular application, click the application name. To learn more, see [Evaluating Individual Application Details](/unified/monitoring-applications-overview).
...
[]The **Most Impacted Location** column lists the location most impacted by the application. Locations are ones your organization defined in Internet & SaaS. To learn more, see [About Locations](/unified/about-locations).
[]The **Most Impacted Region** column lists the region most impacted by the application. These areas are where users access the application.
...
Digital Experience Monitoring currently supports Windows, macOS, Android, and ChromeOS devices only (e.g., desktop, laptop).
[]The **Most Impacted Department** column lists the department most impacted by the application. Departments are ones your organization defined in Internet & SaaS. To learn more, see [About Departments](/unified/about-departments).
[]The **ZDX Score Over Time** graph shows how the ZDX Score trends over the selected time period for the chosen application. To learn more, see [About the ZDX Score](/unified/about-zdx-score).
...
This allows you to compare how different departments are scoring in relation to each other with use of the application.
