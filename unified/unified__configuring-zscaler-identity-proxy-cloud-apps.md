...
Source: https://help.zscaler.com/unified/configuring-zscaler-identity-proxy-cloud-apps
PDF: https://help.zscaler.com/pdf/com/en/1491676.pdf
...
To configure Identity Proxy settings for cloud applications in the Admin Portal, see [Configure Identity Proxy Settings for each Cloud App](#configure-identity-proxy-settings).
...
![Zia-Isolated-identity-proxy](/downloads/unified/administration/internet-saas/identity/identity-proxy-settings/configuring-zscaler-identity-proxy-cloud-apps/Unified-Isolated-Identity-Proxy.png)
​​Prerequisite
Ensure [SSL Inspection](/unified/deploying-ssl-inspection) is enabled for the organization location before configuring the Zscaler service as an IdP for the following cloud apps:
- Box
- GitHub
- Google Apps
- Microsoft Office 365
...
- [1. Configure Identity Proxy Settings for the Cloud App in the Admin Portal](#configure-identity-proxy-settings)
- [2. Download the Zscaler Certificate and Obtain Information from the Admin Portal](#Download)
...
- Go to** Administration **> **Identity** > **Internet & SaaS** >** Identity Proxy Settings**.
...
- On the Authentication Configuration page, select the **Authentication Service** that you configured in Admin Portal. In this example, it's ZscalerExample.
- Click **Save**.
[See image.](#sf-auth)
...
- In the **Single Sign-On Settings** list, click the Zscaler SAML SSO setting that you configured in Admin Portal. In this example, it's ZscalerExample.
- Copy the **Login URL** and specify it as the **ACS URL** while when you configure configuring the Salesforce cloud app instance in the Admin Portal.
[See image.](#sf-url)
...
- **SAML 2.0 Endpoint URL**: Paste the Zscaler Identity Proxy URL that you copied from the Admin Portal.
- **Identity Provider Issuer URL**: Paste the Zscaler Issuer Entity ID that you copied from the Admin Portal.
- **Service Provider Issuer URL**: Enter `https://slack.com`.
- **Public (X.509) Certificate**: Open the zscaler_certificate.cer file that you downloaded from the Admin Portal with a text editor and copy and paste the entire contents.
...
- [b. Configure AD FS claim rule for Office 365](#configure-adfs)
...
- **Isolation Profile**: &amp;amp;amp;amp;amp;amp;amp;amp;amp;amp;lt;!--td {border: 1px solid #ccc;}br {mso-data-placement:same-cell;}--&amp;amp;amp;amp;amp;amp;amp;amp;amp;amp;gt;
Select the isolation profile from the list if you choose the **Browser Isolation** action. This list includes the isolation profiles that you created for your organization.
