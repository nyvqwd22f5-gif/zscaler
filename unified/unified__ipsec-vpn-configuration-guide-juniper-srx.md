...
Source: https://help.zscaler.com/unified/ipsec-vpn-configuration-guide-juniper-srx
PDF: https://help.zscaler.com/pdf/com/en/1495391.pdf
...
Prerequisites
Ensure you have the [Virtual IP (VIP) addresses of the Internet & SaaS Public Service Edges](/unified/locating-virtual-ip-addresses-internet-saas-public-service-edges).
...
This article covers only the configuration details of IPSec VPN tunnels between the Juniper SRX 300 firewall and the Internet & SaaS Public Service Edges. For any other specific information about Juniper SRX 300, refer to the [Juniper SRX documentation](https://www.juniper.net/documentation/product/us/en/srx300/).
...
- <Primary VIP Address> and <Backup VIP Address>: The VIP addresses of the Internet & SaaS Public Service Edges.
- <FQDN>: The FQDN of the VPN credentials you created in the Admin Portal.
- <Pre-Shared Key>: The pre-shared key (PSK) of the VPN credentials you created in the Admin Portal.
...
<67108867 ESP:aes-cbc-256/sha1 8d0f431d 13988/ unlim - root 500 10.66.45.209
>67108867 ESP:aes-cbc-256/sha1 2311ec4f 13988/ unlim - root 500 10.66.45.209
<131074 ESP:aes-cbc-256/sha1 fab7ab1f 86286/ unlim - root 500 10.66.91.26
>131074 ESP:aes-cbc-256/sha1 1012ab99 86286/ unlim - root 500 10.66.91.26
...
ID              Algorithm       SPI    Life:sec/kb Mon lsys Port         Gateway
<67108867 ESP:aes-cbc-256/sha1 8d0f431d 13988/ unlim - root 500 <Primary Tunnel VIP Address>
>67108867 ESP:aes-cbc-256/sha1 2311ec4f 13988/ unlim - root 500 <Primary Tunnel VIP Address>
...
[]Configure the IKE policy to associate with the IKE proposal. The IKE policy defines the PSK of the peer and the IKE proposal used during the IKE negotiation. You need the <IKE Proposal Name> created in [5. Configure the IKE Proposal](/unified/ipsec-vpn-configuration-guide-juniper-srx#ikev2-ike-proposal).
Enter the following commands:
...
[]Configure two IKE gateways. You need the <IKE Policy Name> created in [6. Configure the IKE Policy](/unified/ipsec-vpn-configuration-guide-juniper-srx#ikev2-ike-policy).
Enter the following commands:
...
[]Configure two IPSec VPNs that are associated with your tunnel interfaces and IKE gateways. You need the <Primary IKE Gateway Name>, <Backup IKE Gateway Name>, and <IPSec Policy Name> configured in [7. Configure the IKE Gateways](/unified/ipsec-vpn-configuration-guide-juniper-srx#ikev2-ike-gateways) and [10. Configure the IPSec Policy](/unified/ipsec-vpn-configuration-guide-juniper-srx#ikev2-ipsec-policy).
