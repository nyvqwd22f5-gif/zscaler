# Editing a Subcloud
Source: https://help.zscaler.com/unified/editing-subcloud
PDF: https://help.zscaler.com/pdf/com/en/1495241.pdf
...
You can edit a subcloud from the [Subclouds](/unified/about-subclouds) page in the Admin Portal to temporarily disable the DCs under scheduled maintenance or DCs with capacity issues, trust incidents, site or region service issues, excessive latency, congestion, peering issues, etc.
To edit a subcloud:
- Go to **Infrastructure **>** Internet & SaaS **>** Traffic Forwarding **>** Subclouds**.
