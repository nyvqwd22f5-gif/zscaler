...
Source: https://help.zscaler.com/unified/understanding-zoom-call-quality-digital-experience-monitoring
PDF: https://help.zscaler.com/pdf/com/en/1494481.pdf
...
To monitor calls or meetings with Zoom Call Quality, you'll first need to configure the application and onboard a Zoom API tenant or Zoom QSS tenant, as well as meet the feature prerequisites. To learn more, see [Configuring Zoom Call Quality for Digital Experience Monitoring](/unified/configuring-zoom-call-quality-zdx).
To access Zoom Call Quality monitoring, do one of the following from the Admin Portal:
- Go to **Applications **and click **Zoom Call Quality** in the Applications Overview page.
- Click the **Zoom Call Quality** application card.
[See image.](#cqm-card)
...
![Table data shown on Zoom Call Quality Meetings page](/downloads/zdx/analytics/applications/understanding-zoom-call-quality-zdx/zdx-zoom-cqm-meeetings-table5.png)
...
[]![Example of Meeting Details page for Zoom Call Quality](/downloads/zdx/analytics/applications/understanding-zoom-call-quality-zdx/zdx-zoom-cqm-meeting-details-and-sessions3_0.png)
