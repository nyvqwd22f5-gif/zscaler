...
PDF: https://help.zscaler.com/pdf/com/en/1401711.pdf
...
- **Status**: Select **Enable** to allow the service to send communications to the Zscaler Incident Receiver. If you **Disable** a receiver, the ZIA Public Service Edge  cannot send information to the receiver.
...
- A <port number> must be included. The default port number is 1344. If you change the port number, you must also update the port number configuration in the Zscaler Incident Receiver to match. To learn more, see [Configuring the Zscaler Incident Receiver](/zia/configuring-zscaler-incident-receiver).
...
Once you save the Zscaler Incident Receiver, download the **Certificate** for the incident receiver from the [Zscaler Incident Receiver page](/zia/about-zscaler-incident-receiver) or from the [Edit Incident Receiver window](/zia/modifying-zscaler-incident-receiver).
You can associate the Zscaler Incident Receiver with a DLP policy rule ([with content inspection](/zia/configuring-dlp-policy-rules-content-inspection), [without content inspection](/zia/configuring-dlp-policy-rules-without-content-inspection), or [SaaS Security API](/zia/configuring-saas-security-api-dlp-policy)) as a DLP incident receiver.