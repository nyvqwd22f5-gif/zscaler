# Using Adaptive Mode
Source: https://help.zscaler.com/unified/using-adaptive-mode
PDF: https://help.zscaler.com/pdf/com/en/1492856.pdf
...
Minimum versions of Zscaler Client Connector and ZDX Module are required.
Adaptive Mode Process
You can select Adaptive mode when configuring a cloud path probe for either a predefined or custom application. To learn more, see [Configuring a Probe](/unified/configuring-probe) and [Best Practices in Operationalizing Digital Experience Monitoring](https://www.zscaler.com/resources/white-papers/best-practices-operationalizing-zdx.pdf).
...
The protocol used is visible in the Cloud Path section on the user details page. To learn more, see [Evaluating the Cloud Path](/unified/evaluating-cloud-path).
