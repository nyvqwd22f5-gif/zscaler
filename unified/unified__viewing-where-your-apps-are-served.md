...
Source: https://help.zscaler.com/unified/viewing-where-your-apps-are-served
PDF: https://help.zscaler.com/pdf/com/en/1531255.pdf
...
The report is generated on the same schedule as the [quarterly business reports](/unified/viewing-quarterly-business-review-reports).
Bar View
...
-
Hover over a bar to view the number of FQDNs, App Segments, Users, Transactions, Total Bytes, and Location details.
[See image.](#img_bar_hover)
If hosting provider details are not determined, **Unknown **appears next to the name of the private applications in Bar view. For accurate location tracking regarding data center environments, edit the App Connector group, set **Hosting Detection** to **Manual**, and then select or enter host data center information. To learn more, see [Configuring App Connectors](/unified/configuring-app-connectors) and [Editing App Connector Groups](/unified/editing-app-connector-groups).
Map View
...
- Switch between the Map and Bar view.
-
Zoom in, zoom out, center your position, or reset your view to review areas of interest. You can zoom in and out with your mouse's scroll wheel. Hold down the mouse's left button to pan around the map.
[See image.](#img_map_zoom)
-
Hover over a marked location to view the number of FQDNs, App Segments, Users, Transactions, Total Bytes, and Location details.
...
[]
![Hover over a location to view more details](/downloads/zpa/dashboard-diagnostics/applications-and-users-monitoring/viewing-where-your-apps-are-served/ZPA-where-map-hover-1.png)
[]
...
[]
![Hover over a bar to view details of the private application](/downloads/zpa/dashboard-diagnostics/applications-and-users-monitoring/viewing-where-your-apps-are-served/ZPA-where-bar-hover-2.png)