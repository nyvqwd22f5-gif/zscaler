...
Source: https://help.zscaler.com/unified/firewall-insights-logs-filters
PDF: https://help.zscaler.com/pdf/com/en/1497361.pdf

Filters define the traffic information that you view in your Firewall Insight Logs. To learn more about logs, see [About Insights Logs](/unified/about-insights-logs).
...
- **Application Segment**: Use this filter to view transactions associated with a specific [application segment](/unified/about-applications).
...
- **Department**: Use this filter to limit the data to the traffic of a specific [department](/unified/about-departments). Use the Search function to find a specific department.
- **Dest Country**: Use this filter to limit the data to traffic associated with specific destination countries.
- **Device Hostname**: The hostname information from support devices. This filter is not available for admins with [device information obfuscation](/unified/obfuscating-device-information-admins) enabled.
...
- **Device Name**: Use this filter to view transactions associated with a specific device name. Enter all or part of the device name in the text field and an operator such as: **Contains**, **Starts With**, **Ends With**, **Exact Match**, **Does Not Contain**, **Does Not End With**, **Not Null**, or **Is Null**. This filter is not available for admins with [device information obfuscation](/unified/obfuscating-device-information-admins) enabled.
...
- **DNAT Rule Name**: Use this filter to limit the data to traffic associated with a specific [NAT Control](/unified/about-nat-control) rule. Choose the rules from the list.
...
- ZIA
- ZPA
- **Forwarding Method**: Use this filter to limit the data to traffic associated with the type of forwarding method used.
...
- **Network Application**: Use this filter to limit the data to specific [network applications](/unified/about-network-applications). Choose the applications from the list.
...
- **Network Service**: Use this filter to limit the data to specific [network services](/unified/about-network-services). Choose the network services from the list.
...
- **Server IP Category**: Use this filter to limit the data to traffic associated with a specific [URL category](/unified/about-url-categories).
...
- **User**: Use this filter to limit the data to the traffic of specific [users](/unified/about-users). Choose the user names from the list.
