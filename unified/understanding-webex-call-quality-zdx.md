...
PDF: https://help.zscaler.com/pdf/com/en/1446941.pdf
...
To monitor calls or meetings with Webex Call Quality, you'll first need to configure the application and meet the feature prerequisites. To learn more, see [Configuring Webex Call Quality for ZDX](/zdx/configuring-webex-call-quality-zdx).
...
Meetings are not reported if none of the participants are monitored ZDX users for Call Quality. At least one meeting participant must be a monitored ZDX user. To learn more about configuring ZDX users for meetings, see [Configuring Webex Call Quality for ZDX](/zdx/configuring-webex-call-quality-zdx).
