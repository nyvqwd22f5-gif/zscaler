...
PDF: https://help.zscaler.com/pdf/com/en/1507096.pdf

Private Clouds are a logical grouping of Private Cloud Controller groups, App Connector groups, ZPA Private Service Edge groups, and log receivers. [Configuring a Private Cloud](/zpa/configuring-private-clouds) is required for uninterrupted access to applications without any manual intervention via [Business Continuity](/zpa/understanding-business-continuity).
Private Clouds provide the following benefits and enable you to:
- Logically group your Private Cloud Controller groups, App Connector groups, ZPA Private Service Edge groups, and log receivers to support ZPA Business Continuity.
- Configure certificate renewal threshold for enrollment certificates of associated App Connectors, ZPA Private Service Edges, and Private Cloud Controllers before expiration.
ZPA Private Clouds and App Connectors establish the control channel to Private Cloud Controllers within the same Private Cloud.
About the Private Clouds Page
On the Private Clouds page (Configuration & Control > Business Continuity > Business Continuity Management > Private Clouds), you can do the following:
...
-
[Add a Private Cloud.](/zpa/configuring-private-clouds)
Private Clouds that are managed by Zscaler are read only and cannot be configured. To learn more, see [Understanding Zscaler-Managed Business Continuity Cloud](/zia/understanding-zscaler-managed-business-continuity-cloud).
...
- **Private Service Edge Groups**: The ZPA Private Service Edge groups associated with the Private Cloud.
- **Log Receivers**: The log receivers associated with the Private Cloud.
- **Status**: Indicates whether the Private Cloud is enabled or disabled.
-
**Certificate Renewal Threshold**: Specifies the number of days before the certificate expires to automatically renew the enrollment certificate for Private Cloud Controllers, App Connectors, and ZPA Private Service Edges.
...
- [Edit the configuration of a Private Cloud.](/zpa/editing-private-clouds)
-
Delete the Private Cloud.
Private Clouds that are managed by Zscaler are read only and cannot be edited or deleted. To learn more, see [Understanding Zscaler-Managed Business Continuity Cloud](/zia/understanding-zscaler-managed-business-continuity-cloud).
...
![Viewing and Managing Private Clouds](/downloads/zpa/business-continuity-management/private-clouds/about-private-clouds/zpa-private-clouds-annotated_2.png)