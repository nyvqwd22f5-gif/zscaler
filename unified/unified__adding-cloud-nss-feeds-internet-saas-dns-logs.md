# Adding Cloud NSS Feeds for Internet & SaaS DNS Logs
Source: https://help.zscaler.com/unified/adding-cloud-nss-feeds-internet-saas-dns-logs
PDF: https://help.zscaler.com/pdf/com/en/1496856.pdf
...
- **Rule Name**: Use this filter to limit the logs based on specific rules in the [DNS Control policy](/unified/configuring-dns-control-policy). Choose the rules from the list.
