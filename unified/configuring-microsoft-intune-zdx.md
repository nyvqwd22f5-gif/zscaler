...
PDF: https://help.zscaler.com/pdf/com/en/1409701.pdf

The integration of Microsoft Intune with Zscaler Digital Experience (ZDX) provides access to Endpoint Analytics for user and device insights. To learn more, see [Understanding Microsoft Endpoint Analytics for ZDX](/zdx/understanding-microsoft-endpoint-analytics-zdx).
Adding the Intune Integration
In the ZDX Admin Portal:
- Go to **Administration **> **Integrations **>** Data Collection**.
