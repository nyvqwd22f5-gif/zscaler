# Tunnel Insights Logs: Columns for Cloud & Branch Connector
Source: https://help.zscaler.com/unified/tunnel-insights-logs-columns-cloud-branch-connector
PDF: https://help.zscaler.com/pdf/com/en/1516896.pdf

You can customize your tunnel logs using the columns. To learn more about logs, see [About Insights Logs](/unified/about-insights-logs-0).
