...
Source: https://help.zscaler.com/unified/creating-indexed-document-match-template
PDF: https://help.zscaler.com/pdf/com/en/1493246.pdf
...
Once an IDM template is created, it appears on the [Indexed Document Match](/unified/about-indexed-document-match) page of the Admin Portal, where you can view the template’s details or delete it. You cannot change the template name after creation. In order to change the name, you must create a new template.
...
You can also delete the IDM template from the Admin Portal:
...
- Enter a **Template Name**. After the template is saved, this name appears in the [Indexed Document Match](/unified/about-indexed-document-match) page in the Admin Portal.
- Click **Upload File**.
