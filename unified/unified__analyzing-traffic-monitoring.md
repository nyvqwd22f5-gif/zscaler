...
Source: https://help.zscaler.com/unified/analyzing-traffic-monitoring
PDF: https://help.zscaler.com/pdf/com/en/1516841.pdf

The Traffic Monitoring page provides information on the name, group, location, throughput, and session data across services of your Cloud or Branch Connector. You can use the **Refresh **icon to refresh the dashboard to view the most recent information.
Analyzing the Traffic Monitoring Page
Location Filtering
You can filter Cloud Connectors under **AWS Regions**, **Azure**, and **GCP**. You can filter Branch Connectors under **Branch Connector Locations**.
...
[]The Geo View provides the geographic locations of all Cloud and Branch Connectors provisioned and deployed on your cloud or branch accounts. The location filtering can be used to filter particular Cloud and Branch Connectors based on your requirements. The map displays the number of Cloud and Branch Connectors deployed in different regions. You can click the cluster to view all the Cloud and Branch Connectors in a particular region along with their cloud provider type (i.e., **AWS**, **Azure**, **GCP**, or **Branch Connector Locations**). You can also click any Cloud and Branch Connector to view its throughput and session count data.
...
- **Connector Group**: The name of the group to which the Cloud or Branch Connector VM is assigned.
...
Click the **View** icon to access the [Traffic Flow](/unified/analyzing-traffic-flow) page, where you can see the throughput and session count forwarded to **ZIA**, **ZPA**, or **Direct** for the selected Cloud or Branch Connector.
