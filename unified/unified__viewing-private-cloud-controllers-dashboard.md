...
Source: https://help.zscaler.com/unified/viewing-private-cloud-controllers-dashboard
PDF: https://help.zscaler.com/pdf/com/en/1528761.pdf
...
Click on any of the Private Cloud Controllers in the widgets to view the [User Activity Diagnostic logs](/unified/accessing-user-activity-diagnostics) page filtered for this Private Cloud Controller.
...
- **Total Bytes Received from Public Service Edges**: Displays up to the top 10 Private Cloud Controllers and the number of bytes received by each from the  Public Service Edges for Private Applications.
- **Total Bytes Transmitted to Public Service Edges**: Displays up to the top 10 Private Cloud Controllers and the number of bytes transmitted by each to the Public Service Edges for Private Applications.
...
- **Total Private Service Edges Connected to the Private Cloud Controller**: Displays up to the top 10 Private Cloud Controllers and the total number of Private Service Edges for Private Applications connected to each.
- **Peak Zscaler Client Connector Redirections to Private Service Edges**: Displays up to the top 10 Zscaler Client Connector redirects to the Private Service Edges for Private Applications.
...
- **Bytes Received from Public Service Edges**: Displays the number of bytes received by the Private Cloud Controller from the Public Service Edges for Private Applications.
- **Bytes Transmitted to Public Service Edges**: Displays the number of bytes transmitted by the Private Cloud Controller from the Public Service Edges for Private Applications.
...
- **Zscaler Client Connector Redirections to Private Service Edges**: Displays the number of Zscaler Client Connector redirects to the Private Service Edges for Private Applications.
...
- **Logs**: Click to view the [User Activity Diagnostic logs](/unified/accessing-user-activity-diagnostics) page filtered for this Private Cloud Controller.
...
- **Active Connections to Public Service Edges**: The active connection the Private Cloud Controller had to Public Service Edges for Private Applications for the point in time listed.
...
- **Zscaler Client Connector Redirections to Private Service Edges**: The number of Zscaler Client Connector redirects to the Private Service Edges for Private Applications.
...
- CPU Utilization
- Memory Utilization
[]The latency monitor widgets on the Latency tab show the latency trend from a Public Service Edge for Private Applications to a Private Cloud Controller in the selected time range. The time range for the Latency tab is different from the rest of the Private Cloud Controllers dashboard. It is limited to data over a period between **30 Mins** to **24 Hours**, or you can select **Custom Range** to specify a custom start and end date. If you use Custom Range, the start date can be within the last 24 hours. This filter applies to all widgets in the Latency tab, and the default time is 30 minutes.
...
Each widget shows the Public Service Edges for Private Applications that interact with the selected Private Cloud Controller during the time range. The widgets have the same functionality as seen in the [Activity Monitor](#ActivityMonitorWidgets) section.
...
[]![Filter Private Cloud Controllers on the Private Cloud Controllers Dashboard in the Admin Portal](/downloads/zpa/dashboard-diagnostics/private-cloud-controller-monitoring/viewing-private-cloud-controllers-dashboard/zpa-pcc-dashboard-filters.jpg)
