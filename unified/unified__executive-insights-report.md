...
Source: https://help.zscaler.com/unified/executive-insights-report
PDF: https://help.zscaler.com/pdf/com/en/1497521.pdf
...
For organizations that receive it, this report is located in Analytics > Internet & SaaS > Analytics > Executive Insights Email Report.
[See image.](#report)
Report Schedule
There are two sets of recipients that receive the report. The first set receives the report on the first weekend, when the report is generated. The second set receives the report 7 days after the first set receives it.
If you want to add a recipient to receive the report, contact your Zscaler Account team team to add them. Specify which set you want them to be added to, the first or second set of recipients.
Report Widgets
...
[]![Screenshot of the Executive Insights report. Contains comparative analysis through bar graphs and percentages.](/downloads/zia/documentation-knowledgebase/analytics/dashboards-reports-and-logs/reports/executive-insights-report/zia-executive-insights-report.png)