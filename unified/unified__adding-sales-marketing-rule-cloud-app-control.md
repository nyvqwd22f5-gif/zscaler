...
Source: https://help.zscaler.com/unified/adding-sales-marketing-rule-cloud-app-control
PDF: https://help.zscaler.com/pdf/com/en/1494756.pdf
...
-
From the **Cloud App Control Policy** tab, click **Add** and select **Sales and Marketing**.
The **Add Sales and Marketing Rule** window appears.
- In the **Add Sales and Marketing Rule** window, enter the rule attributes:
...
[]![Screenshot of ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-sales-marketing-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Sales-Marketing-See-More.png)
