...
Source: https://help.zscaler.com/unified/viewing-device-fingerprint-information-failed-posture-devices
PDF: https://help.zscaler.com/pdf/com/en/1532414.pdf

Device Posture Failure is available for Windows users only.
You can view device fingerprint information for [Failed Posture Devices](/unified/about-failed-posture-devices).
To view device fingerprint information for failed posture devices:
-
In the Admin Portal, go to **Infrastructure > Connectors > Client > Failed Posture Devices**.
...
- **External Device ID**: The identifier that associates an external Mobile Device Management (MDM) device ID with devices in the Admin Portal. This feature is not supported on Zscaler Client Connector versions earlier than 4.0 for Windows.
...
- **Owner**: If [Collect Device Owner Information](/unified/configuring-zscaler-client-connector-collect-device-owner-information) is enabled, this field displays the device owner information. This is the locally logged in user. When disabled, this field does not display device owner information.
...
- **Logout, Disable, Uninstall Password**: The password associated with the device’s app profile. Applies to Zscaler Client Connector version 4.0 for Windows. To learn more, see [Configuring Zscaler Client Connector Profiles](/unified/configuring-zscaler-client-connector-app-profiles).
-
For Zscaler Client Connector version 4.0 and later for Windows, the following optional one-time passwords listed are associated with the device’s app profile and are configured in [app profiles](/unified/configuring-zscaler-client-connector-app-profiles):
