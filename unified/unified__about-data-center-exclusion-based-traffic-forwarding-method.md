...
Source: https://help.zscaler.com/unified/about-data-center-exclusion-based-traffic-forwarding-method
PDF: https://help.zscaler.com/pdf/com/en/1495246.pdf
...
- The admin’s action of disabling the tunnels is logged in the [Audit Logs](/unified/about-audit-logs) in the Admin Portal.
...
- The status of the tunnels and the reason they are down are logged in the [Tunnel Insights Logs](/unified/tunnel-insights-logs-columns) in the Admin Portal.
...
- [Add a DC exclusion](/unified/excluding-data-center-based-traffic-forwarding-method).
...
- Edit a configured DC exclusion.
- Delete a configured DC exclusion.
