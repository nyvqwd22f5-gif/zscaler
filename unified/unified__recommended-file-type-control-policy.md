...
Source: https://help.zscaler.com/unified/recommended-file-type-control-policy
PDF: https://help.zscaler.com/pdf/com/en/1494021.pdf

When [configuring](/unified/configuring-file-type-control-policy) the [File Type Control policy](/unified/about-file-type-control), Zscaler recommends using:
...
If you have Advanced Sandbox, you can configure your Sandbox policy to [quarantine](/unified/configuring-sandbox-policy#first-time-action) executable downloads for the first-time action.
