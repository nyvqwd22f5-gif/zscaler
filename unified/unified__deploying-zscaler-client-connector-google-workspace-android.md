...
Source: https://help.zscaler.com/unified/deploying-zscaler-client-connector-google-workspace-android
PDF: https://help.zscaler.com/pdf/com/en/1532841.pdf
...
[See image.](#settings)
- In the **Runtime permissions **section, select **Allow** for the **Contacts **feature if **Zscaler Client Connector as IdP **is the preferred authentication type**. **Click **Save** and collapse the **Runtime permission**s section.
[See image.](#runtime)
...
`}``
[See image.](#json)
- You can add [Zscaler parameters](/unified/parameters-guide-zscaler-client-connector-android-and-android-chromeos) to the JSON format based on your organization's needs and click **Save**.
