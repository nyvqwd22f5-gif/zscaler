...
PDF: https://help.zscaler.com/pdf/com/en/1285441.pdf
...
- In the Zscaler Client Connector Portal, go to **Administration **and click **Client Connector App Store**.
...
- From the** User Groups** drop-down menu, select the groups to which you want to apply this configuration.
- [Groups are synced](/zscaler-client-connector/syncing-directory-groups-between-zia-admin-portal-and-zscaler-client-connector-portal) from Zscaler Internet Access (ZIA).
...
- In the Zscaler Client Connector Portal, go to **Administration **and click **Client Connector App Store**. Make sure you're on the **Update Settings** tab.
...
- In the Zscaler Client Connector Portal, go to **Administration**. Click **Client Connector App Store**. Make sure you are on the **Update Settings** tab.
