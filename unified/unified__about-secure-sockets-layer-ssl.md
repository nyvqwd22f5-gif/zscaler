...
Source: https://help.zscaler.com/unified/about-secure-sockets-layer-ssl
PDF: https://help.zscaler.com/pdf/com/en/1493021.pdf
...
[]![Image of SSL packet capture](/downloads/zpa/ssl_packet_capture_image.png)
...
To see a list of the supported DHE and ECDHE cipher suites, see [Supported Cipher Suites in SSL Inspection](/unified/supported-cipher-suites-ssl-inspection).
To learn more about how the Zscaler service can protect your organization from the potential misuse of SSL by attackers for malicious activity, see [Protecting SSL Traffic](/unified/about-ssl-inspection#how-zscaler-protects-ssl-traffic).
[]![Screenshot of certificate chain](/downloads/zpa/certificate_chain_screenshot.png)
[]![Screenshot of certificate signed by Google Internet Authority G2](/downloads/zpa/certificate_signed_by_google_internet_authority_g2_screenshot.png)
[]![Screenshot of certificate signed by GeoTrust Global CA](/downloads/zpa/certificate_signed_by_geotrust_global_ca_screenshot.png)
[]![Screenshot of certificate signed by Equifax Secure Certificate Authority](/downloads/zpa/certificate_signed_by_equifax_secure_certificate_authority.png)
[]![Screenshot of the browser certificate store](/downloads/zpa/browser_certificate_store_screenshot.png)