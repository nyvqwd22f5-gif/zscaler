...
PDF: https://help.zscaler.com/pdf/com/en/1531357.pdf
...
[See image.](#disable-password-authentication)
- Click **Save**.
...
- Go to **Settings** > **Users & Roles** > **Settings**.
- In **Password expiration (Days)**, enter the password expiration period in days.
[See image.](#modify-password-expiry-period)
- Click **Save**.
...
[]![Disable password authentication](/downloads/deception/authentication/authentication-settings/configuring-user-authentication-settings/itdr-disable-password-auth_1.png)
[]![Modify password expiry period](/downloads/deception/authentication/authentication-settings/configuring-user-authentication-settings/itdr-modify-password-expiry-period_1.png)
[]![Modify OTP duration](/downloads/deception/authentication/authentication-settings/configuring-user-authentication-settings/itdr-modify-otp-duration-1.png)