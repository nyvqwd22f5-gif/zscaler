...
Source: https://help.zscaler.com/itdr/siem-configuration-guide-ibm-qradar
PDF: https://help.zscaler.com/pdf/com/en/1531725.pdf
...
- [Step 1: Forward Logs to QRadar](#itdr-qradar-siem-integration-forward-logs)
- [Step 2: Create a Log Source Type in QRadar](#itdr-qradar-siem-create-log-source)
- [Step 3: Create a Custom Log Source Extension in QRadar](#itdr-qradar-siem-log-source-extension)
- [Step 4: Add a Log Source to QRadar](#itdr-qradar-siem-integration-add-log-source)
...
[See image.](#itdr-qradar-siem-integration-option)
-
In the **QRadar Details** window:
- **Name**: Enter a name for the QRadar SIEM integration.
- **Enabled**: Select to enable SIEM integration.
- **Service Connector**: Select a Service Connector from the drop-down menu. If you select a Service Connector that is configured in the ITDR Admin Portal, the portal sends logs to QRadar.
- **Type of logs**: Select an option from the drop-down menu.
- **Events**: Send events to QRadar.
- **Audit Logs**: Send audit logs to QRadar.
- **Include Safe Events**: Enable to forward the events that are marked as safe to QRadar.
-
**Filter**: Specify a query if you want to send filtered event logs to QRadar. If this field is blank, all event logs are sent to QRadar.
...
[See image.](#itdr-config-qradar-siem-integration-details)
-
Click **Save**.
...
- Select the [log source type](#itdr-qradar-siem-create-log-source) that you created.
- Click **Save**.
...
- **Log Source Type**: Select the [log source type](#itdr-qradar-siem-create-log-source) you created from the drop-down menu.
...
To test the QRadar SIEM integration, generate events on the Investigate page. The QRadar console starts receiving logs.
[]![Add SIEM Integration option](/downloads/itdr/orchestrate/siem-integrations/siem-configuration-guide-ibm-qradar/itdr-add-siem-integrations-qradar.png)
[]![Configure SIEM Integration details for IBM QRadar](/downloads/itdr/orchestrate/siem-integrations/siem-configuration-guide-ibm-qradar/itdr-configt-siem-integrations-qradar.png)