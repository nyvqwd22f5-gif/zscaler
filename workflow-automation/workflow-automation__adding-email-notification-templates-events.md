...
Source: https://help.zscaler.com/workflow-automation/adding-email-notification-templates-events
PDF: https://help.zscaler.com/pdf/com/en/1503496.pdf

[]Workflow Automation allows you to create various email notification templates using the email template builder to send notifications to end users for event justification. The email template builder ensures that the email notification template displays properly to all email clients.
...
After you select the template type, the email template builder appears and displays the following:
...
- The Button toolbar, which contains the **Content**,** Blocks**, **Body**, and **Images **buttons. You use these buttons to navigate within the email template builder.
...
[![Viewing the Notification Template page with an empty email template builder. The email template builder displays a template design area, the Rich Text Editor with all the tools, and the Button toolbar.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/WA-BI-Not-Template-PG-Initial-PG.png)
][]
[]To configure the general details for the template body:
-
On the email template builder, in the Button toolbar, click **Body**. The Rich Text Editor appears, displaying fields that you can use to configure the general details for the template.
...
[]![Viewing the Notification Template page with the Body button highlighted in the Button toolbar.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/WA-BI-Not-Template-PG-Body-Button.png)
[]![ Viewing the General section in the Rich Text Editor for the body of the template. This section contains fields that are used for configuring the body of the email notification template.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/WA-BI-Not-Template-PG-Body-Button-General.png)
[]![Viewing the Email Settings section in the Rich Text Editor for the body of the template. This section contains a Preheader Text field that is used for the email notification template.](/downloads/workflow-automation/setup/managing-notification-templates/WA-Not-Template-Page-Body-Button-Email-Settings.png)
[]![Viewing the Links section in the Rich Text Editor for the body of the template. This section contains fields (Color and Underline) that are used for configuring the links within the body of the email notification template.](/downloads/workflow-automation/setup/managing-notification-templates/WA-Not-Template-Page-Body-Button-Links.png)
[]To add rows with columns:
-
In the email template builder, add a row with columns to the template using one of these methods:
...
- In the Button toolbar, click **Blocks**. In the Rich Text Editor, select a row with one or more columns, then drag and drop it to the template design area of the email template builder. Depending on your selection, in the template design area, a row appears with one or more columns.
...
- In the **All Sides** field, from the drop-down menu, select the type of border for all sides of the column. Border types are **Solid**, **Dotted**, and **Dashed**.
...
- Drop a new image or select a file to upload in the empty box under the **Background Image** field. The image you upload appears in the box along with an **Edit Image** button. In the template design area, this image also appears for the row.
...
-
**Image Options**: Configure the following options for the uploaded image:
...
-
**Repeat**: Select whether you want to repeat the image in the row. The following are repeat options:
...
- In the Rich Text Editor, click the **Mobile** tab. All the settings that you added to the row in the desktop version appear on the mobile version.
...
![Video showing how use the email template builder to configure rows with columns for an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Columns%20Rows/WA-BI-Video-Methods-for-Adding-Rows.gif)
[]
[]![Viewing the email template builder with rows and columns added for an email notification template. A row with two columns is highlighted in the design section. In addition, the Desktop tab and Column tab are highlighted in the Rich Text Editor for that row.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Columns%20Rows/WA-BI-Not-Template-PG-RichTextEditor-Add-Rows-With-Cols.png)
[]![Video showing how use the email template builder to configure rows with one or more columns for an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Columns%20Rows/WA-BI-Video-Adding-Columns-to-Rows.gif)
[]![Viewing the Column Properties section in the Rich Text Editor for a row with two columns. Tabs are highlighted at the top of the section for each column in the row. The Column Properties section contains fields for Background Color, Padding, and Border.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Columns%20Rows/WA-BI-Not-Template-PG-Add-Columns-Column-Properties.png)
[]![Viewing the Row Properties section in the Rich Text Editor for a row. The Row properties section contains fields for Background Color and Content Background Color. In addition, there are buttons and fields to upload an image for a row.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Columns%20Rows/WA-BI-Not-Template-PG-Add-Columns-Row-Properties.png)
...
[]![Viewing the mobile version of the email template builder with rows and columns added for an email notification template. The Mobile tab is highlighted on the Rich Text Editor.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Columns%20Rows/WA-BI-Not-Template-PG-Add-Columns-Mobile-Tab.png)
[]To add buttons:
...
- In the template design area, click the button placeholder in the column and row where you dropped the text. In the template design area, a Button toolbar appears. On the right side of the email template builder, the Rich Text Editor for the button also appears, displaying the **Desktop** tab for the button.
...
-
**Special Links**: (Optional) From the drop-down menu, select **Event Justification Magic Link**. This redirects the user to the Event page, where they can view and enter justification details for an event.
...
- In the Rich Text Editor, click the **Mobile** tab. Most of the settings that you added for the button in the desktop version appear for the mobile version.
...
[]![Video showing how to use the email template builder to add a button for an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Button/WA-BI-Video-Adding-Buttons.gif)
[]![Viewing the Smart Buttons section in the Rich Text Editor for a button. The Smart Buttons section contains a Try it Now! button. When you click this button you can get AI based suggestions for your buttons in any tone you want.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Button/WA-BI-Not-Template-PG-Add-Buttons-Smart-Buttons.png)
...
[]![Viewing the Button Options section in the Rich Text Editor for a button. The Button Option section contains multiple fields, such as Background Color, Text Color, Width, Font Family, Font Weight, and Font Size.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Button/WA-BI-Not-Template-PG-Add-Buttons-Button-Options.png)
[]![Viewing the Spacing section in the Rich Text Editor for a button. The Spacing section contains fields for Alignment, Padding, Border, and Rounded Border.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Button/WA-BI-Not-Template-PG-Add-Buttons-Spacing.png)
[]![Viewing the General section in the Rich Text Editor for a button. The General section contains the Container Padding field.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Button/WA-BI-Not-Template-PG-Add-Buttons-General.png)
...
[]![Viewing the mobile version of an email notification template that contains a button in the email template builder. The Mobile tab is highlighted on the Rich Text Editor.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Button/WA-BI-Not-Template-PG-Add-Buttons-Mobile-Tab.png)
[]To add dividers:
-
In the email template builder, in the Button toolbar, click **Content**. In the Rich Text Editor, click the **Divider** tool, then drag and drop it to a column in a row in the template design area of the email template builder. In the template design area, a divider line appears in the column for the row.
...
- In the** **Rich Text Editor, click the **Mobile** tab. A couple of the settings that you added for the divider in the desktop version appear for the mobile version.
...
[]![Video showing how to use the email template builder to add a divider for an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Divider/WA-BI-Video-Adding-Dividers.gif)
[]![Video showing how to use the email template builder to configure a divider for an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Divider/WA-BI-Video-Configuring-Dividers.gif)
[]![Viewing the General section in the Rich Text Editor for a divider. The General section contains the Container Padding field.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Divider/WA-BI-Not-Template-PG-Add-Dividers-General.png)
[]![Viewing the Responsive Design section in the Rich Text Editor for a divider. The Responsive Design section contains an option to hide this button on the Desktop version of the email notification template.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Divider/WA-BI-Not-Template-PG-Add-Dividers-Responsive-Design.png)
[]![Viewing the mobile version of an email notification template that contains a divider in the email template builder. The Mobile tab is highlighted on the Rich Text Editor.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Divider/WA-BI-Not-Template-PG-Add-Dividers-Mobile-Tab.png)
[]To add headings:
- In the email template builder, in the Button toolbar, click **Content**. In the Rich Text Editor, click the **Heading** tool, then drag and drop it to a column in a row in the template design area of the email template builder. In the template design area, the text `Heading` appears in the column for the row. By default, the heading type is an H1.
- Enter the text or value for the heading:
- In the template design area, click the `Heading` text in the column and row where you dropped the heading. In the template design area, a heading toolbar appears. On the right side of the email template builder, the Rich Text Editor for the heading also appears, displaying the **Desktop** tab for the heading.
- In the template design area:
...
-
(Optional) **Special Links**: From the drop-down menu, select **Event Justification Magic Link**. This redirects the user to the Event page, where they can view and enter justification details for an event.
...
- In the Rich Text Editor, click the **Mobile** tab. Most of the settings that you added for the heading in the desktop version appear for the mobile version.
...
[]![Video showing how to use the email template builder to add text to an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Heading/WA-BI-Video-Adding-Headings.gif)
[]![Viewing the Smart Headings section in the Rich Text Editor for a heading. The Smart Headings section contains a Try it Now! button. When you click this button you can get AI based suggestions for your heading in any tone you want.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Heading/WA-BI-Not-Template-PG-Add-Heading-Smart-Headings.png)
[]![Viewing the Text section in the Rich Text Editor for a heading. The text section contains multiple fields, such as Heading Type, Font Family, Font Weight, Font Size, Color, and Text Align.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Heading/WA-BI-Not-Template-PG-Add-Heading-Text.png)
[]![Viewing the Links section in the Rich Text Editor for heading. This section contains fields (Inherit Body Styles, Color, and Underline) that are used for configuring the links within the heading for the email notification template.](/downloads/workflow-automation/setup/managing-notification-templates/WA-Not-Template-Page-Add-Heading-Rich-Text-Editor-Link-Section.png)
[]![Viewing the General section in the Rich Text Editor for a heading. The General section contains the Container Padding field.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Heading/WA-BI-Not-Template-PG-Add-Heading-General.png)
...
[]![Viewing the mobile version of an email notification template that contains a heading in the email template builder. The Mobile tab is highlighted on the Rich Text Editor.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Heading/WA-BI-Not-Template-PG-Add-Heading-Mobile-Tab.png)
[]To add text:
...
- In the** **Rich Text Editor, click the **Mobile** tab. Most of the settings that you added for the text in the desktop version appear for the mobile version.
...
[]![Video showing how to use the email template builder to add text to an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Text/WA-BI-Video-Adding-Text.gif)
[]![Viewing the Text section in the Rich Text Editor for text.  The text section contains multiple fields, such as Font Family, Font Weight, Font Size, Color, and Text Align.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Text/WA-BI-Not-Template-PG-Add-Text-Text.png)
[]![Viewing the Links section in the Rich Text Editor for text. This section contains fields (Inherit Body Styles, Color, and Underline) that are used for configuring the links within the text for the email notification template.](/downloads/workflow-automation/setup/managing-notification-templates/WA-Not-Template-Page-Add-Text-Rich-Text-Editor-Link-Section.png)
[]![Viewing the General section in the Rich Text Editor for text. The General section contains the Container Padding field.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Text/WA-BI-Not-Template-PG-Add-Text-General.png)
...
[]![Viewing the mobile version of an email notification template that contains text in the email template builder. The Mobile tab is highlighted on the Rich Text Editor.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Text/WA-BI-Not-Template-PG-Add-Text-Mobile-Tab.png)
[]You can add images to the template design area using a couple of different methods. You can select an image in the Rich Text Editor accessed from the **Images** button on the Button toolbar, or you can click the **Image** tool in the Rich Text Editor accessed from the **Content** button on the Button toolbar.
To add images:
-
In the email template builder, drag and drop an image to the template using one of the following methods:
...
-
In the Rich Text Editor, in the **Responsive Design **section, if you want to hide the image from the desktop version, enable **Hide on Desktop**. In the desktop version of this notification template, the image is hidden.
[See image.](#email-builder-image-content-window-resp-des-section)
- Configure the mobile version of the image for the template:
- In the Rich Text Editor, click the **Mobile** tab. Most of the settings that you added for the image in the desktop version appear for the mobile version.
...
[]![Video showing how to use the email template builder to add an image to an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Image/WA-BI-Video-Adding-Images.gif)
[]![Viewing the Magic Image section in the Rich Text Editor for a image. The Magic Image section contains a Generate Images button. When you click this button you can get unique and custom images for your design with AI.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Image/WA-BI-Not-Template-PG-Add-Image-Magic-Image.png)
[]![Viewing an uploaded image on the email template builder. The uploaded image is highlighted in the Design area.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Image/WA-BI-Not-Template-PG-Add-Image-Upload-Image.png)
[]![Viewing the edit image window for an image in the email template builder. This window contains several buttons that you can use to apply different affects to the image. Buttons are Filter, Resize, Crop, Draw, Text, Shapes, Stickers, Frame, Corners, and Merge.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Image/WA-BI-Not-Template-PG-Add-Image-Edit-Image-Page.png)
[]![Viewing the Image section in the Rich Text Editor for an image. The Image section contains buttons to upload an image and additional fields (Width, Align, and Alternate Text) for the image.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Image/WA-BI-Not-Template-PG-Add-Image-Image-Sec.png)
...
[]![Viewing the General section in the Rich Text Editor for an image. The General section contains the Container Padding field.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Image/WA-BI-Not-Template-PG-Add-Image-General.png)
...
- **Separator**: Enter the separator for the menu items. In the template design area, the menu items appear with this separator.
-
**Padding**: Set the padding in one of the following ways:
...
- In the Rich Text Editor, click the **Mobile** tab. Most of the settings that you added for the menu in the desktop version appear for the mobile version.
...
[]![Video showing how to use the email template builder to add a menu to an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Menu/WA-BI-Video-Adding-Menus.gif)
[]![Viewing the email template builder with a menu configured for an email notification template. The menu items are highlighted in the design section. In addition, the Label fields for the action items are highlighted in the Menu Items section in the Rich Text Editor for the menu.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Menu/WA-BI-Not-Template-PG-Add-Menu-Action-Types.png)
[]![Viewing the Styles section in the Rich Text Editor for a menu. The Styles section contains fields, such as Font Family, Font Weight, Font Size, Text Color, Link Color, Align, Layout, Separator, and Padding.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Menu/WA-BI-Not-Template-PG-Add-Menu-Styles.png)
[]![Viewing the General section in the Rich Text Editor for a menu. The General section contains the Container Padding field.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Menu/WA-BI-Not-Template-PG-Add-Menu-General.png)
...
[]![Viewing the mobile version of an email notification template that contains an image in the email template builder. The Mobile tab is highlighted on the Rich Text Editor.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/Menu/WA-BI-Not-Template-PG-Add-Menu-Mobile-Tab.png)
[]To add HTMLs:
-
...
- In the Rich Text Editor, click the **Mobile** tab. A couple of the settings that you added for the HTML in the desktop version appear for the mobile version.
...
[]![Video showing how to use the email template builder to add HTML content to an email notification template](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/HTML/WA-BI-Video-Adding-HTML-Content.gif)
[]![Viewing the HTML section in the Rich Text Editor for HTML content. The HTML section contains an area where you can add the HTML content you want to display on the email notification template. The HTML content section is highlighted in the Rich Text Editor and the HTML content is highlighted in the design area for the email notification template.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/HTML/WA-BI-Not-Template-PG-Add-HTML-HTML.png)
[]![Viewing the General section in the Rich Text Editor for HTML content. The General section contains the Container Padding field.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/HTML/WA-BI-Not-Template-PG-Add-HTML-General.png)
...
[]![Viewing the mobile version of an email notification template that contains HTML content in the email template builder. The Mobile tab is highlighted on the Rich Text Editor.](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/HTML/WA-BI-Not-Template-PG-Add-HTML-Mobile-Tab.png)
...
[]To move rows:
-
In the email template builder, in the template design area for a template, click the row that you want to move. A directional icon appears at the end of the row.
...
[]![Viewing the email template builder with a row selected in the Design area and the directional icon highlighted at the end of the row. When a row is selected in the Design area, the directional icon appears at the end of the row. Click the directional icon and then drag and drop the row to the new location in the template. ](/downloads/workflow-automation/business-insights/setup/adding-email-notification-templates-events/moving-deleting-duplicating-rows-columns/WA-BI-Email-Builder-Move-Rows.png)
[]To move column content:
-
In the email template builder, in the template design area for a template, click the column of a row that contains content that you want to move. A directional icon appears at the end of the column.
...
[]To duplicate a row:
-
In the email template builder, in the template design area, click the row that you want to duplicate. A **Delete** icon and a **Duplicate** icon appear under the row. On the right side of the email template builder, the Rich Text Editor for the row appears.
