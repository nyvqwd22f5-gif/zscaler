...
PDF: https://help.zscaler.com/pdf/com/en/1495211.pdf
...
You can only add Microsoft Teams notification templates if you have integrated Workflow Automation with Microsoft Teams.
To add a Microsoft Teams notification template:
-
...
After you select the template type, a section to create the Microsoft Teams notification template appears under the row on the page. Using the options at the top of this new section, you can create and design a Microsoft Teams notification template, change the content of the template, and insert links.
[See image.](#add-microsoft-teams-notification-template)
- In the content section, design the Microsoft Teams notification template by entering text and using one or more of the following options:
...
[]![Notification Template Page - Adding Microsoft Teams Template](/downloads/workflow-automation/setup/adding-microsoft-teams-notification-templates/WA-Notification-Template-PG-Add-MSTeams-Notification.png)