...
PDF: https://help.zscaler.com/pdf/com/en/1400386.pdf
...
Some issues might involve having no backup or updated GRE tunnels, failing to set up monitoring on the failover tunnel, and not using the ${GATEWAY} MACRO to help forward traffic to Zscaler. These issues might result in traffic inadequately being sent to the Zscaler cloud, which can lead to an internet outage. You might also run into authentication issues and other issues that impact your user experience when sending traffic to Zscaler. For example, the Microsoft-Recommended Microsoft 365 One Click Configuration option ensures a smoother Microsoft 365 experience by automatically exempting the required URLs so that authentication and SSL interception is performed appropriately. If this button is disabled, you might run into user experience issues.
You can view the report in the ZIA Admin Portal by going to **Analytics** > **System Audit Report**.
[See image.](#report)
...
- [GRE Tunnels](#GRE)
- [PAC Files](#PAC)
- User Performance Configuration
...
The overall grade for the report is the overall grades for High Availability Configuration and User Performance Configuration combined. It's not dependent on Other Configuration.
...
If you receive a grade of B or C, see [Best Practices for Deploying GRE Tunnels](/zia/best-practices-deploying-gre-tunnels).
...
[]In this section, we check all PAC files to see if they use a ZIA Public Service Edge’s static FQDN name or VIP address in the return statement. The PAC files can use Global ZIA Public Service Edge IP address, Virtual Service Edge (formerly Virtual ZEN or VZEN) IP address, Private Service Edge (formerly Private ZEN or PZEN) IP address, or an on-premises proxy solution, and it won’t be flagged in this report.
[See image.](#pacimage)
...
If you receive a grade of B or C, see [Best Practices for Writing PAC Files](/zia/best-practices-writing-pac-files).
...
If you receive a grade of B or C, see [Best Practices for Deploying GRE Tunnels](/zia/best-practices-deploying-gre-tunnels).
[]****![System Audit Report](/downloads/zscaler-tech-pubs-style-guide/draft-articles/about-system-audit-report/updated-system-audit-report_0.png)
****
[]****![GRE Tunnels](/downloads/zscaler-tech-pubs-style-guide/draft-articles/about-system-audit-report/updated-gre-tunnels.png)
****
[]****![PAC Files](/downloads/zscaler-tech-pubs-style-guide/draft-articles/about-system-audit-report/Static%20PAC%20Files.png)
****
