...
PDF: https://help.zscaler.com/pdf/com/en/1398996.pdf

[Watch a video about Backup and Restore](https://fast.wistia.net/embed/iframe/52m88uwf64)
When you restore policies and configuration settings from a [restore point](/zia/about-backup-and-restore), it overwrites all your current policies and configuration settings, including all the rules and their components, such as URL categories and time intervals. If your current configuration has a component that is not in the restore point, such as a URL category, that component is removed when the restore point is restored. Therefore, you might want to review the policies in the restore point before restoring it.
...
- Click **Collapse All **to collapse all of the expanded policies.
