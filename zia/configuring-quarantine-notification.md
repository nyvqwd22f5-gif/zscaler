...
- **Display Company Logo**: Enable this option to display the logo of your organization in the end user notification. The option to upload your company logo is available on the [Company Profile page](/zia/about-company-profile).
[See image.](#settings)
- These settings within the **Configure Notifications **section are also applied to [block notifications](/zia/configuring-block-notifications) and [caution notifications](/zia/configuring-caution-notification).
...
The options within the **IT Support** section are also applied to [Acceptable Use Policy](/zia/configuring-acceptable-use-policy), [block notifications](/zia/configuring-block-notifications), and [caution notifications](/zia/configuring-caution-notification).
