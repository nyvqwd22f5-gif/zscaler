...
Source: https://help.zscaler.com/zia/configuring-icap-server-mutual-transport-layer-security-mtls-certificate
PDF: https://help.zscaler.com/pdf/com/en/1402431.pdf

ICAP servers can be configured for mutual client authentication using the MTLS Certificate Authority (CA) Certificate that you can download from the ZIA Admin Portal.
To configure the ICAP server with the MTLS Certificate:
- In the ZIA Admin Portal, go to **Administration** > **ICAP Receivers** or **Administration** > **DLP Incident Receiver**.
