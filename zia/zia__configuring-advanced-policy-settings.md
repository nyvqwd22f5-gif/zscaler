...
PDF: https://help.zscaler.com/pdf/com/en/1399326.pdf

[Watch a video about Configuring Advanced Policy Settings.](https://fast.wistia.net/embed/iframe/i9mt7tmn0q)
...
[]Enable this option to activate the predefined CIPA Compliance Rule. To learn more, see [About CIPA Compliance](/zia/about-cipa-compliance).
If you have exceeded the [URL filtering policy rules limit](/zia/ranges-limitations#Rules), the following warning message appears:
...
- Yahoo
- YouTube
[SSL Inspection](/zia/about-ssl-inspection) must be enabled for this option.
...
- [Firewall Control Policy](/zia/about-firewall-control) and [DNS Control Policy](/zia/about-dns-control): The rule is created to allow traffic from firewall.
- [Cloud App Control Policy](/zia/about-cloud-app-control): The rule is created under the Collaboration & Online Meetings category to allow traffic destined to the Zoom, GoTo, RingCentral, Webex, or Talkdesk UCaaS applications.
...
[]![Advanced Policy Settings Tab allows you to configure advanced settings for policies](/downloads/zia/policies/url-filtering/configuring-advanced-policy-settings/ZIA-Advanced-Policy-Settings-New-Gen-AI-Claude-Mistral.png)