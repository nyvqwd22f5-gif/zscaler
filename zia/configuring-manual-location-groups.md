...
PDF: https://help.zscaler.com/pdf/com/en/1400546.pdf

This article describes how to create a [manual location group](/zia/about-location-groups) and how to add your locations and sublocations to a manual group. You can add up to 256 groups, inclusive of manual and dynamic location groups. For a complete list of ranges and limits per feature, see [Ranges & Limitations](/zia/ranges-limitations#Locations).
...
- **Description**: (Optional) Enter a description of the location group.
- **Extranet Location Type**: Select this if you want to create a group of extranet locations. To learn more, see [About Extranet](/zia/about-extranet).
...
Select the checkboxes for the locations or sublocations you want to assign to the manual group. You can assign a location to the group independently of its sublocations and a sublocation independently of its parent location. You can add up to 32K locations and sublocations to a group. For a complete list of ranges and limits per feature, see [Ranges & Limitations](/zia/ranges-limitations#Locations).
...
[See image.](#filter)
You can also search for specific locations or sublocations by entering the name, group name, IP address, proxy port, VPN credential name, ZIA Virtual Service Edge name, or cluster name.
