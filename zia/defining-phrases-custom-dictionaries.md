...
PDF: https://help.zscaler.com/pdf/com/en/1400061.pdf

[]You can add phrases to your custom dictionaries that represent content you want to protect for your organization. To learn more, see [Adding Custom DLP Dictionaries](/zia/adding-custom-dlp-dictionary).
...
- To enable matching of Unicode phrases when they are adjacent to other characters with no delimiters in between, check the Unicode checkbox. To learn more, see [Adding Custom DLP Dictionaries](/zia/adding-custom-dlp-dictionary).
