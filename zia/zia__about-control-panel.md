...
Source: https://help.zscaler.com/zia/about-control-panel
PDF: https://help.zscaler.com/pdf/com/en/1508616.pdf
...
- [Notes Tab](#Notes-tab)
If the status of a policy is pending, the policy is not displayed on the[ Posture page](/zia/about-posture).
...
- View and change the severity level of the control. To learn more, see [Updating the Control Severity](/zia/updating-control-severity). Hover over the severity level to view a breakdown of the severity.
...
![Remediation Tab showing threat and remediation information](/downloads/tech-pubs-drafts/zia-draft-articles/about-control-panel-draft-doc-57316/Remediation_Tab.png)
...
![Assets Tab showing assets information](/downloads/tech-pubs-drafts/zia-draft-articles/about-control-panel-draft-doc-57316/Assets_Tab.png)
...
You must have user or admin permissions to add notes to the control. To learn more, see [About Roles in 3rd-Party App Governance](/zia/about-roles-3rd-party-app-governance).
...
[]![Assets Tab showing Evidence Copy and Download Options ](/downloads/zia/policies/saas-security/posture-management/posture-management-advanced/about-control-panel/AssetEvidence_Copy.png)