...
Source: https://help.zscaler.com/zia/add-custom-file-hashes
PDF: https://help.zscaler.com/pdf/com/en/1403036.pdf

In addition to the default [Sandbox policy](/zia/about-sandbox) rules, you can add custom MD5 hash values to the Denylist for your organization to block specific files that are applicable to Zscaler Sandbox analysis. You can also add custom MD5 hash values to the Allowlist to allow specific files access.
