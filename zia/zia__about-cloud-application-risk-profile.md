...
PDF: https://help.zscaler.com/pdf/com/en/1402271.pdf
...
On the Cloud Application page (Administration > Risk Profiles), you can do the following:
- [Add a cloud application risk profile](/zia/adding-cloud-application-risk-profile).
...
- [Edit, duplicate, or delete a cloud application risk profile](/zia/editing-deleting-duplicating-items).
