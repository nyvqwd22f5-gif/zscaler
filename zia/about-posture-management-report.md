...
Source: https://help.zscaler.com/zia/about-posture-management-report
PDF: https://help.zscaler.com/pdf/com/en/1401826.pdf
...
To learn more about the SSPM policy statuses, see [Viewing and Managing the Supported SSPM Policies](/zia/viewing-and-managing-supported-sspm-policies).
...
On the Posture Management page (Analytics > SaaS Security > Posture Management), you can do the following:
...
- Administrator
- Notes
You can also [modify the table and its columns](/zia/how-do-i-use-tables-admin-portal).
...
To learn how to configure security policies as per the business requirements, see [Understanding the SaaS Security Posture Management Policy](/zia/understanding-saas-security-posture-management-policy).
