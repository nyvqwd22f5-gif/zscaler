...
PDF: https://help.zscaler.com/pdf/com/en/1399411.pdf

You can schedule standard and custom reports for regular distribution to specified recipients. To learn more about scheduled reports, see [About Scheduled Reports](/zia/about-scheduled-reports).
An organization can schedule up to 500 reports.
You can view and manage scheduled reports by going to **Analytics** > **Interactive Reports **> **Scheduled Reports**. A super admin can view and edit all scheduled reports. Other administrators can view and manage their own scheduled reports only.
To schedule a report:
- Do one of the following:
-
Go to **Analytics** > **Interactive Reports** > **Scheduled Reports**, and then click **Add**.
[See image.](#Scheduled_reports_add_icon)
-
Go to **Analytics** > **Interactive Reports**, select a report, and then click the **Schedule** icon.
...
Recipients can only view the report; they cannot edit it or navigate to any other area of the ZIA Admin Portal. If a recipient copies and pastes the URL of the report, the ZIA Admin Portal login page appears and the recipient is required to enter a valid user name and password to log in.
...
[]![A sample email for a Zscaler scheduled report](/downloads/zia/documentation-knowledgebase/analytics/dashboards-reports-and-logs/reports/how-do-i-schedule-reports/scheduled_report_email_screenshot.png)
