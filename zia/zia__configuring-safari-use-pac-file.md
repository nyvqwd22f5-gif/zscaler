...
PDF: https://help.zscaler.com/pdf/com/en/1400611.pdf
...
- In the **Network** window, select **Automatic Proxy Configuration **and paste the PAC file URL that you copied from the ZIA Admin Portal.
[See image.](#Image5)
...
[![Screenshot of Hosted PAC Files menu in ZIA Admin Portal](/downloads/zia/documentation-knowledgebase/forwarding-your-traffic/pac-files/using-pac-files/configuring-safari-use-pac-file/ZIA-admin-portal-hosted-pac-files-menu.png)
]
