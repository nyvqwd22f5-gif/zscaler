...
PDF: https://help.zscaler.com/pdf/com/en/1400941.pdf

To configure an Azure Virtual WAN (VWAN) location:
You must complete the procedure for [Configuring a Microsoft Azure Virtual WAN Integration](/zia/configuring-microsoft-azure-virtual-wan-integration) before you can sync and configure tunnels for your Azure hubs.
- Go to **Administration **> **Location Management**.
If you clicked on the hub sites hyperlink within the **Administration **> **Partner Integrations** > [Azure Virtual WAN](/zia/configuring-microsoft-azure-virtual-wan-integration) tab, you are automatically redirected to this page.
...
You can view all Azure hub locations from this tab under the **Locations** tab. The [Locations](/zia/about-locations) page allows you apply Zscaler service features, such as enforcing [authentication](/zia/provisioning-and-authenticating-users), enabling [SSL Inspection](/zia/about-ssl-inspection), etc. to any locations associated to the hubs.
