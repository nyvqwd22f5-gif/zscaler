...
PDF: https://help.zscaler.com/pdf/com/en/1400631.pdf
...
-
Click **Add** and select **Hosting Providers**.
The **Add Hosting Providers **window appears.
- In the **Add Hosting Providers **window, enter the **Cloud App Control Rule** attributes:
...
[]![ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-hosting-providers-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Hosting-Provider-Click-See-More.png)
