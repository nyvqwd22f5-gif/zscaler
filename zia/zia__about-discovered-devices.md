...
On the Discovered Devices page (Analytics > IoT Report > any section of the IoT Report), you can do the following:
...
- View all the insights logs related to the IP address. You are redirected to the [Web Insights Logs](/zia/about-insights-logs) page.
- [Provide feedback on an inaccurate or unknown device classification](/zia/providing-feedback-iot-device-classifications).
...
Additionally, you can click **View Logs** to open Web Insights Logs for the device or click [Submit Feedback](/zia/providing-feedback-iot-device-classifications) to provide feedback on incorrect or unknown device classification to the AI/ML engine.
...
Currently, only URL filtering policy status and statistics data is available in the IoT Report. The default policy **None (default)** is a URL filtering policy and not an IoT specific policy. Therefore, it is not counted as an IoT policy.
