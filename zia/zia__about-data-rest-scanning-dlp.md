...
PDF: https://help.zscaler.com/pdf/com/en/1401446.pdf
...
- [Configure a Data at Rest Scanning DLP policy rule.](/zia/configuring-data-rest-scanning-dlp-policy-content-inspection)
...
- [Edit, duplicate, or delete a DLP policy rule.](/zia/editing-deleting-duplicating-items)
- [Modify the table and its columns.](/zia/using-tables)
- Go to the [Exceptions](/zia/configuring-saas-security-api-dlp-policy-exceptions) page, where you can configure DLP policy exceptions.
- Go to the [Malware Detection](/zia/about-saas-security-api-malware-detection) page, where you can create rules to discover and prevent threats to data at rest in sanctioned SaaS applications. You can also configure exceptions to the policy.
- Go to the [Scanning Exceptions](/zia/configuring-saas-security-api-scanning-exceptions) page, where you can configure scanning exceptions for file sharing applications.
