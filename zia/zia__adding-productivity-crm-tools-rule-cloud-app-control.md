...
PDF: https://help.zscaler.com/pdf/com/en/1400151.pdf
...
Organizations are moving to the cloud for their business applications. This category includes applications such as Salesforce, Evernote, and Microsoft 365, so you can create rules specifically for these and other similar cloud applications. You can specify which applications your users are allowed to access and define a daily quote by bandwidth or time.
...
-
Click **Add** and select **Productivity & CRM Tools**.
The **Add Productivity & CRM Tools Rule** window appears.
- In the **Add Productivity & CRM Tools Rule** window, enter the **Cloud App Control Rule** attributes:
...
[]![ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-productivity-crm-tools-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Prod-CRM-See-More.png)
...
-
**Tenant Profiles**: Appears only when **Google Analytics** is selected as the cloud application. You can select the tenant profiles for which you want to apply the rule. To learn more, see [About Tenant Profiles](/zia/about-tenant-profiles).
Ensure that **Google Analytics** is not exempted from SSL Inspection.
