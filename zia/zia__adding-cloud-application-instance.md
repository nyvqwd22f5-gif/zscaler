...
PDF: https://help.zscaler.com/pdf/com/en/1403156.pdf
...
- Go to **Administration** > **Cloud Applications** > **Instances**.
-
...
You can add a maximum of 1,024 instance identifiers per cloud application instance. For guidance on entering URLs, see the [URL Format Guidelines](/zia/url-format-guidelines).
