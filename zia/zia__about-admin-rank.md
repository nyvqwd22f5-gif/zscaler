# About Admin Rank
Source: https://help.zscaler.com/zia/about-admin-rank
PDF: https://help.zscaler.com/pdf/com/en/1399726.pdf

[Watch a video about Admin Rank and how to configure Admin Rank.](https://fast.wistia.net/embed/iframe/zm3n7kynyx)
Admin rank is a feature you use when creating [roles](/zia/adding-admin-roles) for [role-based administration](/zia/about-administrators).
...
By default, the admin ranking is disabled. To use this feature, you must enable admin rank in **Administration** > **Advanced Settings**. To learn more, see [About Advanced Settings](/zia/about-advanced-settings#admin-ranking).
...
[]Admins who have permission to manage roles can only create or edit roles with a lower rank.
