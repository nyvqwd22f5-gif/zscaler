...
PDF: https://help.zscaler.com/pdf/com/en/1401546.pdf
...
Adding a Rule for Human Resources
To add a rule for Human Resources apps:
- Go to **Policy** > **URL & Cloud App Control** > **Cloud App Control Policy**.
-
Click **Add** and select **Human Resources**.
The **Add Human Resources Rule** window appears.
- In the **Add Human Resources Rule** window, enter the **Cloud App Control Rule** attributes:
...
[]![ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-human-resources-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Human-Resources-Click-See-More.png)
