...
Source: https://help.zscaler.com/zia/adding-nss-feeds-firewall-logs
PDF: https://help.zscaler.com/pdf/com/en/1399076.pdf
...
Before you start configuring a feed for Firewall logs, consider the [guidelines for configuring feeds](/zia/general-guidelines-nss-feeds-and-feed-formats).
...
- **Log Domain**:
- If you want to configure NSS for ZIA Firewall logs, choose **Firewall** and follow the successive steps.
