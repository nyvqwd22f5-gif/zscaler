...
Source: https://help.zscaler.com/zia/about-application-information
PDF: https://help.zscaler.com/pdf/com/en/1451681.pdf

The Application Information page shows you information on the specific application you selected to view on the [Shadow IT Report](/zia/shadow-it-report) page.
...
On the Application Information page (Analytics > SaaS Security > Applications > any application on the Shadow IT Report page), you can do the following:
...
- Print a PDF version of this page or view the logs for the application; you are redirected to the [Web Insights](/zia/about-insights) page.
...
- **Policies Applied**: All the policies that are configured specifically for the application in the ZIA Admin Portal. The field stays blank if you haven't configured any policies for the application.
- **Tags**: The [tags assigned to the application](/zia/adding-cloud-application-tag). You can add or remove tags for the application by clicking the **Edit** icon.
...
The Risk Attributes and 3rd-Party Integrations information is unavailable for [custom cloud applications](/zia/adding-custom-cloud-applications).
...
[]On the 3rd-Party Integrations tab, you can view the following data populated by [3rd-Party App Governance](/zia/what-3rd-party-app-governance). The application must have at least one integration (Risk Attributes > Basic Information) for data to be populated.
...
- **View More**: To view more information in the 3rd-Party App Governance Admin Portal, you must be a ZIA super admin and your organization must be subscribed to 3rd-Party App Governance. If your organization is not subscribed, you instead see links to upgrade your license.
...
- **Data Residency Vendors**: If applicable, this field shows the vendors (e.g., AWS) that host the application's data. Data in this field is populated by [3rd-Party App Governance](/zia/what-3rd-party-app-governance).
