...
PDF: https://help.zscaler.com/pdf/com/en/1404791.pdf

A NAT64 prefix is used in the algorithmic translation of a synthetic IPv6 address to an IPv4 address. The Zscaler service provides a default NAT64 prefix, supports the well-known prefix (64:ff9b::/96), and also allows you to add your network-specific prefixes to the ZIA Admin Portal. During the NAT64 mechanism, these prefixes are used to match against the destination address prefix in the inbound IPv6 packets and derive an IPv4 address for the destination server. The extracted IPv4 address is then used to establish an IPv4 connection with the destination server from the Zscaler service. To learn more, see [Understanding IPv6 Support](/zia/understanding-ipv6-support).
...
On the NAT64 Prefixes page (Administration > IPv6 Configuration), you can:
- [Configure a NAT64 prefix. ](/zia/configuring-ipv6-settings#configure-nat64-prefix)
...
- [Edit or delete a NAT64 prefix. ](/zia/editing-deleting-duplicating-items)
- [Modify the table and its columns.](/zia/how-do-i-use-tables-admin-portal)
- Search for a NAT64 prefix.
- Go to the [DNS64 prefix](/zia/about-dns64-prefix) page.
