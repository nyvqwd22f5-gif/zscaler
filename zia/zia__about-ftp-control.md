...
PDF: https://help.zscaler.com/pdf/com/en/1398756.pdf

[Watch a video about FTP Control](https://fast.wistia.net/embed/iframe/vf77fis4i2?quality=1080p)
...
- If you have [Malware Protection](/zia/about-malware-protection), you can scan FTP over HTTP traffic and native FTP traffic in real time. To learn more, see [Configuring the FTP Control Policy](/zia/configuring-ftp-control-policy).
- If you have [Data Loss Prevention (DLP)](/zia/configuring-policy-using-zscaler-dlp-engines#protocols), [Sandbox](/zia/how-do-i-add-rules-sandbox-policy#protocols), [File Type Control](/zia/how-do-i-configure-file-type-control-policy#protocols), [URL Filtering](/zia/how-do-i-configure-url-filtering-policy#protocols), and [Bandwidth Control](/zia/how-do-i-add-rules-bandwidth-control-policy#protocols), you can configure those policies based on protocols (e.g., FTP over HTTP and native FTP).
- Complete FTP logging in [Firewall Insights](/zia/about-insights).
...
On the FTP Control page, you can do the following:
- [Configure the FTP Control Policy](/zia/configuring-ftp-control-policy)
- [View the Recommended Policy](/zia/what-recommended-ftp-control-policy)
