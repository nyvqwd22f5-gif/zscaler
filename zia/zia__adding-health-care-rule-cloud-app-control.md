...
PDF: https://help.zscaler.com/pdf/com/en/1402146.pdf
...
-
Click **Add** and select **Health Care**.
The **Add** **Health Care Rule **window appears.
- In the **Add** **Health Care Rule **window, enter the **Cloud App Control Rule** attributes:
...
By default, this field displays the first 100 cloud applications. The subsequent 100 cloud applications are displayed when you slect **Click to see more** at the bottom of the list. You can repeat this process to view the remaining cloud applications.
...
[]![ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-health-care-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Healthcare-Click-See-More.png)
