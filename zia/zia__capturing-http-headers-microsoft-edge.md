...
PDF: https://help.zscaler.com/pdf/com/en/1504371.pdf
...
To capture headers in Microsoft Edge:
...
-
When the test is completed, right-click on one transaction and select **Save all as HAR with content**.
[See image.](#chrome-save)
- Click **Save **on the dialog box that appears to download the file.
-
...
[]![Go to Developer Tools by clicking More tools and then Developer tools](/downloads/tech-pubs-drafts/zia-draft-articles/capturing-http-headers-microsoft-edge-draft/Mircrosoft%20Edge%201_0.png)
[]![Ensure Record, Disable Cache, and Preserve log are selected](/downloads/tech-pubs-drafts/zia-draft-articles/capturing-http-headers-google-chrome-draft/Microsoft%201.png)
[]![Save all as HAR with content](/downloads/tech-pubs-drafts/zia-draft-articles/capturing-http-headers-microsoft-edge-draft/Microsoft%20Edge%203.png)
[]![Click Console and then click on Save as](/downloads/tech-pubs-drafts/zia-draft-articles/capturing-http-headers-google-chrome-draft/Microsoft%202.png)
Exporting HTTP Headers with Sensitive Data
The latest versions of Microsoft Edge do not include sensitive data by default when the **Export** or **Save **option is selected.
...
[See Image.](#copy-data)
- Send the saved file to Zscaler Support.
[]![Click the Settings icon and go to Preferences](/downloads/zia/troubleshooting/capturing-http-headers-microsoft-edge/settings%20prefs.png)
[]![make sure that Preserve logs and Disable cache is selected](/downloads/zia/troubleshooting/capturing-http-headers-microsoft-edge/Preserve%20logs.png)
...
[]![Click and hold the download button to export HAR with sensitive data](/downloads/zia/troubleshooting/capturing-http-headers-microsoft-edge/Export%20HAR.png)
[]![Right click an entry and click Copy and then copy all as HAR](/downloads/tech-pubs-drafts/zia-draft-articles/capturing-http-headers-google-chrome-doc-54588/Copy%20sensitive%20data.png)