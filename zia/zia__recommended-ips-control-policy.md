...
PDF: https://help.zscaler.com/pdf/com/en/1400961.pdf

You can configure the following recommended [IPS Control](/zia/about-ips-control) policy in the ZIA Admin Portal to leverage Zscaler's Intrustion Prevention System (IPS):
...
To learn more about how to configure this rule, see [Configuring IPS Control Policy](/zia/configuring-ips-control-policy).
