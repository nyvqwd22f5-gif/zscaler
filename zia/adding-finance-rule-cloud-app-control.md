...
PDF: https://help.zscaler.com/pdf/com/en/1402141.pdf
...
Adding a Rule for Finance Apps
To add a rule for Finance apps:
- Go to **Policy **> **URL & Cloud App Control **> **Cloud App Control Policy**.
-
Click **Add** and select **Finance**.
The **Add Finance Rule** window appears.
- In the **Add Finance Rule** window, enter the **Cloud App Control Rule** attributes:
...
[]![ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-finance-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Finance-Click-See-More.png)
