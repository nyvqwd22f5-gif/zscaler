# About Global Public Service Edges
Source: https://help.zscaler.com/zia/about-global-public-service-edges
PDF: https://help.zscaler.com/pdf/com/en/1400866.pdf

Zscaler has configured several Global, or Ghost, ZIA Public Service Edges across its clouds. These Public Service Edge addresses do not listen for traffic but are dummy addresses that every Public Service Edge knows about. They can be useful when working in no default route environments. To learn more, see [Implementing Zscaler in No Default Route Environments](/zia/implementing-zscaler-no-default-route-environments).
