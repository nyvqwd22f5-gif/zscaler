...
Source: https://help.zscaler.com/zia/adding-dlp-resources
PDF: https://help.zscaler.com/pdf/com/en/1463246.pdf

[]Adding Data Loss Prevention (DLP) resources is the first step you complete when [configuring Endpoint Data Loss Prevention (DLP) policy rules](/zia/configuring-endpoint-dlp-policy-rules). The Zscaler service supports the following DLP resources:
- Network shares
- Printers
...
- Click **Add a Removable Storage** device. The **Add Removable Storage Device** window is displayed.
...
- Enter your removable storage devices in the CSV file tempate in the following format:
