...
PDF: https://help.zscaler.com/pdf/com/en/1400536.pdf
...
[]Your company's risk score, computed based on different types of risky events. To gain more insights about your most infectious users and locations, log in to the ZIA Admin Portal. To learn more, see [Company Risk Score Report](/zia/company-risk-score-report).
...
[]The most advanced threats blocked by Zscaler can't be detected by firewall, proxy, or anti-virus solutions. Zscaler blocks botnet calls from reaching your command and control centers. Cyber criminals trick your employees into clicking on malicious links to infect their devices and transforming them into botnets. To drill down further into this data, log in to the ZIA Admin Portal.
