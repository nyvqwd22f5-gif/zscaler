...
PDF: https://help.zscaler.com/pdf/com/en/1400381.pdf

When [configuring](/zia/configuring-sandbox-policy) the Sandbox policy, you can choose the action the Sandbox takes when users download a file. Depending on the following action you choose, your users may see a particular end user notification (EUN).
- [Allow](#sandbox-allow-notification)
- [Quarantine](#sandbox-quarantine-notification)
- [Block](#sandbox-block-notification)
To learn about the recommended Sandbox actions, see [Recommended Sandbox Policy](/zia/recommended-sandbox-policy).
...
**
You can customize this quarantine notification on the End User Notifications page. To learn more, see [Configuring the Quarantine Notification](/zia/configuring-quarantine-notification).
...
**
You can customize this block notification on the End User Notifications page under Security Violation Notifications. To learn more, see [Configuring Block Notifications](/zia/configuring-block-notifications).