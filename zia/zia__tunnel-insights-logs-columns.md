...
Source: https://help.zscaler.com/zia/tunnel-insights-logs-columns
PDF: https://help.zscaler.com/pdf/com/en/1401061.pdf

You can customize your tunnel logs using the columns. To learn more about logs, see [About Insights Logs](/zia/about-insights-logs).
...
- **Location**: The [location](/zia/about-locations) associated with the tunnel.
...
- QuickSec
- SonicWall
- **VPN Credential**: The [VPN credential](/zia/about-vpn-credentials) associated with the IPSec VPN tunnel.