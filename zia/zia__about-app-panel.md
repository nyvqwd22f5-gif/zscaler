# About the App Panel
Source: https://help.zscaler.com/zia/about-app-panel
PDF: https://help.zscaler.com/pdf/com/en/1450491.pdf
...
- View or change the app's **Risk Score**. Hover over the risk score to view a breakdown of the score. To learn more about the risk score and how to update it, see [Updating the App Risk Score](/zia/updating-app-risk-score). Refer to the following table for the components used to calculate each app's risk score.
- View or change the app's **Classification**. To learn more, see [Classifying Apps](/zia/classifying-apps).
- View or change the app's **Automated Workflow** (e.g., [End User Review](/zia/configuring-end-user-review) or [Revoked/Banned](/zia/revoking-banning-apps)) if supported by the platform.
- Add the app to your inventory. The App Panel header appears in blue if the app is not currently in your inventory. To learn more, see [Add an App to Your Inventory](/zia/pre-vetting-apps#add-app-inventory).
![App Panel Header showing app info](/downloads/tech-pubs-drafts/zia-draft-articles/about-app-panel-draft-doc-57316/App_Panel_Header.png)
...
-
View **Findings** associated with the app. You can also change the status of a finding. To learn more, see[ Updating the App Finding Status](/zia/updating-app-finding-status).
![App Panel Overview tab displaying an overview of the app](/downloads/tech-pubs-drafts/zia-draft-articles/about-app-panel-draft-doc-57316/Overview_Tab.png)
...
![App Panel Access tab showing app access and permission info](/downloads/tech-pubs-drafts/zia-draft-articles/about-app-panel-draft-doc-57316/Access_Tab.png)
...
![App Panel Activities tab showing user activity](/downloads/tech-pubs-drafts/zia-draft-articles/about-app-panel-draft-doc-57316/Activities_Tab.png)
...
![App Panel Details tab showing the list of app info](/downloads/tech-pubs-drafts/zia-draft-articles/about-app-panel-draft-doc-57316/Details_Tab.png)
...
You must have user or admin permissions to add notes to the app. To learn more, see [About Roles in 3rd-Party App Governance](/zia/about-roles-3rd-party-app-governance).
