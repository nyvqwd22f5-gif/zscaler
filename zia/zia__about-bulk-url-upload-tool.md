...
Source: https://help.zscaler.com/zia/about-bulk-url-upload-tool
PDF: https://help.zscaler.com/pdf/com/en/1401656.pdf
...
- Download the [UrlUpload.gz](/downloads/zia/policies/url-filtering/about-url-upload-tool/UrlUpload-06-05-2025.gz) file.
...
- An API config file, which contains the `BASE_URI`, `API_KEY`, `USERNAME` (Optional), `UPLOAD_CSV_FILE` (Optional). To learn more, see [API Getting Started](/zia/api-getting-started).
