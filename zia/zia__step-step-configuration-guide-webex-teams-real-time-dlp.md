...
Source: https://help.zscaler.com/zia/step-step-configuration-guide-webex-teams-real-time-dlp
PDF: https://help.zscaler.com/pdf/com/en/1518511.pdf
...
[]Ensure that Zscaler Internet Access (ZIA) is fully configured for your organization. To learn more, see [Step-by-Step Configuration Guide for ZIA](/zia/step-step-configuration-guide-zia).
[]Ensure that your company details are set up in your Company Profile. To learn more, see [About the Company Profile](/zia/about-company-profile).
...
To learn more, see [Configuring DLP Policy Rules with Content Inspections](/zia/configuring-dlp-policy-rules-content-inspection) and [Configuring the Data at Rest Scanning DLP Policy](/zia/configuring-data-rest-scanning-dlp-policy).
...
To learn more, see [About SaaS Security Scan Configuration](/zia/about-saas-security-scan-configuration).
...
To learn more, see [About Insights Logs](/zia/about-insights-logs) and [About SaaS Security Insights Logs](/zia/saas-security-insights-logs).