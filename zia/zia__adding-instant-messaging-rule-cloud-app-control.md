...
PDF: https://help.zscaler.com/pdf/com/en/1400156.pdf
...
You can completely block or selectively disable IM applications. Client-based IMs, such as Trillian, as well as web IMs, such as Google Chat and Zendesk Chat, are supported. Admins can completely block the IM or just block file transfers. IM file transfers are scanned for viruses and for DLP (if the respective policies are set).
...
-
Click **Add** and select **Instant Messaging**.
The **Add Instant Messaging Rule** window appears.
- In the **Add Instant Messaging Rule** window, enter the **Cloud App Control Rule** attributes:
...
-
Specify the **Action** by choosing one of the following options for **Chatting** and **File Transfers**:
...
[]![ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-instant-messaging-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Instant-Messaging-Click-See-More.png)
