...
- [Admin accounts created for your organization's admins](/zia/adding-admins)
...
[1. Add the Zscaler Internet Access Administrator application in the Microsoft Entra admin center.](#adding-zia-admin-application)
[2. Configure SAML Admin SSO in the Microsoft Entra admin center.](#configure-saml-admin-azure)
[3. Assign admins to the ZIA Admin application ](#assigning-admins-zia-admin-app)[in the Microsoft Entra admin center](#configure-saml-admin-azure)[.](#assigning-admins-zia-admin-app)
[4. (Optional) Enable IdP-Initiated SSO ](#application-visibility)[in the Microsoft Entra admin center](#configure-saml-admin-azure)[.](#application-visibility)
[5. Configure SAML Admin SSO in the ZIA Admin Portal.](/zia/configuring-saml-admins#configuring-saml-admins)
...
-
In **SAML Signing Certificate**, download **Certificate (base64)**. You need it for Step 3 in [5. Configure SAML Admin SSO in the ZIA Admin Portal](/zia/configuring-saml-admins#configuring-saml-admins).
...
[]If you've disabled application visibility in Step 2 of [4. (Optional) Enable IdP-Initiated SSO](#application-visibility), you can use this method to directly access the ZIA Admin application from the browser.
