...
PDF: https://help.zscaler.com/pdf/com/en/1403116.pdf

[Watch a video about Security & UEBA Alerts including configuration](https://fast.wistia.net/embed/iframe/xg2ozazz6z)
Webhook configuration in the ZIA Admin Portal allows you to deliver alerts for the configured events in the alert rule to third-party applications (e.g., ServiceNow, Splunk, etc.) for incident management. The feature comprises two parts:
- Creating a webhook
- Associating the webhook with the alert rules
To add a webhook:
- Go to **Alerts** > **Webhooks**.
- Click **Add Webhook**.
