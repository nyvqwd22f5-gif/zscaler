...
PDF: https://help.zscaler.com/pdf/com/en/1463231.pdf
...
The Zscaler DLP engines support files up to 100 MB. The maximum size also applies to files extracted from archive files.
...
- [2. Configure DLP notification templates](/zia/how-do-i-configure-dlp-notifications) if you want to send email notifications to your organization's auditor when your users' activities violate Endpoint DLP policy rules.
...
- [6. (Optional) Define exception rules.](#ExceptionRules)
[]
- Go to **Policy** > **Endpoint Data Loss Prevention**.
- Click **Add DLP Rule**.
...
- **Rule Label**: Select a rule label to associate it with the rule. To learn more, see [About Rule Label](/zia/about-rule-labels).
...
- **Groups**:** **You can specify how the Endpoint DLP rule applies to your [groups](/zia/about-groups). Select **Any** to apply the rules to all groups or select up to 32 groups. You can also search for groups.
-
**Users**: You can specify how the Endpoint DLP rule applies to your [users](/zia/about-users). Select **Any** to apply the rules to all users or select up to 32 users. You can also search for users.
...
- **Departments**:** **You can specify how the DLP rule applies to your [departments](/zia/about-departments). Select **Any** to apply the rules to all departments or select up to 32 departments. You can also search for departments.
...
- **Device Trust Level**: Select the necessary device trust levels (**High Trust**, **Medium Trust**, **Low Trust**, or **Unknown**). The trust levels assigned to the devices are based on your [posture configurations](/client-connector/adding-zia-posture-profiles) in the Zscaler Client Connector Portal. You can also search for device trust levels.
...
To learn about configuring custom messages for the **Allow**, **Block**, and **Protect** actions, see [Configuring EUNs for Endpoint DLP](/zia/configuring-euns-endpoint-dlp). To learn about configuring custom messages for the **Confirm** action, see [Configuring User Confirmation Notification Templates](/zia/configuring-user-confirmation-notification-templates).
...
To learn more, see [Adding DLP Resources](/zia/adding-dlp-resources).
...
- **Groups**:** **You can specify how the Endpoint DLP exception rule applies to your [groups](/zia/about-groups). Select **Any** to apply the rules to all groups or select up to 32 groups. You can also search for groups.
-
**Users**: You can specify how the Endpoint DLP rule applies to your [users](/zia/about-users). Select **Any** to apply the rules to all users or select up to 32 users. You can also search for users.
Contact Zscaler Support to increase the limit of **Users**, **Groups**, or **Departments**.
...
- **Departments**:** **You can specify how the DLP exception rule applies to your [departments](/zia/about-departments). Select **Any** to apply the rules to all departments or select up to 32 departments. You can also search for departments.
...
[]![An endpoint rule using predefined Zscaler DLP engines](/downloads/zia/policies/configuring-endpoint-dlp-policy-rules/ZIA-Example-Endpoint-DLP-Policy-parent-rule_MVP2_C2C.png)
[]![An endpoint exception rule using predefined Zscaler DLP engines](/downloads/zia/policies/configuring-endpoint-dlp-policy-rules/ZIA-Example-Endpoint-DLP-Policy-exception-rule_5.1_C2C.png)