...
PDF: https://help.zscaler.com/pdf/com/en/1517436.pdf

The [HTTP header insertion profile](/zia/about-http-header-insertion-profile) allows you to add custom HTTP request headers and modify existing HTTP request headers. It consists of two parts: adding HTTP header insertion profiles and associating them to a URL Filtering policy rule.
To add an HTTP header insertion profile:
- Go to **Administration** > **HTTP Header Control **> **HTTP Header Insertion Profile**.
-
