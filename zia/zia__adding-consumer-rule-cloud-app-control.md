...
PDF: https://help.zscaler.com/pdf/com/en/1400141.pdf
...
Adding a Rule for Consumer Apps
To add a rule for Consumer apps:
- Go to **Policy** > **URL & Cloud App Control** > **Cloud App Control Policy**.
-
Click **Add** and select **Consumer**.
The **Add Consumer Rule** window appears.
- In the **Add Consumer Rule** window, enter the **Cloud App Control Rule** attributes:
...
[]![ZIA Add Cloud Application Rule with Click to See More in the Cloud Applications Field](/downloads/zia/documentation-knowledgebase/policies/cloud-apps/cloud-app-control-policies/adding-consumer-rule-cloud-app-control/ZIA-Add-Cloud-App-Control-Rule-Consumer-Click-See-More.png)
