...
Source: https://help.zscaler.com/itdr/viewing-details-pane
PDF: https://help.zscaler.com/pdf/com/en/1531837.pdf
...
Click **View Extended Details** to view the in-depth analysis of attack activities carried out against the selected deception object. To learn more, see [Viewing Extended Details](/itdr/viewing-extended-details).
![Endpoint View Extended Details](/downloads/itdr/investigate/viewing-details-pane/endpoint%201.png)
...
When events are discovered, you can[ take immediate actions](/itdr/taking-action-dashboard). Click **Actions** to contain, block, or delete threats. You can also mark an attack as safe.
Click **View Extended Details** to view the in-depth analysis of the attacker’s activity. To learn more, see [Viewing Extended Details](/itdr/viewing-extended-details).
![Attacker Details Pane](/downloads/itdr/investigate/viewing-details-pane/Attacker.png)