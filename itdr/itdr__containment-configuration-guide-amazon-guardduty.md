...
Source: https://help.zscaler.com/itdr/containment-configuration-guide-amazon-guardduty
PDF: https://help.zscaler.com/pdf/com/en/1531870.pdf

This configuration guide provides information on prerequisites and how to integrate Zscaler ITDR with Amazon GuardDuty to contain and isolate detected attackers.
With this integration, ITDR strengthens cloud security by automatically preventing known attacker IP addresses from accessing AWS resources. When ITDR detects malicious activity, it sends the source IP address to the Amazon GuardDuty threat list. Amazon GuardDuty then uses this information to block or flag any traffic originating from these IP addresses, helping to reduce the risk of compromise and enhance threat response across your AWS environment.
Prerequisites
...
- [Step 1: Configure the Containment Integration Between ITDR and Amazon GuardDuty](#containment-integration)
- [Step 2: Configure Orchestration Rule or Manually to Contain Detected Attackers](#orchestration-and-manual-containment)
...
Ensure that you copy Detector IDs for all accounts and regions must be protected from malicious IP addresses.
- In Zscaler ITDR Admin Portal, go to **Orchestrate **> **Containment**.
-
In the table, locate **AWS Guard Duty (Attacker IPs) **and click the **Edit** icon.
[See image.](#edit-icon-aws-guard-duty)
- In the **AWS Guard Duty (Attacker IPs) **configuration window:
...
-
Click **Contain with AWS Guard Duty**.
[See image.](#contian-with-guard-duty-option)
-
In the **Contain with AWS Guard Duty** window, select the AWS account name from the **Name **drop-down menu, and click **Contain**.
...
[]![A list of containment integrations with the Amazon GuardDuty highlighted](/downloads/itdr/orchestrate/containment-integrations/containment-configuration-guide-amazon-guardduty/deception-containment-list-aws-guardduty.png)
[]![Configuration window of Amazon GuardDuty Integration](/downloads/itdr/orchestrate/containment-integrations/containment-configuration-guide-amazon-guardduty/deception-aws-guardduty-details.png)
[]![Amazon GuardDuty Configuration Window with the option to list commands highlighted](/downloads/itdr/orchestrate/containment-integrations/containment-configuration-guide-amazon-guardduty/deception-aws-guardduty-details-show-commands.png)
...
[]![Response section configuration for Amazon GuardDuty in Rule Details window](/downloads/itdr/orchestrate/containment-integrations/containment-configuration-guide-amazon-guardduty/deception-rule-aws-guard-duty.png)
...
[]![Option to contain with Amazon GuardDuty highlighted on the Investigate page](/downloads/itdr/orchestrate/containment-integrations/containment-configuration-guide-amazon-guardduty/deception-contian-with-guardduty-option.png)
[]![Containment window for Amazon GuardDuty](/downloads/itdr/orchestrate/containment-integrations/containment-configuration-guide-amazon-guardduty/deception-manual-containment-guardduty.png)