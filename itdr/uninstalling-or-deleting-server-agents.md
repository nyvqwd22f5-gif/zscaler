...
Source: https://help.zscaler.com/itdr/uninstalling-or-deleting-server-agents
PDF: https://help.zscaler.com/pdf/com/en/1531864.pdf

This article provides instructions for uninstalling or deleting server agents.
Uninstalling Server Agents
You can uninstall a single agent, multiple agents, or all server agents from the ITDR Admin Portal.
...
- When you delete a server agent, its entry is removed from the ITDR Admin Portal only. The agent is not uninstalled from the server.
...
[]![Uninstall a server agent](/downloads/itdr/settings/server-agents-settings/agents/uninstalling-or-deleting-server-agents/itdr-server-agent-uninstall-agent-window.png)
...
[]![View server agents deleting confirmation window](/downloads/itdr/settings/server-agents-settings/agents/uninstalling-or-deleting-server-agents/itdr-delete-server-agent.png)
