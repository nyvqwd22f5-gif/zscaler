...
Source: https://help.zscaler.com/itdr/installing-server-agent
PDF: https://help.zscaler.com/pdf/com/en/1531859.pdf
...
- [Download the Windows EXE installer](/itdr/downloading-server-agent) file from the ITDR Admin Portal.
...
| `/CMC=<instance name>` | The hostname of the ITDR Admin Portal | Yes |
...
After you run the command, the server agent is installed on a domain controller and appears in the [Agents](/itdr/about-server-agent) table (Settings > Server Agents Settings > Agents).
The domain you selected to install a server agent appears in the [Domains](/itdr/about-server-agent-domains) table (Settings > Server Agents Settings > Domains).
Configuring Proxies
