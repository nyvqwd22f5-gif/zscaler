...
Source: https://help.zscaler.com/itdr/siem-configuration-guide-microsoft-sentinel
PDF: https://help.zscaler.com/pdf/com/en/1531726.pdf
...
- Create a log analytics workspace on Sentinel. To learn more, refer to the [Microsoft documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/quick-create-workspace?tabs=azure-portal).
...
- [Step 1: Obtain the Log Analytics Workspace ID and Primary Key from the Microsoft Azure Portal](#itdr-obtain-ws-id-primary-key)
- [Step 2: Forward Logs to Sentinel](#itdr-forward-logs-to-azure-sentinel-siem-integration)
...
[See image.](#itdr-azure-sentinel-copy-ws-id)
...
[See image.](#itdr-azure-sentinel-siem-integration-option)
-
...
- **Workspace ID**: Enter the [Workspace ID](#itdr-obtain-ws-id-primary-key) you copied from Sentinel.
- **Primary Key**: Enter the [Primary key](#itdr-obtain-ws-id-primary-key) you copied from Sentinel.
...
[See image.](#itdr-config-azure-sentinel-siem-integration-details)
-
Click **Save**.
...
[]![Sentinel SIEM integration option](/downloads/itdr/orchestrate/siem-integrations/siem-configuration-guide-microsoft-sentinel/itdr-sentinal-integration-option.png)
[]![Sentinel SIEM integration details](/downloads/itdr/orchestrate/siem-integrations/siem-configuration-guide-microsoft-sentinel/itdr-sentinal-integration-details.png)