...
Source: https://help.zscaler.com/unified/session-insights-logs-columns
PDF: https://help.zscaler.com/pdf/com/en/1516876.pdf

You can customize your Session logs by using column fields. To learn more about logs, see [About Insights Logs](/unified/about-insights-logs-0).
...
- **Connector Instance**: The specific Zscaler software instance from which you want to view the session logs.
- **Connector VM**: The Cloud Connector or Branch Connector virtual machine.
...
- **Connector Group**: The name of the Cloud Connector or Branch Connector group.
- **Connector Source IP**: The Cloud Connector or Branch Connector source IP address.
- **Connector Source Port**: The source port of the Cloud Connector or Branch Connector that is used to connect to the forwarding gateway.
