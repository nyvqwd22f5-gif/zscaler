...
Source: https://help.zscaler.com/cloud-branch-connector/storing-your-secret-credentials-hashicorp-vault
PDF: https://help.zscaler.com/pdf/com/en/1519691.pdf
...
- Enter `api_key`. For the corresponding value, enter the value you copied from the [API Key Management](/cloud-branch-connector/about-api-key-management) page on the Cloud & Branch Connector Admin Portal.
...
max_jwt_exp="60m"`
where `bound_service_accounts` is the email address associated with the [VM service account](/cloud-branch-connector/deploying-zscaler-cloud-connector-google-cloud-platform#VMServiceAcct) you created previously.
For example:
...
- [Service Account email from Vault service account details](/cloud-branch-connector/deploying-zscaler-cloud-connector-google-cloud-platform#VMServiceAcct). You must have access to the service account to see this information.
[]![Selecting admin as the namespace](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/VaultNamespace.png)
[]![Creating secrets for KV Secrets Engine](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/VaultEnableKVSecretsEngine_1.png)
[]![Creating secrets for KV Secrets Engine](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/kv_create_secrets_1.png)
[]![Creating a secret for KV Secrets Engine](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/HCPCreateSecretPage_1.png)
[]![Creating service account for Vault to authenticate with GCP](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/GCPCreateServiceAccount_1.png)
[]![Selecting Service Account Key Admin role](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/CreateGCP_HCP_ServiceAccount2.png)
[]![Create private key in Google Cloud Platform](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/GCPAddPrivateKey_1.png)
[]![Enabling the Google Cloud secrets engine](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/VaultEnableGCPSecretsEngine_1.png)
[]![Selecting JSON file for Vault to communicate with Google Cloud](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/VaultSelectAuthFile_1.png)
[]![Copying the cluster URL](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/HCPclusterURL_1.png)
[]![Finding the API path](/downloads/cloud-branch-connector/deployment-management/cloud-connector-deployment-management/storing-your-secret-credentials-hashicorp-vault/HCPapiPath_1.png)