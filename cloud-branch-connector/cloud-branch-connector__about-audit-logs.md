...
On the Audit Logs page (Administration > Audit Logs), you can do the following:
- View a list of admin logins:
- **Timestamp**: The local time of the admin's last login or last logout.
- **Actions**:** **The action performed by the admin in the Cloud & Branch Connector Admin Portal or API.
