...
Source: https://help.zscaler.com/unified/adding-cloud-nss-feeds-metrics-logs
PDF: https://help.zscaler.com/pdf/com/en/1519566.pdf
...
[][![Adding a Cloud NSS Feed in the Zscaler Cloud & Branch Connector Admin Portal](/downloads/cloud-branch-connector/nanolog-streaming-service/nss-feeds/adding-cloud-nss-feeds/adding-cloud-nss-feeds-metrics-logs/Add%20Cloud%20NSS%20Feed.png)
]
...
- **Resource**: Metrics that are applicable at an individual resource level. There are physical and logical resources in a Cloud or Branch Connector that all data processing instances use.
...
- **Cloud/Branch Connector Groups**:** **Use this filter to limit the logs to specific [Cloud Connector Groups ](/unified/about-cloud-connector-groups-0)or Branch Connector Groups.
- **Cloud/Branch Connector VM**: Use this filter to limit the logs to specific Cloud or Branch Connector VMs.
[See image.](#AddMetricsCloudNSSFeed)
[]![Add Cloud NSS Feed window in the Zscaler Cloud & Branch Connector Admin Portal](/downloads/cloud-branch-connector/nanolog-streaming-service/nss-feeds/adding-cloud-nss-feeds/adding-cloud-nss-feeds-metrics-logs/Add%20Metrics%20Cloud%20NSS%20Feed.png)
