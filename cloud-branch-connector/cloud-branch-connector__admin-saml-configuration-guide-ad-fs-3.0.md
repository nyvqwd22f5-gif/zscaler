...
PDF: https://help.zscaler.com/pdf/com/en/1420896.pdf
...
- [Zscaler Admin XML Metadata](/cloud-branch-connector/configuring-saml-admins)
...
- [Step 3: Configure SAML Admin SSO in the Cloud & Branch Connector Admin Portal](/cloud-branch-connector/configuring-saml-admins)
[]
...
[See image.](#ADFS1Cii)
- [Import your XML Metadata file](/cloud-branch-connector/configuring-saml-admins), then click **Next**.
-
...
Verifying Cloud & Branch Connector Admin Portal Access via SSO
To verify the Cloud & Branch Connector Admin Portal access via SSO:
