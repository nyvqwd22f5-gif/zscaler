...
PDF: https://help.zscaler.com/pdf/com/en/1420396.pdf

Zscaler firewall has over 50 predefined services and an admin can configure up to 1,024 additional custom services. You can add, modify, or delete ports in all predefined services except ICMP_any, UDP_any, TCP_any, and OTHER. To learn more, see [Configuring Network Services](/cloud-branch-connector/configuring-network-services).
...
You can also define network service groups. To learn more, see [About Network Service Groups](/cloud-branch-connector/about-network-service-groups)[.](/zia/about-network-service-groups)
...
- [Add a network service](/cloud-branch-connector/configuring-network-services).
...
- [Edit a network service](/cloud-branch-connector/editing-deleting-or-duplicating-items).
- View a network service.
- Modify the table and its columns.
- Search for a network service.
- Filter the network services by protocol (TCP or UDP).
- Go to the [Network Service Groups](/cloud-branch-connector/about-network-service-groups) page.
