...
PDF: https://help.zscaler.com/pdf/com/en/1420671.pdf

You can customize your DNS logs by using column fields. To learn more about logs, see [About Insights Logs.](/cloud-branch-connector/about-insights-logs)
...
- **CC Instance**: The specific Zscaler software instance from which you want to view the DNS logs.
