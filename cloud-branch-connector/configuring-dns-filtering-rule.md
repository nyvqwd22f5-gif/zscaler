...
Source: https://help.zscaler.com/unified/configuring-dns-filtering-rule
PDF: https://help.zscaler.com/pdf/com/en/1516461.pdf
...
Under the **Destination** field, the application segment field is automatically set to **Any**.
...
- **Destination IPv4 Groups**: Select one or more destination IPv4 groups.
