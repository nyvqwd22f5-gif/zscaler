...
Source: https://help.zscaler.com/unified/adding-cloud-nss-feeds-event-logs
PDF: https://help.zscaler.com/pdf/com/en/1519561.pdf
...
- **Feed Output Format**: These are the fields that are displayed in the output. See [NSS Feed Output Format: Event Logs](/unified/nss-feed-output-format-event-logs-0) for information about the available fields and their syntax.
