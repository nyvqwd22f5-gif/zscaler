...
Source: https://help.zscaler.com/zidentity/importing-ip-locations-csv-file
PDF: https://help.zscaler.com/pdf/com/en/1499136.pdf

The article describes how to import IP locations using a CSV file.
To edit and import a CSV file:
- Go to **Administration** > **Environment **> **IP Locations**.
-
Click **Import CSV**.
...
- B: Enter the name of the IP location that must be displayed in the ZIdentity Admin Portal.
