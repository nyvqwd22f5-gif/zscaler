...
Source: https://help.zscaler.com/zidentity/importing-ip-location-groups-csv-file
PDF: https://help.zscaler.com/pdf/com/en/1499151.pdf

The article describes how to import IP location groups using a CSV file.
To edit and import a CSV file :
- Go to **Administration** > **Environment **> **IP Location Groups**.
- Click **Import CSV**.
