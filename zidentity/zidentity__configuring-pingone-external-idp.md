...
Source: https://help.zscaler.com/zidentity/configuring-pingone-external-idp
PDF: https://help.zscaler.com/pdf/com/en/1499331.pdf
...
- In the application drawer, select the **Configuration **tab, and do the following:
-
...
- On the **Scopes **tab, select **email **and **Profile **to include them as allowed scopes.
- Click **Save**.
...
- Paste the **OIDC Discovery Endpoint **value [copied from the PingOne admin console](#add-app-pingone) into the **Metadata URL **field and click **Fetch**.
...
- Paste the **Redirect URI** value copied from the ZIdentity Admin Portal to the **Redirect** **URIs **field.
- Click **Save**.
[See image.](#pingone-redirect-uri)
- [][In the ZIdentity Admin Portal](#zidentity-side-provisioning)
...
- Locate the IdP entry created for PingOne on the **Primary Identity Provider **(or **Secondary Identity Providers**) tab and click the **Edit **icon.
...
[See image.](#oidc-id-token-sample)
...
- In the **Edit Attribute Mappings **page:
-
Click **Add **and map the necessary attributes configured in the ZIdentity Admin Portal.
...
- Paste the **SCIM Endpoint URL **[copied from the ZIdentity Admin Portal](#provision-users-pingone) to the **SCIM Base URL** field.
- Select** OAuth 2 Bearer Token** from the **Authentication Method** drop-down menu and paste the **Bearer Token **[copied from the ZIdentity Admin Portal](#zidentity-side-provisioning) to the **Oauth Access token **field.
-
...
-
On the **Edit User Filter** page, configure the necessary conditions for user filter. For example, you can filter users based on specific Group Names.
...
- On the **Edit Group Provisioning **page:
-
...
- [c. Map authentication levels and ACR values in the ZIdentity Admin Portal](#map-als-and-acr-in-zidentity)
...
- **Policy Name**: Enter the ACR value that must be mapped to the authentication level in ZIdentity Admin Portal. For example, if you are configuring this authentication policy for email authentication, enter `Email` as the policy name.
...
[]![List of applications in PingOne with the option to add a new app highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zslogin-add-application-window.jpg)
[]
![Adding an OIDC web application in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-add-application.png)
[]
![List of configurations for an app in PingOne with the client credentials options highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-client-id-secret-pingone.png)
[]
![List of URLs in PingOne app with the Well-Known Configuration URL highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-oidc-endpoint_1.png)
[]
![List of configurations for an app in PingOne with the option to edit configurations highlighted ](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-edit-configuration_0.png)
[]
![Editing configuration for an app in PingOne with the Redirect URIs option highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-redirect-uro.png)
[]
![List of allowed scopes with the option to add scopes highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-scope-edit-pingone.png)
[]
![Selecting scopes for an app in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-add-scopes.png)
[]
![Option to activate an app in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-added-scopes.png)
[]
...
[]
![Configuring OIDC settings for an IdP in ZIdentity with some options highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-oidc-configuration-pingone%20(1).png)
[]
![Configuring JIT provisioning for an IdP in ZIdentity](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-provisioning-nogroups-full_0.png)
[]![A sample ID token with blurred sensitive information.](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-id-token-sample.png)
[]![Enabling SCIM provisioning in ZIdentity with the SCIM endpoint URL highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-scim-endpoint-url-oin-okta.png)
[]![Mapping attributes in PingOne with the option to add custom attribute mapping highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-attribute-mapping-tab-pingone_0.png)
[]![Adding attribute mapping in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-attribute-mapping-configuration.png)
[]
[]![Building and testing expressions in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-attribute-mapping.gif)
[]![Configuring SCIM provisioning in ZIdentity with the SCIM Endpoint URL highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-scim-endpoint-url-oin-okta_0.png)
[]![Configuring attributes mapping in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-all-attributes-mapped-pingone.png)
[]![Adding a new connection from the Provisioning page with the option to create a new connection highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-add-new-connection.png)
[]![Selecting the connection type in PingOne with the Identity Store type option highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-select-identity.png)
[]![Finding the SCIM Outbound connection in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/scim-search-and-select.png)
[]![Configuring basic information for a SCIM connection in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/scim-name-description.png)
[]![Configuring authentication settings in PingOne for a conenction](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-base-url-scim.png)
[]![Creating a new connecting in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-last-step-pingone.png)
[]![Configuring SCIM provisioning in PingOne with the option to enable it highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-enable-connection.png)
[]![Configuing provisioning in PingOne with the option to creare a new rule highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-new-rule-option.png)
[]![Creating a new rule for ZIdentity in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-new-rule-window.png)
[]![Configuring a target connecion in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-select-target.png)
[]![User filter in PingOne rule with the option to add a filter highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-edit-user-filter.png)
[]![Configuring user filters for a rule in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-user-filter.png)
[]![Mapping attributes for a rule in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-rule-attribute-mapping.png)
[]![Group provisioning step in PingOne with the option to add groups highlighted](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-group-provisioning.png)
[]![Selecting groups for provisioning in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidenity-adding-groups.png)
[]![Enabling a rule for group provisioning in PingOne](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zidentity-rule-enabled.png)
[]
![ZIdentity Landing page with highlighted banner at the top.](/downloads/zidentity/integration/external-idp-configuration/configuring-pingone-external-idp/zid-landing-page-1%20(1).png)
