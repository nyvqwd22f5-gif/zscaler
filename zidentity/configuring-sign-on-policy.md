...
Source: https://help.zscaler.com/zidentity/configuring-sign-on-policy
PDF: https://help.zscaler.com/pdf/com/en/1499071.pdf

The article describes how to add a sign-on policy from the [Sign-On Policy](/zidentity/about-sign-on-policies) page. You can add up to 256 policies.
Adding an Admin Sign-On Rule
To configure a sign-on rule:
- Go to **Policy **>** Admin Sign-On**.
- Click **Add Rule**.
