...
Source: https://help.zscaler.com/zidentity/configuring-authentication-levels
PDF: https://help.zscaler.com/pdf/com/en/1507491.pdf
...
-
In the ZIdentity Admin Portal, go to **Administration **> **Authentication **> **Authentication Levels**.
...
[]![Authentication Levels Page](https://help.zscaler.com/downloads/zidentity/authentication/configuring-authentication-levels/zidentity-rn-step-up-authentication.png)
After configuring authentication levels, you need to create access policies in the [supported Zscaler services](/zidentity/understanding-step-authentication).
If you have configured external IdP for authentication via OIDC, you need to map the authentication levels to their respective `acr` values in the IdP. To learn more about external IdPs, see [About External Identity Providers](/zidentity/about-external-identity-providers).