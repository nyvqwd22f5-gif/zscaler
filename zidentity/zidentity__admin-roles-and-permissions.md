...
Source: https://help.zscaler.com/zidentity/admin-roles-and-permissions
PDF: https://help.zscaler.com/pdf/com/en/1499426.pdf
...
-
-
[](/zia/accessing-and-using-executive-insights-app)
-
-
-
-
...
| Users and Groups | Full | View users and user groups.Add, edit, delete, activate, deactivate user.Add, edit, delete group.Import group details from a CSV file.Change group name, assign users to group.Add, edit, delete attribute.Submit Zscaler Support ticket from within Experience Center. |
|  | View Only | View users, user groups, user attributes, and group attributes.Submit Zscaler Support ticket from within Experience Center. |
...
| IP Locations & Groups | Full | View IP locations and location groups.Add location and location groups, import IP locations and location group details from a CSV file.Edit, delete IP locations and IP location groups.Change all configuration per IP location and IP location groups. |
