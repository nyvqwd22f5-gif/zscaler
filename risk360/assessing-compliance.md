...
PDF: https://help.zscaler.com/pdf/com/en/1533795.pdf
...
- **TTP to Risk360 Factor Mapping**: Maps all the attack sub-techniques to the [Risk360 Factors](/unified/viewing-risk-factors) and shows the status of each sub-technique.
...
- **Related Risk360 Factors**: The [Risk360 Factors](/unified/viewing-risk-factors) that are related to the attack.
