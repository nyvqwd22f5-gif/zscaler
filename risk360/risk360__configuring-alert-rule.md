...
PDF: https://help.zscaler.com/pdf/com/en/1483201.pdf
...
- **Webhooks**: Select from the existing configured webhooks or configure a new webhook by clicking **Configure Webhooks** to receive alerts via webhooks. To learn more, see [Configuring Webhooks](/risk360/configuring-webhooks).
- **Email Recipient**: Enter the email address to which you want the alerts to be sent. To learn more about the information sent, see [Understanding the Alert Email](/risk360/understanding-alert-email).
