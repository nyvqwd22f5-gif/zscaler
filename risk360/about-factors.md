...
PDF: https://help.zscaler.com/pdf/com/en/1452786.pdf

The Factors page shows the list of contributing factors that are affecting your organization's risk score. The Risk360 service quantifies each factor according to its risk weight, which then adds to your overall organization risk score and also maps these factors to various renowned risk and security frameworks like MITRE, NIST, etc. The services also supports integration with other vendors like [CrowdStrike](/risk360/crowdstrike-integration-risk360-factors) to gather data for risky events and activities and represent them into Risk360 Factors to provide a holistic risk management experience.
...
On the Factors page, from the top right, you can select how you want to view the page. Based on your selection, the page updates to the following views:
...
Compliance
On the Compliance tab, you can view a list of recognized cybersecurity frameworks and their control IDs mapped to the factor. Click on the control ID; you're redirected to the framework's website where the control IDs are explained in detail. To learn more, see [Analyzing Risk With MITRE ATT&CK](/risk360/analyzing-risk-mitre-attack) and [Analyzing Risk With NIST CSF.](/risk360/analyzing-risk-mitre-attack)
