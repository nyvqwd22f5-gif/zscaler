...
PDF: https://help.zscaler.com/pdf/com/en/1349801.pdf
...
[]To exclude these ranges, you must add them to the **Destination Exclusions** list in the app profile you created for testing. To learn more, see [VPN Gateway Bypasses](/zscaler-client-connector/best-practices-adding-bypasses-z-tunnel-2.0#vpn-gateway-bypasses).
To learn more about app profiles, see [Configuring Zscaler Client Connector Profiles](/zscaler-client-connector/configuring-zscaler-app-profiles).
