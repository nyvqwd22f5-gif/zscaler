# Deploying ZDX with Jamf Pro for iOS
Source: https://help.zscaler.com/zscaler-client-connector/deploying-zdx-jamf-pro-ios
PDF: https://help.zscaler.com/pdf/com/en/1507961.pdf
...
With Jamf Pro, you can configure and deploy Zscaler Digital Experience (ZDX) for iOS devices. Before following this guide, ensure that Zscaler Client Connector is installed on your device. To learn more, see [Deploying Zscaler Client Connector with Jamf Pro for iOS](/zscaler-client-connector/deploying-zscaler-client-connector-jamf-pro-ios).
This deployment guide applies to devices running iOS version 16 and later. To learn more, see [Supported Versions & Feature Compatibility](/zdx/supported-versions-feature-compatibility).
- [Create and Push ZDX Per App Content Filter Configuration Profile from Jamf Pro](#content-filter-section)
- [Create and Push Associated App from Jamf Pro](#associated-per-app)
[]To create and push ZDX Per App content filter configuration profile from Jamf Pro, follow these steps:
