...
PDF: https://help.zscaler.com/pdf/com/en/1532880.pdf

You can add a list of host and remote IP addresses, ports, and protocols to use for inbound and outbound firewall rules when adding a ruleset to manage endpoint firewall rules to use with location-based policies. To learn more, see [About Location-Based Policies](/zscaler-client-connector/about-location-based-policies).
...
- Click **Save**.
You can enter a maximum of 300 firewall IP lists. After you create a list, you can select it in [inbound](/zscaler-client-connector/adding-ruleset#inbound-rule) and [outbound](/zscaler-client-connector/adding-ruleset#outbound-rule) firewall rules when adding a ruleset.
