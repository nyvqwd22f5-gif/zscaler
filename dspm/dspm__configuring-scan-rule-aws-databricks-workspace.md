...
PDF: https://help.zscaler.com/pdf/com/en/1532749.pdf

You can configure the scan rule to scan AWS Databricks workspace or accounts. DSPM scans these resources for any sensitive data and vulnerabilities and displays the scan results on the [Resource Inventory page](/dspm/about-resource-inventory).
Prerequisites
Before configuring the scan rule, you need to configure the Databricks workspace or accounts. To learn more, see [About Service Registration](/dspm/about-service-registration).
Configuring Scan Rule
To configure a scan rule for Databricks workspace or accounts:
...
- Click **Next**.
-
[]On the **Scan Type** page, select **Data Sampling Scan** to scan a sample of recent data in the workspace or accounts.
DSPM cannot detect files that are deleted from the Databricks workspace or accounts.
...
Select the local timezone for the scan schedule. The scan schedule is displayed in the local timezone.
- Click **Next**.
-
...
- Click **Next**.
[]![The scan type selection page with Data Sampling option selected.](/downloads/dspm/scan-rules/scan-rules-aws/configuring-scan-rule-aws-databricks-workspace/ds-scan-scan-type.png)
...
[]![A tile list of cloud types, resource categories, and database types. ](/downloads/dspm/scan-rules/scan-rules-aws/configuring-scan-rule-aws-databricks-workspace/ds-scan-aws-databricks.png)
[]![The Select Resources to Scan page with selected Databricks workspaces.](/downloads/dspm/scan-rules/scan-rules-aws/configuring-scan-rule-aws-databricks-workspace/ds-scan-databricks-resources.png)
[]![The scan schedule page with options for daily, weekly, and monthly scan frequency settings.](/downloads/dspm/scan-rules/scan-rules-aws/configuring-scan-rule-aws-databricks-workspace/ds-scan-schedule.png)
[]![The scan settings review page displays the configured scan settings before completing the scan configuration.](/downloads/dspm/scan-rules/scan-rules-aws/configuring-scan-rule-aws-databricks-workspace/ds-scan-review.png)
