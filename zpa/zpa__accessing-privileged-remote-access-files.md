...
PDF: https://help.zscaler.com/pdf/com/en/1508966.pdf
...
![Files tools on the Files page in the ZPA Admin Portal](/downloads/zpa/dashboard-diagnostics/accessing-privileged-remote-access-files/Tools_1.png)
Viewing Files
...
![PRA File System total widgets displayed on the Files page in the ZPA Admin Portal](/downloads/zpa/dashboard-diagnostics/accessing-privileged-remote-access-files/Viewing%20charts.png)
Filtering Files
...
![Adding filters to the Files table on the Files page within the ZPA Admin Portal](/downloads/zpa/dashboard-diagnostics/accessing-privileged-remote-access-files/Filters.png)
- Click **Apply**.
