...
PDF: https://help.zscaler.com/pdf/com/en/1483491.pdf
...
- Click **Save**.
If you want to completely replace a [deployed App Connector](/zpa/about-deploying-connectors), you must delete the configuration and then re-enroll it. However, you can apply the new App Connector provisioning key to the virtual machine (VM) image you already deployed by [replacing the old key](/zpa/managing-deployed-connectors#ReplaceProvisioningKey).