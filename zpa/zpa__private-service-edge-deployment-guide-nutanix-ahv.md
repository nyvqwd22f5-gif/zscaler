...
PDF: https://help.zscaler.com/pdf/com/en/1529938.pdf

This deployment guide provides information on prerequisites, how to deploy a Private Service Edge on Nutanix AHV, and post-deployment verification checks. For general information regarding Private Service Edge deployment for ZPA, see [About Deploying Private Service Edges](/zpa/about-deploying-service-edges).
...
- Step 4: Verify that the deployed Private Service Edge is [running and healthy](/zpa/managing-deployed-connectors#Status). Also, check that it [meets your sizing requirements](/zpa/managing-deployed-zpa-private-service-edges).
After you have verified your deployment, you can perform additional tasks to maintain the system (i.e., changing your Private Service Edge console admin credentials or performing system software updates). To learn more, see [Managing Deployed Private Service Edges](/zpa/managing-deployed-zpa-private-service-edges).
[]
...
[]![Selecting Settings in the Nutanix Portal.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-img-configuration.png)
[]![Create Image window in the Nutanix Portal after clicking Upload Image.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-create-vm.png)
...
[]
![Clicking Create VM in the Table tab of the Nutanix portal.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-create-vm-window.png)
[]
[]![Entering General Configuration in the Create VM window.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-create-vm-window-general2.png)
[]![Entering Computer Details in the Create VM window.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-create-vm-window-compute.png)
[]![Deleting the CD ROM Disk Type in the Create VM window.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-create-vm-window-disks.png)
[]![Adding a new disk in the Create VM window.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-create-vm-window-add-new-disk.png)
[]![Entering parameters in the Add Disk window.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-deployment-add-disk-window2.png)
[]![Adding a new NIC.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-add-new-nic2.png)
[]![Adding a new NIC in the Create NIC window.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-create-nic-window2.png)
![Searching for the VM in the Nutanix portal.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-search.png)
[]
[]![Powering on the VM in the Nutanix portal.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-vm-power-on.png)
[]![Launching the ZPA Private Service Edge console in the Nutanix portal.](/downloads/zpa/private-service-edge-management/private-service-edge-deployment-guides-supported-platforms/zpa-service-edge-deployment-prerequisites/zpa-pse-nutanix-deployment-launch-console.png)
...
- Log in to the Private Service Edge console using your [admin credentials](/zpa/managing-deployed-connectors#Default).
...
echo "<ZPA Private Service Edge Provisioning Key>" | sudo tee /opt/zscaler/var/service-edge/provision_key
...
- Zscaler highly recommends [updating the Private Service Edge system software](/zpa/about-connector-software-updates) before proceeding.
[]
