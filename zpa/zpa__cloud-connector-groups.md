...
Source: https://help.zscaler.com/zpa/cloud-connector-groups
...
Gets all configured Cloud Connector groups for the specified customer.

**Tags:** Cloud Connector Groups
...
Gets the Cloud Connector group details for the specified ID.
...
| ---- | --- | ---- | -------- | ----------- |
| customerId | path | integer (int64) | Yes | The unique identifier of the ZPA tenant. |
| id | path | integer (int64) | Yes | The unique identifier of the Cloud Connector group. |
