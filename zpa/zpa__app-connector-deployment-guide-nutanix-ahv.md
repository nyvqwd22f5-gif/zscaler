...
PDF: https://help.zscaler.com/pdf/com/en/1485191.pdf

This deployment guide provides information on prerequisites, how to deploy an App Connector on Nutanix AHV, and post-deployment verification checks. For general information regarding App Connector deployment for ZPA, see [About Deploying App Connectors](/zpa/about-deploying-connectors).
...
- Step 4: Verify that the deployed App Connector is [running and healthy](/zpa/managing-deployed-connectors#Status). Also, check that it is [meeting your sizing requirements](/zpa/managing-deployed-connectors#VerifySizing).
...
Before you deploy a virtual appliance on Nutanix AHV, you must obtain the latest Zscaler App Connector OVA. Use the following link to download the latest VMware image from Zscaler: [https://dist.private.zscaler.com/vms/VMware/2025.10/zpa-connector-el9-2025.10.ova](https://dist.private.zscaler.com/vms/VMware/2025.10/zpa-connector-el9-2025.10.ova).
...
- Click **Save**.
- In the **Table** tab (**Home **> **VM**), search for the VM by name.
...
[]![Create Image window in the Nutanix Portal after clicking Upload Image.](/downloads/zpa/app-connector-management/app-connector-deployment-guides-supported-platforms/app-connector-deployment-guide-nutanix-ahv/zpa-connector-nutanix-deployment-create-vm_0.png)
...
![Entering Computer Details in the Create VM window.](/downloads/zpa/app-connector-management/app-connector-deployment-guides-supported-platforms/app-connector-deployment-guide-nutanix-ahv/zpa-connector-nutanix-deployment-create-vm-window-compute_0.png)
[]
...
[]![Entering parameters in the Add Disk window.](/downloads/zpa/app-connector-management/app-connector-deployment-guides-supported-platforms/app-connector-deployment-guide-nutanix-ahv/zpa-nutanix-deployment-add-disk-window2_0.png)
...
- Zscaler highly recommends [updating the App Connector system software](/zpa/about-connector-software-updates) before proceeding.
[]
