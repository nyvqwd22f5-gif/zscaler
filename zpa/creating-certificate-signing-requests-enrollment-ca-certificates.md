...
PDF: https://help.zscaler.com/pdf/com/en/1484071.pdf

A CA certificate is required for enrolling Zscaler Client Connector [configuring an App Connector](/zpa/about-connectorprovisioningwizard#sc) for enrollment, and [configuring an AppProtection-enabled application segment](/zpa/configuring-application-segments) for enrollment.
...
The **Enrollment Certificates** page automatically updates to display your pending CSR in the table, where you must [upload the signed certificate and the certificate chain](/zpa/about-uploadingEnrollmentCertificate#UploadPending).