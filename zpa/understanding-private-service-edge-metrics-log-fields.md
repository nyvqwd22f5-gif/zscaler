...
| PrivateSE | Name of the ZPA Private Service Edge | %[OPT]s%[OPT]j%[OPT]J%[OPT]o |
...
| ProcessMemoryUtilization | The memory utilization of the ZPA Private Service Edge process | %[OPT]s%[OPT]j%[OPT]J%[OPT]d |
...
| SystemMaximumFileDescriptors | The number of total ZPA Private Service Edge system file descriptors | %[OPT]s%[OPT]j%[OPT]J%[OPT]d |
| SystemUsedFileDescriptors | The number of used ZPA Private Service Edge system file descriptors | %[OPT]s%[OPT]j%[OPT]J%[OPT]d |
| ProcessMaximumFileDescriptors | The number of total ZPA Private Service Edge process file descriptors | %[OPT]s%[OPT]j%[OPT]J%[OPT]d |
| ProcessUsedFileDescriptors | The number of used ZPA Private Service Edge process file descriptors | %[OPT]s%[OPT]j%[OPT]J%[OPT]d |
| AvailableDiskBytes | The number of free bytes available for the ZPA Private Service Edge | %[OPT]s%[OPT]j%[OPT]J%[OPT]d |
