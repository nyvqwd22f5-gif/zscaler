...
Source: https://help.zscaler.com/zpa/accessing-api-protection-diagnostics
PDF: https://help.zscaler.com/pdf/com/en/1499841.pdf
...
By default, the detailed AppProtection control, AppProtection profile, and policy information are displayed that occurred in the last 24 hours. You can do the following:
...
On the API Protection Diagnostics page, you can apply filters or drill down further into the log data using the Query Builder. By default, no filters are applied. If you want to view and filter User Status for real-time events, use [Live Logs](/zpa/about-live-logs).
