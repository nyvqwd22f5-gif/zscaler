...
PDF: https://help.zscaler.com/pdf/com/en/1530860.pdf
...
Use the Application and User Group Relationships page (Insights > Usage > Application and User Group Relationships) to view the usage between applications and user groups.
...
-
**Detailed**: The detailed report includes details about segment groups, application segments, applications (including FQDN, port, protocol, and discovered applications), access policy rule, and user groups and users who have accessed the applications and application segments.
...
-
Sunburst chart: If you click an individual item in the inner ring, you can exclude it from display.
...
[]
![Application Segment Settings in the Application and User Group Relationships Page](/downloads/zpa/dashboard-diagnostics/applications-and-users-monitoring/applications-users-insights/viewing-application-and-user-group-relationships/zpa-application-user-group-relationships-settings-saml-scim.png)
...
[]
![Exclude Items in Settings Drawer](/downloads/tech-pubs-drafts/zpa-draft-articles/viewing-application-and-user-group-relationships-doc-58689/zpa-application-user-group-relationships-settings-exclude.png)
[]
...
[]
![Sunburst Chart](/downloads/tech-pubs-drafts/zpa-draft-articles/viewing-application-and-user-group-relationships-doc-58689/zpa-using-application-user-group-relationships-gif2.gif)
[]
...
[]
![Using the Application and User Group Relationships Insights](/downloads/tech-pubs-drafts/zpa-draft-articles/viewing-application-and-user-group-relationships-doc-58689/zpa-using-application-user-group-relationships-gif2.gif)
[]
...
[]
![Run Report](/downloads/tech-pubs-drafts/zpa-draft-articles/viewing-application-and-user-group-relationships-doc-58689/zpa-application-user-group-relationships-run-report-window.png)
[]
...
[]![Detailed Report View within the Download CSV File window in the ZPA Admin Portal](/downloads/zpa/dashboard-diagnostics/applications-and-users-monitoring/applications-users-insights/viewing-application-and-user-group-relationships/zpa-application-user-group-relationships-download-detailed-view.png)
[]![Summary Report View within the Download CSV File window in the ZPA Admin Portal](/downloads/zpa/dashboard-diagnostics/applications-and-users-monitoring/applications-users-insights/viewing-application-and-user-group-relationships/zpa-application-user-group-relationships-download-summary-view.png)