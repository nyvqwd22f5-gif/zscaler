...
PDF: https://help.zscaler.com/pdf/com/en/1507451.pdf

This deployment guide provides information on prerequisites, how to deploy a ZPA Private Cloud Controller on Red Hat Enterprise Linux 9.x, and post-deployment verification checks.
...
---> Package zpa-pcc.x86_64 0:25.49.4-1.el9 will be installed
...
================================================================================
Installing:
zpa-pcc     x86_64       25.49.4-1.el9       zscaler            1.1 M
Transaction Summary
================================================================================
Install 1 Package
...
warning: /var/cache/yum/x86_64/7/zscaler/packages/zpa-pcc-25.49.4-1.el9.x86_64.rpm: Header V4 RSA/SHA1 Signature, key ID 8765e1dd: NOKEY kb 00:00:01 ETA
Public key for zpa-pcc-25.49.4-1.el9.x86_64.rpm is not installed
zpa-pcc-25.49.4-1.el9.x86_64.rpm                                                                                               | 1.1 MB      00:00:03
...
Running transaction
Installing : zpa-pcc-25.49.4-1.el9.x86_64                          1/1
Verifying  : zpa-pcc-25.49.4-1.el9.x86_64                           1/1
Installed:
zpa-pcc.x86_64 0:25.49.4-1.el9
Complete!
...
- RPM package ([zpa-pcc.rpm](https://yum.private.zscaler.com/yum/el9/zpa-pcc-25.49.4-1.el9.x86_64.rpm))
...
- Apply the ZPA Private Cloud Controller provisioning key.
- [See instructions.](#pkey_duplicate)
- Run the following command:
[admin@pcc ~]$ iptables -I INPUT 1 -j ACCEPT
- Zscaler highly recommends [updating the Private Cloud Controller system software](/zpa/understanding-private-cloud-controller-software-upgrades) before proceeding.
- []Stop running the ZPA Private Cloud Controller service.
