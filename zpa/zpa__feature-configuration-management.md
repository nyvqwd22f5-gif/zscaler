...
Source: https://help.zscaler.com/zpa/feature-configuration-management
...
Gets all feature configuration details for the specified customer.

**Tags:** Feature Configuration Management
...
Creates a feature configuration for the specified customer.
...
Gets the feature configuration details for the specified ID.
...
| ---- | --- | ---- | -------- | ----------- |
| customerId | path | integer (int64) | Yes | The unique identifier of the ZPA tenant. |
| id | path | integer (int64) | Yes | The unique identifier of the feature configuration. |
...
Updates the feature configuration for the specified ID.
