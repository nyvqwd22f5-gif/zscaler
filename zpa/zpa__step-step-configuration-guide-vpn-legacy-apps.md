...
- [Configuring Network Connectors](/zpa/configuring-vpn-connectors)
...
- [Configuring Network Segments](/zpa/configuring-vpn-segments)
...
- [About VPN Service Edges](/zpa/about-vpn-service-edges)
- [Configuring Zscaler Client Connector App Profiles](/zscaler-client-connector/configuring-zscaler-client-connector-app-profiles#global)
[See image.](#AppProfileBypass)
[]Verify that users can successfully connect to the VPN Service Edge. To learn more, see [About VPN Connected Users](/zpa/about-vpn-connected-users).
