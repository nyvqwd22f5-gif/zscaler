...
PDF: https://help.zscaler.com/pdf/com/en/1506381.pdf
...
Zscaler retains logs for rolling periods of at least 14 days during the subscription term. You can also view your logs or stream logs in real time using the [Log Streaming Service (LSS)](/zpa/about-log-streaming-service). The data in the [dashboard](/zpa/dashboard-diagnostics) might be more recent than the data presented within Diagnostics.
...
- **Private Cloud Controller: Public IP Address**: See logs for a public Private Cloud Controller IP address, which is used to reach out to the ZPA Public Service Edge.
...
- **Session Type**: The sesion type associated with the connection (e.g., **TLS**).
...
The time displayed is based on the time you choose for [your account setting](/zpa/accessing-and-navigating-zpa-admin-portal) in the ZPA Admin Portal.
...
- []**Private Cloud Controller Name**: The name of the Private Cloud Controller used to connect the application to the user. You can click on the name to open the [Edit Private Cloud Controller](/zpa/editing-deployed-private-cloud-controller) window.
- **Private Cloud Controller ID**: The ID (created by ZPA) of the Private Cloud Controller. You can click the **Copy** icon to copy the ID to your clipboard.
...
- **Private Cloud Controller Group Name**: The name of the group the Private Cloud Controller is included in. You can click on the name to open the [Edit Private Cloud Controller Group](/zpa/editing-private-cloud-controller-groups) window.
- **Private Cloud Controller Group ID**: The ID (created by ZPA) for the Private Cloud Controller group. You can click the **Copy** icon to copy the ID to your clipboard.
- []**Name**: The name of the ZPA Public Service Edge that processed the connection.
