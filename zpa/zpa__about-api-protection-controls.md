...
On the API Protection Controls page (Configuration & Controls > Security > AppProtection Controls > API Protection Controls), you can do the following:
