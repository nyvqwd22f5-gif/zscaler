...
Source: https://help.zscaler.com/zpa/zscaler-virtual-ip-address-range-management
...
**Tags:** Zscaler Virtual IP Address Range Management
...
| ---- | --- | ---- | -------- | ----------- |
| customerId | path | integer (int64) | Yes | The unique identifier of the ZPA tenant. |
| ipRangeId | path | integer (int64) | Yes | The unique identifier of the virtual IP address range. |
