...
PDF: https://help.zscaler.com/pdf/com/en/1530858.pdf
...
- **View Access Policy**: Allows you to access the [Access Policy](/zpa/about-access-policy) page to manage the access policies.
...
- **Transactions**: The number of ZPA transactions going through the access policy.
- **Actions**: The available actions for the access policy rule.
- **Edit**: Edit the access policy rule in the **Edit Access Policy** window. To learn more, see [Editing Access Policies](/zpa/editing-access-policies).
- **Policy Hit and User Details**: View the access policy rule's policy usage details. To learn more, see [Viewing Policy Usage Details](/zpa/viewing-policy-usage-details).
