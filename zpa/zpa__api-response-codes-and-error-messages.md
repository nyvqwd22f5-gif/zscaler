...
Source: https://help.zscaler.com/zpa/api-response-codes-and-error-messages
PDF: https://help.zscaler.com/pdf/com/en/1484801.pdf

The following table lists the HTTP status codes returned by the API.
[](/zpa/understanding-rate-limiting)
| Code | Description |
| ---- | ----------- |
| 200 | Successful |
| 201 | Created |
...
| 429 | Exceeded the rate limit or quotaThe following example is the response body when an API call is rate limited:`{
