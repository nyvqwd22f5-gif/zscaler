# About SCIM APIs
Source: https://help.zscaler.com/zpa/about-scim-apis
PDF: https://help.zscaler.com/pdf/com/en/1485471.pdf

The SCIM APIs allow you to use custom SCIM clients to make REST API calls to Zscaler. To learn more, see [About SCIM](/zpa/about-scim) and [SCIM API Examples](/zpa/scim-api-examples).
