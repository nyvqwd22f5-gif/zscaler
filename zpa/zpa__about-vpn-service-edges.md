...
On the VPN Service Edges page (VPN (for Legacy Apps) > VPN Service Edges > VPN Service Edges), you can do the following:
...
- [Add a new VPN Service Edge.](/zpa/configuring-vpn-service-edges)
...
- [Modify the display of columns in the table](/zpa/using-tables).
- [Edit the VPN Service Edge](/zpa/editing-vpn-service-edges).
- Delete the VPN Service Edge.
- Display more rows or a different page of the table.
![VPN Service Edges page in the ZPA Admin Portal](/downloads/zpa/vpn-legacy-apps/vpn-configuration/about-vpn-service-edges/VPN-Service-Edges-page-w-steps-software-update_1.png)