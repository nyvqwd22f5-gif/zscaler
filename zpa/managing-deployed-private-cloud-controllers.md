...
Source: https://help.zscaler.com/zpa/managing-deployed-private-cloud-controllers
PDF: https://help.zscaler.com/pdf/com/en/1529184.pdf

After you deploy a Private Cloud Controller and complete the proper networking configurations, verify that the Private Cloud Controller is running and healthy, and that the [sizing and scalability specifications](/zpa/private-cloud-controller-deployment-prerequisites) you selected before deployment are still adequate for your organization's needs:
...
- Go to **Configuration & Control** > **Business Continuity** > **Private Cloud Controllers**.
...
To learn more, see [Private Cloud Controller Specifications and Sizing Requirements](/zpa/private-cloud-controller-deployment-prerequisites).
...
- [Log in to the ZPA Private Cloud Controller console](#Login) using the default admin username and password.
...
- RPM package ([zpa-pcc.rpm](https://yum.private.zscaler.com/yum/el9/zpa-pcc-25.47.3-1.el9.x86_64.rpm))
- GPG public key ([https://yum.private.zscaler.com/yum/el9/gpg](https://yum.private.zscaler.com/yum/el9/gpg))
- Use the `scp` command to copy the RPM package to the remote Private Cloud Controller's target directory, for example:
`$ scp zpa-pcc.rpm admin@<server>:/home/admin
$ scp gpg admin@<server>:/home/admin`
- Log in to the Private Cloud Controller console using your admin credentials.
- Update the Private Cloud Controller software package using the following command:
`$ sudo yum upgrade zpa-pcc-25.47.3-1.el9.x86_64.rpm`
- Make sure that the update completes successfully as shown in this example:
`: [root@test-abc.lab.test /tmp]# yum upgrade zpa-pcc-25.47.3-1.el9.x86_64.rpm -y
...
==============================================================================================================================================================================================
Upgrading:
zpa-pcc                                 x86_64                           25.47.3-1.el9                                                       @commandline                             3.4 M
Transaction Summary
==============================================================================================================================================================================================
Upgrade  1 Package
Total size: 3.4 M
...
Running transaction
Preparing        :                                                                                                  1/1
Running scriptlet: zpa-pcc-25.47.3-1.el9.x86_64                                                                     1/2
Upgrading        : zpa-pcc-25.47.3-1.el9.x86_64                                                                     1/2
Running scriptlet: zpa-pcc-25.47.3-1.el9.x86_64                                                                     1/2
...
Running scriptlet: zpa-pcc-25.47.3-1.el9.x86_64                                                                     2/2
Cleanup          : zpa-pcc-25.47.3-1.el9.x86_64                                                                     2/2
Running scriptlet: zpa-pcc-25.47.3-1.el9.x86_64                                                                     2/2
Verifying        : zpa-pcc-25.47.3-1.el9.x86_64                                                                     1/2
Verifying        : zpa-pcc-25.47.3-1.el9.x86_64                                                                     2/2
Upgraded:
zpa-pcc-25.47.3-1.el9.x86_64
Complete!`
-
Reload the service units using the following command:
`$ sudo systemctl daemon-reload`
-
Restart the Private Cloud Controller using the following command:
`$ sudo systemctl restart zpa-pcc`
- Verify that the updated version of the Private Cloud Controller appears in the ZPA Admin Portal. To learn more, see [Check Private Cloud Controller Status](#Status).
...
- Log in to the ZPA Admin Portal and go to **Configuration & Control** > **Business Continuity** > **Private Cloud Controllers**.
...
- (Optional) If you do not already have your new Private Cloud Controller provisioning key, be sure to complete the procedure for [adding a new Private Cloud Controller with a new provisioning key](/zpa/configuring-private-cloud-controllers).
- Log in to the Private Cloud Controller console using your admin credentials.
...
When the user sessions have expired on the disabled Private Cloud Controllers, delete them within the ZPA Admin Portal and remove any old VM instances from your environment.