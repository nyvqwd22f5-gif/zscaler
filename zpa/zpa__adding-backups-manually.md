...
PDF: https://help.zscaler.com/pdf/com/en/1485851.pdf

You can back up and restore a set of policies and configuration settings, and save up to 10 backups. To learn more, see [About Backup and Restore](/zpa/about-backup-and-restore).
To add a backup:
