...
PDF: https://help.zscaler.com/pdf/com/en/1485161.pdf

The ZPA service analyzes user logs and suggests AI-powered recommendations for application segments. AI-powered recommendations are application segments that have been pulled based on the filters you have configured in the [AI-Powered Recommendations Settings](/zpa/configuring-ai-powered-recommendations-settings). These AI-powered recommendations for application segments can be [merged with existing defined application segments](/zpa/merging-recommended-application-segments), [added as newly defined application segments](/zpa/configuring-recommended-application-segments), or ignored if they do not apply.
...
To learn more about the configuration options available for your applications before configuring an application segment within ZPA, see [About Applications](/zpa/about-applications) and [Configuring AI-Powered Recommendations Settings](/zpa/about-application-segments-settings).
Prerequisites
The following prerequisites are required to activate the AI-Powered Recommendations page:
- Have a minimum of 100 [discovered applications](/zpa/about-application-discovery).
- Have at least 20 [enrolled users](/zpa/about-users-dashboard).
...
[]On the AI-Powered Recommendations page (Resource Management > Application Management > Application Segments > AI-Powered Recommendations), you can do the following:
- Open the [Settings](/zpa/about-application-segments-settings) drawer to add parameters to AI-powered recommended application segment findings.
...
- [Add an AI-powered recommended application segment](/zpa/configuring-recommended-application-segments).
- [Merge with a defined application segment](/zpa/merging-recommended-application-segments).
...
- Download the configuration information for the recommended [application group](/zpa/about-segment-groups) to a CSV file.
...
![Using the Recommended Application Segments page within the ZPA Admin Portal](/downloads/zpa/documentation-knowledgebase/applications/application-segments/about-ai-powered-recommendations-application-segments/zpa-ai-powered-recommendations-w-steps.png)
[]
...
- **Attack Surface Reduction**: The percentage reduction in the attack surface (i.e., percentage difference between potential users and recommended users).
- **Recommended Users**: The number of users recommended for this application segment.
...
- Go to the [Defined Application Segments](/zpa/about-applications) tab to view and manage defined application segments.
- Go to the [Application Segment Import](/zpa/about-application-segment-import) page to import database files for faster application segment configurations.
