...
PDF: https://help.zscaler.com/pdf/com/en/1484921.pdf

The ZPA App Connector Docker image is available on Docker Hub for both the arm64 and amd64 platforms:
...
Prerequisites
An environment variable named `ZPA_PROVISION_KEY` is required to run this image. You can retrieve the provisioning key from the [ZPA Admin Portal](https://admin.private.zscaler.com/). To learn more, see [About App Connector Provisioning Keys](/zpa/about-connector-provisioning-keys).
