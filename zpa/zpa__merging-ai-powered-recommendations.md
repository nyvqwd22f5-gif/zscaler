...
PDF: https://help.zscaler.com/pdf/com/en/1485166.pdf

AI-powered recommendations for application segments can become defined application segments. You can [add an AI-powered recommendation](/zpa/configuring-recommended-application-segments), which moves it to the [Defined Application Segment](/zpa/about-applications) page as a new defined application segment. You can also merge an AI-powered recommendation with an existing defined application segment. This option allows you to combine application segments that have the same grouping reasons.
...
- **Health Reporting**: Indicates whether [health reporting](/zpa/understanding-health-reporting) for the application is **Continuous**, **On Access**, or **None**.
- Click **Next**.
